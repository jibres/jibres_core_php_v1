...
<p class="f fs14 msg warn2">
  ...
  <?php if(\dash\data::barcodeScaned()) {?>
    ...
    <a class="c" href="<?php echo \dash\url::this(); ?>/add<?php echo \dash\data::barcodeScaned(); ?>" data-shortkey="118"><?php echo T_("Add new post"); ?> <kbd>f7</kbd></a>
...
<div class="fs14 msg info2 pTB20">
  <p><?php echo T_("Hi!"); ?></p>
  <p><?php echo T_("Publish news and pages on your website."); ?>
  <p><a href="<?php echo \dash\url::that(); ?>/add"><?php echo T_("Try to start with add new post!"); ?></a></p>

</div>

<img class="banner" src="<?php echo \dash\url::cdn(); ?>/img/product/camera1.png" align='<?php echo T_("add new post"); ?>'>
