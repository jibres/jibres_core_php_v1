    ...
    <div class="c8 s12">
      <div class="data">
        ...
        <div class="body">
          ...
          <?php if(\dash\data::postWriterOld()) {?><div class="mt-2"><?php echo T_("Current post writer"). ' '.  \dash\data::postWriterOld_displayname(); ?></div><?php } //endif ?>
        </div>
      </div>
    </div>
    <div class="c4 s12">
    ...
    <div class="data">
      ...
      <div class="body">
        ...
        <?php if(\dash\data::dataRow_redirecturl()) {?>
          <div class="row alert-success minimal">
