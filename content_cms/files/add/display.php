<form method="post">
	<div class="avand-md">
		<section class="box">
			<div data-uploader data-size='large' data-name='file'  data-ratio-free data-final='#finalImage' data-file-max-size='<?php echo \dash\data::maxFileSize() ?>' data-autoSend>
