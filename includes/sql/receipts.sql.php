...
class receipts 
{
	...
	public $cheque_id = array('type' => 'smallint@5', 'label' => 'id');
	public $receipt_cheque_date = array('type' => 'datetime@', 'label' => 'cheque_date');
	public $receipt_cheque_status = array('type' => 'enum@pass,back_recovery,back_fail,lost,block,delete,inprogress', 'label' => 'cheque_status');
	public $receipt_desc = array('type' => 'varchar@200', 'label' => 'desc');
	public $transaction_id = array('type' => 'int@10', 'label' => 'id');
	public $fund_id = array('type' => 'smallint@5', 'label' => 'id');
