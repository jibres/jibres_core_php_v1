...
class twigTransTerms
{
 private function transtext()
 {
	...
	echo T_("Enamad");                                                                // Line 52
	echo T_("Samandehi");                                                             // Line 54
	echo T_("Proudly Made in IRAN");                                                  // Line 58
	...
	echo T_("allowed extentions jpg, png (gif for bussiness plans). Max 500Kb");      // Line 150
	...
	echo T_("Insert");                                                                // Line 139
	echo T_("Save All");                                                              // Line 143
