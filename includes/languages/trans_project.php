...
class twigTransTerms
{
 private function transtext()
 {
	...
	echo T_("Soon");                                                                  // Line 271

	//--------------------------------------------------content\changelog\display.html
	echo T_("Date");                                                                  // Line 35
	echo T_("Description");                                                           // Line 6
	...
	echo T_("Simple");                                                                // Line 127
	echo T_("Standard");                                                              // Line 185
	...
	echo T_("Products Summary");                                                      // Line 13
	...
	echo T_("Export");                                                                // Line 63

	//-------------------------------------------content_a\product\factor\display.html
	echo T_("allowed extentions jpg, png (gif for bussiness plans). Max 500Kb");      // Line 201
	...
	echo T_("Discount Percent");                                                      // Line 221
	echo T_("%");                                                                     // Line 141
	...
	echo T_("Weight");                                                                // Line 168
	echo T_("Enter product weight");                                                  // Line 170
	echo T_("Sale Price");                                                            // Line 194
	echo T_("Price for sale without discount");                                       // Line 196
	echo T_("Impure Interest Rate");                                                  // Line 197
	echo T_("Final Pure Price");                                                      // Line 206
	echo T_("Pure Interest Rates");                                                   // Line 207
	echo T_("Discount on sale");                                                      // Line 220
	echo T_("Vat");                                                                   // Line 230
	echo T_("This product is vat base");                                              // Line 230
	echo T_("Initial Balance");                                                       // Line 238
	echo T_("Min stock");                                                             // Line 246
	echo T_("Max stock");                                                             // Line 255
	echo T_("Status of product");                                                     // Line 262
	echo T_("Avalible");                                                              // Line 266
	echo T_("Normal status of product");                                              // Line 266
	echo T_("maybe come in future and be available");                                 // Line 271
	echo T_("Unavailable");                                                           // Line 276
	echo T_("temporary does not exist in store");                                     // Line 276
	echo T_("Discountinued");                                                         // Line 281
	echo T_("does not exist for now and on the future");                              // Line 281
	echo T_("Unset");                                                                 // Line 286
	echo T_("Unknown status for product");                                            // Line 286
	echo T_("Sold");                                                                  // Line 520
	echo T_("Service");                                                               // Line 315
	echo T_("This product is service base and not a real goods");                     // Line 315
	echo T_("Sale Online");                                                           // Line 324
	echo T_("This product is saleonline base");                                       // Line 324
	echo T_("Sale in store");                                                         // Line 334
	echo T_("This product is salestore base");                                        // Line 334
	echo T_("Count in carton");                                                       // Line 342
	echo T_("Count of product in carton");                                            // Line 344
	echo T_("Tag");                                                                   // Line 75
	...
	echo T_("Detail");                                                                // Line 61
	echo T_("Site");                                                                  // Line 510
	echo T_("Report");                                                                // Line 530
	echo T_("Price change");                                                          // Line 545
	echo T_("General");                                                               // Line 468
	echo T_("Manage");                                                                // Line 6
	echo T_("Sale gateway");                                                          // Line 607
	...
	echo T_("Click to check list of this product");                                   // Line 33
	echo T_("No product in this unit");                                               // Line 35
	echo T_("You can delete it now!");                                                // Line 36
	echo T_("Cancel");                                                                // Line 46
	...
	echo T_("Count product");                                                         // Line 110
	echo T_("Is default");                                                            // Line 88
	echo T_("Without Unit");                                                          // Line 120
	echo T_("Click to check products in this category");                              // Line 124
	...
	echo T_("General Detail");                                                        // Line 151
	...
	echo T_("Please select one language");                                            // Line 302
	...
	echo T_("Start");                                                                 // Line 279

	//-----------------------------------content_a\setting\plan\currentPlanDetail.html
	echo T_("Upgrade");                                                               // Line 224
	echo T_("Continuation");                                                          // Line 21
	echo T_("Change plan");                                                           // Line 28
	echo T_("Current Plan");                                                          // Line 220
	echo T_("Forever");                                                               // Line 48
	echo T_("Expire on");                                                             // Line 265
	echo T_("days left");                                                             // Line 96
	echo T_("Expired");                                                               // Line 100
	echo T_("History");                                                               // Line 272
	echo T_("End");                                                                   // Line 280
	echo T_("Expire");                                                                // Line 126
	echo T_("Period");                                                                // Line 283
	...
	//---------------------------------------content_a\thirdparty\billing\display.html
	...
	//----------------------------------------content_a\thirdparty\credit\display.html
	...
	//----------------------------------------content_a\thirdparty\export\display.html
	...
	echo T_("Please select one itme");                                                // Line 23
	...
	//------------------------------content_a\thirdparty\minustransaction\display.html
	...
	//-------------------------------content_a\thirdparty\plustransaction\display.html
	echo T_("Increase amount of budget");                                             // Line 53

	//---------------------------------------content_a\thirdparty\profile\display.html

	//-----------------------------------content_a\thirdparty\transaction\display.html
	echo T_("Search in transactions");                                                // Line 66
	echo T_("Plus");                                                                  // Line 59
	echo T_("Minus");                                                                 // Line 60
	...
	//-------------------------------------------content_subdomain\home\visitcard.html
