...
class twigTransTerms
{
 private function transtext()
 {
	...
	echo T_("Staff");                                                                 // Line 413
	echo T_("Supplier");                                                              // Line 115
	echo T_("Tag");                                                                   // Line 444
	echo T_("Add tag manually to link thirdparty togethers");                         // Line 454
	echo T_("Tag keywords...");                                                       // Line 455
	echo T_("Save tag");                                                              // Line 461
	...
	echo T_("Clear filters");                                                         // Line 198
	echo T_("Result not found!");                                                     // Line 197
	echo T_("Search with new keywords.");                                             // Line 197
	echo T_("Hi!");                                                                   // Line 204
	...
	echo T_("Barcode");                                                               // Line 29
	echo T_("Scan Barcode here...");                                                  // Line 143
	echo T_("Barcode2");                                                              // Line 150
	echo T_("Scan Barcode2 here...");                                                 // Line 152
	echo T_("Code on scale");                                                         // Line 37
	echo T_("Enter product code on scale");                                           // Line 161
	echo T_("Sale Price");                                                            // Line 184
	echo T_("Price for sale without discount");                                       // Line 186
	echo T_("Impure Interest Rate");                                                  // Line 187
	echo T_("Final Price");                                                           // Line 33
	echo T_("Final Pure Price");                                                      // Line 196
	echo T_("Pure Interest Rates");                                                   // Line 197
	echo T_("Discount on sale");                                                      // Line 210
	echo T_("Discount Percent");                                                      // Line 140
	echo T_("Vat");                                                                   // Line 220
	echo T_("This product is vat base");                                              // Line 220
	echo T_("Initial Balance");                                                       // Line 228
	echo T_("Min stock");                                                             // Line 236
	echo T_("Max stock");                                                             // Line 245
	echo T_("Status of product");                                                     // Line 252
	echo T_("Avalible");                                                              // Line 256
	echo T_("Normal status of product");                                              // Line 256
	echo T_("maybe come in future and be available");                                 // Line 261
	echo T_("Unavailable");                                                           // Line 266
	echo T_("temporary does not exist in store");                                     // Line 266
	echo T_("Discountinued");                                                         // Line 271
	echo T_("does not exist for now and on the future");                              // Line 271
	echo T_("Unset");                                                                 // Line 276
	echo T_("Unknown status for product");                                            // Line 276
	echo T_("Service");                                                               // Line 305
	echo T_("This product is service base and not a real goods");                     // Line 305
	echo T_("Sale Online");                                                           // Line 314
	echo T_("This product is saleonline base");                                       // Line 314
	echo T_("Sale in store");                                                         // Line 324
	echo T_("This product is salestore base");                                        // Line 324
	echo T_("Count in carton");                                                       // Line 332
	echo T_("Count of product in carton");                                            // Line 334
	echo T_("Site");                                                                  // Line 499
	echo T_("Report");                                                                // Line 519
	echo T_("Price change");                                                          // Line 534
	echo T_("Gallery");                                                               // Line 49
	echo T_("Property");                                                              // Line 568
