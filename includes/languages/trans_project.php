...
class twigTransTerms
{
 private function transtext()
 {
	...
	echo T_("Set as default");                                                        // Line 87
	echo T_("Remove");                                                                // Line 22
	echo T_("Enable irankish PC POS");                                                // Line 112
	echo T_("Serial");                                                                // Line 119
	echo T_("Terminal");                                                              // Line 126
	echo T_("Receiver");                                                              // Line 133
	echo T_("Enable asanpardakht PC POS");                                            // Line 149
	echo T_("IP");                                                                    // Line 156
	echo T_("Port");                                                                  // Line 164
