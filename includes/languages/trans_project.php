...
class twigTransTerms
{
 private function transtext()
 {
	...
	echo T_("Cheque");                                                                // Line 448
	echo T_("In out");                                                                // Line 82

	//-------------------------------------------------content_pardakhtyar/layout.html
	...
	echo T_("trackingNumber");                                                        // Line 86
	echo T_("trackingNumberPsp");                                                     // Line 87
	echo T_("requestType");                                                           // Line 91
	echo T_("status");                                                                // Line 21
	echo T_("merchantType");                                                          // Line 92
	echo T_("residencyType");                                                         // Line 93
	echo T_("vitalStatus");                                                           // Line 94
	echo T_("firstNameFa");                                                           // Line 98
	echo T_("lastNameFa");                                                            // Line 99
	echo T_("fatherNameFa");                                                          // Line 100
	echo T_("firstNameEn");                                                           // Line 101
	echo T_("lastNameEn");                                                            // Line 102
	echo T_("fatherNameEn");                                                          // Line 103
	echo T_("birthCrtfctNumber");                                                     // Line 104
	echo T_("birthDate");                                                             // Line 105
	echo T_("gender");                                                                // Line 134
	echo T_("birthCrtfctSeriesLetter");                                               // Line 107
	echo T_("birthCrtfctSeriesNumber");                                               // Line 108
	echo T_("nationalCode");                                                          // Line 109
	echo T_("birthCrtfctSerial");                                                     // Line 110
	echo T_("telephoneNumber");                                                       // Line 113
	echo T_("emailAddress");                                                          // Line 114
	echo T_("webSite");                                                               // Line 115
	echo T_("fax");                                                                   // Line 116
	echo T_("cellPhoneNumber");                                                       // Line 117
	echo T_("foreignPervasiveCode");                                                  // Line 121
	echo T_("passportNumber");                                                        // Line 122
	echo T_("passportExpireDate");                                                    // Line 123
	echo T_("countryCode");                                                           // Line 124
	echo T_("registerNumber");                                                        // Line 127
	echo T_("comNameFa");                                                             // Line 128
	echo T_("comNameEn");                                                             // Line 129
	echo T_("commercialCode");                                                        // Line 130
	echo T_("registerDate");                                                          // Line 131
	echo T_("nationalLegalCode");                                                     // Line 132
	...
	//--------------------------------------dash/addons/includes/html/display-mvc.html
	...
	//-------------------------------------dash/addons/includes/html/display-dash.html
	...
	//-----------------------------------------dash/addons/includes/html/inc_spay.html
	...
	//-----------------------------dash/addons/includes/html/display-enter-blocks.html
	...
	//---------------------------------dash/addons/includes/html/display-dash-xhr.html

	//-----------------------------------dash/addons/includes/html/inc_pagination.html
	echo T_("Total");                                                                 // Line 22

	//-----------------------------------dash/addons/includes/html/inc_commentadd.html
	...
	echo T_("Add store as free trial");                                               // Line 30
	echo T_("You have not created your own store yet!");                              // Line 33
	echo T_("Try Jibres free trial for 14 days");                                     // Line 33
	echo T_("As supplier");                                                           // Line 45
	echo T_("You are sell to this stores");                                           // Line 45
	echo T_("Store");                                                                 // Line 147
	echo T_("Sell count");                                                            // Line 51
	echo T_("Total sell price");                                                      // Line 52
	echo T_("Average sell price");                                                    // Line 53
	echo T_("You are not sell something to any stores yet!");                         // Line 68
	echo T_("Start from");                                                            // Line 87
	echo T_("Current plan");                                                          // Line 88
	echo T_("days left");                                                             // Line 56
	echo T_("Expired");                                                               // Line 206
	echo T_("Staff");                                                                 // Line 438
	echo T_("As customer");                                                           // Line 142
	echo T_("You are buy from this stores");                                          // Line 142
	echo T_("Buy count");                                                             // Line 148
	echo T_("Total buy price");                                                       // Line 149
	echo T_("Average buy price");                                                     // Line 150
	echo T_("You are not buy something from stores yet!");                            // Line 165

	//-----------------------------------------content_api/v6/headers/just-appkey.html
	...
	//------------------------------------------------content_api/v6/headers/full.html
	echo T_("Click here to get your apikey");                                         // Line 51

	//------------------------------------------content_api/v6/doc/21-get-profile.html
	...
	//-------------------------------------------content_api/v6/doc/40-user-login.html
	...
	//------------------------------------------------content_api/v6/doc/55-notif.html
	...
	//------------------------------------content_api/v6/doc/71-session-terminate.html
	...
	//---------------------------------------content_api/v6/doc/23-update-profile.html
	...
	echo T_("linkedin");                                                              // Line 86
	echo T_("facebook");                                                              // Line 59
	echo T_("twitter");                                                               // Line 68

	//-------------------------------------------------content_api/v6/doc/display.html
	echo T_("API");                                                                   // Line 26
	...
	//----------------------------------------------content_api/v6/doc/33-contact.html
	echo T_("Get contact text");                                                      // Line 5

	//------------------------------------------------content_api/v6/doc/01-intro.html
	echo T_("APIs");                                                                  // Line 3
	...
	//---------------------------------------------content_api/v6/doc/42-language.html

	//------------------------------------------------content_api/v6/doc/10-token.html
	...
	//---------------------------------------------content_api/v6/doc/02-endpoint.html
	...
	//--------------------------------content_api/v6/doc/303-product-comment-list.html
	...
	echo T_("Product guarantee list");                                                // Line 4
	echo T_("Product comment list");                                                  // Line 5
	...
	echo T_("Categories of Product");                                                 // Line 22
	echo T_("Product Units");                                                         // Line 23
	echo T_("Product Compnay");                                                       // Line 24
	echo T_("Product Guarantee");                                                     // Line 25
	echo T_("Third Parties");                                                         // Line 33
	echo T_("Suppliers");                                                             // Line 49
	echo T_("Staffs");                                                                // Line 38
	echo T_("register new sale factor");                                              // Line 47
	echo T_("List of sales");                                                         // Line 49
	echo T_("List of purchases");                                                     // Line 50
	echo T_("List of all factors");                                                   // Line 51
	echo T_("Reports");                                                               // Line 57
	echo T_("Daily report");                                                          // Line 20
	echo T_("Monthly report");                                                        // Line 20
	echo T_("Setting");                                                               // Line 13
	echo T_("Store plans");                                                           // Line 70
	echo T_("Factor settings");                                                       // Line 71
	echo T_("Shift transformation");                                                  // Line 77
	echo T_("You are active user");                                                   // Line 90
	...
	echo T_("Search products");                                                       // Line 46
	echo T_("Sort");                                                                  // Line 53
	echo T_("You can sort your list");                                                // Line 55
	echo T_("Variants");                                                              // Line 619
	echo T_("in stock");                                                              // Line 102
	echo T_("For");                                                                   // Line 105
	echo T_("variants");                                                              // Line 105
	echo T_("Add new product");                                                       // Line 106
	echo T_("Try to start with add new product!");                                    // Line 114

	//--------------------------------------------content_a/products/edit/display.html
	echo T_("Images");                                                                // Line 71
	echo T_("Shopping");                                                              // Line 118
	echo T_("This product has multiple options, like different sizes or colors");     // Line 145
	echo T_("Product Availability");                                                  // Line 170
	echo T_("Organization");                                                          // Line 190
	...
	echo T_("Sale in store");                                                         // Line 349
	...
	//--------------------------------------------content_test1/log/check/display.html
	echo T_("You are not starting yet!");                                             // Line 122

	//------------------------------------------content_test1/log/request/display.html

	//-------------------------------------------------content_test1/home/display.html

	//---------------------------------------------------content_cms/dayevent/chart.js
	echo T_("Day Event");                                                             // Line 27

	//---------------------------------------------------------content_cms/layout.html
