...
class twigTransTerms
{
 private function transtext()
 {
	...
	echo T_("Optimize your inventory decisions.");                                    // Line 80
	echo T_("Know which products are the most profitable and which you should re-order when.");// Line 80
	echo T_("Demand forecasting!");                                                   // Line 80
	echo T_("Receive recommendations on your products based on your rate of sales."); // Line 80
	echo T_("Units");                                                                 // Line 134
	echo T_("Dimensions");                                                            // Line 138
	echo T_("Cart Limit");                                                            // Line 161
	echo T_("Organization");                                                          // Line 194
	echo T_("Price change chart");                                                    // Line 222
	echo T_("Delete product");                                                        // Line 234
