...
class twigTransTerms
{
 private function transtext()
 {
	...
	echo T_("Soon");                                                                  // Line 270

	//--------------------------------------------------content\changelog\display.html
	echo T_("Date");                                                                  // Line 28
	...
	echo T_("We reach 10000 factor records.");                                        // Line 32
	echo T_("First factor of first store is generated.");                             // Line 37
	echo T_("Our first store on web is created and start add product to store.");     // Line 42
	echo T_("Beta version is released.");                                             // Line 47
	echo T_("Alfa version is released.");                                             // Line 52
	echo T_("We restart plans to run Jibres at Ermile.");                             // Line 57
	echo T_("The name of project selected as Jibres and <a href='https://Jibres.ir' target='_blank'>Jibres.ir</a> and <a href='https://Jibres.com'>Jibres.com</a> domains are registered.");// Line 62
	echo T_("Create git repository and first commit is pushed.");                     // Line 67
	echo T_("Database is completely designed and implementated.");                    // Line 72
	echo T_("02:00 AM");                                                              // Line 76
	echo T_("Start database analysis of Jibres.");                                    // Line 77
	echo T_("We were born to do Best!");                                              // Line 82
	echo T_("Be patient...");                                                         // Line 87
	...
	echo T_("Products");                                                              // Line 121
	echo T_("Qty");                                                                   // Line 110
	echo T_("Factor");                                                                // Line 503
	echo T_("Toman");                                                                 // Line 170
	...
	echo T_("Standard");                                                              // Line 215
	echo T_("Price");                                                                 // Line 192
	...
	echo T_("Total payable");                                                         // Line 115
	...
	echo T_("Row");                                                                   // Line 57
	echo T_("Product");                                                               // Line 36
	echo T_("Count");                                                                 // Line 36
	echo T_("Discount");                                                              // Line 201
	echo T_("Total");                                                                 // Line 113
	echo T_("Choose customer");                                                       // Line 110
	echo T_("Search in list to add product");                                         // Line 120
	echo T_("Last scanned barcode");                                                  // Line 146

	//----------------------------------------------content_a\factor\edit\display.html
	echo T_("Final Price");                                                           // Line 206
	echo T_("Save");                                                                  // Line 339
	...
	echo T_("Sale Invoice");                                                          // Line 47
	echo T_("Sum");                                                                   // Line 29
	echo T_("Your total discount and profits");                                       // Line 110

	//---------------------------------------content_a\factor\fishprint\fishprint.html
	echo T_("Customer");                                                              // Line 46
	echo T_("Address");                                                               // Line 470
	echo T_("Tel");                                                                   // Line 23

	//----------------------------------------------content_a\factor\home\display.html
	echo T_("No factor founded.");                                                    // Line 49
	echo T_("Search with new keywords or barcode.");                                  // Line 49
	echo T_("Add new factor");                                                        // Line 80
	echo T_("You are not have factor yet! add new one.");                             // Line 55
	echo T_("Search in factors list");                                                // Line 91
	echo T_("Search");                                                                // Line 50
	echo T_("You are not register any factor yet!");                                  // Line 78
	echo T_("Invoice Date");                                                          // Line 106
	echo T_("Type");                                                                  // Line 102
	echo T_("Items");                                                                 // Line 109
	echo T_("Sale");                                                                  // Line 38
	echo T_("Buy");                                                                   // Line 72
	echo T_("Prefactor");                                                             // Line 148
	echo T_("Lending");                                                               // Line 58
	echo T_("Backbuy");                                                               // Line 150
	echo T_("Backfactor");                                                            // Line 151
	echo T_("Waste");                                                                 // Line 152
	echo T_("Clear filters");                                                         // Line 192
	echo T_("Result not found!");                                                     // Line 191
	echo T_("Search with new keywords.");                                             // Line 191
	echo T_("Hi!");                                                                   // Line 198
	echo T_("Try to start with add new factor!");                                     // Line 174
	...
	echo T_("Products Summary");                                                      // Line 60
	echo T_("Add new Product");                                                       // Line 14
	echo T_("Sale Invoicing");                                                        // Line 90
	echo T_("Buy Invocing");                                                          // Line 100
	echo T_("Supplier");                                                              // Line 45
	echo T_("Staff");                                                                 // Line 44
	echo T_("Sales count group by hour");                                             // Line 149

	//-----------------------------------------------------------content_a\layout.html
	echo T_("Dashboard");                                                             // Line 5
	echo T_("Product List");                                                          // Line 13
	echo T_("Third Parties");                                                         // Line 21
	echo T_("Customers");                                                             // Line 230
	echo T_("Suppliers");                                                             // Line 249
	echo T_("Staffs");                                                                // Line 239
	echo T_("register new sale factor");                                              // Line 36
	echo T_("List of sales");                                                         // Line 37
	echo T_("List of purchases");                                                     // Line 38
	echo T_("List of all factors");                                                   // Line 39
	echo T_("Reports");                                                               // Line 45
	echo T_("Daily report");                                                          // Line 20
	echo T_("Monthly report");                                                        // Line 20
	echo T_("Setting");                                                               // Line 55
	echo T_("Store plans");                                                           // Line 58
	echo T_("Factor settings");                                                       // Line 59
	...
	echo T_("Warehouse");                                                             // Line 9

	//-------------------------------------------content_a\product\export\display.html
	echo T_("Please wait to complete export progress");                               // Line 11
	echo T_("Export");                                                                // Line 62

	//---------------------------------------------content_a\product\home\display.html
	echo T_("Duplicate title");                                                       // Line 7
	echo T_("Have barcode");                                                          // Line 8
	echo T_("Have not barcode");                                                      // Line 9
	echo T_("Just code");                                                             // Line 10
	echo T_("No barcode & code");                                                     // Line 11
	echo T_("Whitout buyprice");                                                      // Line 12
	echo T_("Whitout price");                                                         // Line 13
	...
	echo T_("Title");                                                                 // Line 219
	echo T_("Category");                                                              // Line 71
	echo T_("Final price");                                                           // Line 76
	echo T_("Stock");                                                                 // Line 305
	echo T_("Last modified");                                                         // Line 78
	echo T_("Code");                                                                  // Line 129
	...
	echo T_("General Detail");                                                        // Line 100
	echo T_("Delete product");                                                        // Line 47
	echo T_("Add");                                                                   // Line 335
	echo T_("Insert");                                                                // Line 43
	echo T_("Save All");                                                              // Line 129
	echo T_("allowed extentions jpg, png (gif for bussiness plans). Max 500Kb");      // Line 136
	echo T_("Name of product");                                                       // Line 78
	echo T_("Enter a valid name");                                                    // Line 22
	echo T_("Set short and best title for your product");                             // Line 86
	echo T_("Enter a valid team title");                                              // Line 86
	echo T_("Slug");                                                                  // Line 95
	echo T_("Manufacturer");                                                          // Line 102
	echo T_("Product manufacturer");                                                  // Line 105
	echo T_("Cat");                                                                   // Line 99
	echo T_("Organize by category");                                                  // Line 118
	echo T_("For quick access");                                                      // Line 131
	echo T_("Short code");                                                            // Line 139
	echo T_("Unit");                                                                  // Line 99
	echo T_("like Qty, kg, etc");                                                     // Line 149
	echo T_("Barcode");                                                               // Line 161
	echo T_("Scan Barcode here...");                                                  // Line 163
	echo T_("Barcode2");                                                              // Line 170
	echo T_("Scan Barcode2 here...");                                                 // Line 172
	echo T_("Buy price");                                                             // Line 190
	echo T_("Sale Price");                                                            // Line 196
	echo T_("Price for sale without discount");                                       // Line 198
	echo T_("Impure Interest Rate");                                                  // Line 199
	echo T_("Final Pure Price");                                                      // Line 208
	echo T_("Pure Interest Rates");                                                   // Line 209
	echo T_("Discount on sale");                                                      // Line 219
	echo T_("Discount Percent");                                                      // Line 220
	echo T_("Vat");                                                                   // Line 229
	echo T_("This product is vat base");                                              // Line 229
	echo T_("Initial Balance");                                                       // Line 237
	echo T_("Min stock");                                                             // Line 245
	echo T_("Max stock");                                                             // Line 254
	echo T_("Status of product");                                                     // Line 261
	echo T_("Avalible");                                                              // Line 265
	echo T_("Normal status of product");                                              // Line 265
	echo T_("maybe come in future and be available");                                 // Line 270
	echo T_("Unavailable");                                                           // Line 275
	echo T_("temporary does not exist in store");                                     // Line 275
	echo T_("Discountinued");                                                         // Line 280
	echo T_("does not exist for now and on the future");                              // Line 280
	echo T_("Unset");                                                                 // Line 285
	echo T_("Unknown status for product");                                            // Line 285
	echo T_("Sold");                                                                  // Line 509
	echo T_("Service");                                                               // Line 314
	echo T_("This product is service base and not a real goods");                     // Line 314
	echo T_("Sale Online");                                                           // Line 323
	echo T_("This product is saleonline base");                                       // Line 323
	echo T_("Sale in store");                                                         // Line 333
	echo T_("This product is salestore base");                                        // Line 333
	echo T_("Count in carton");                                                       // Line 341
	echo T_("Count of product in carton");                                            // Line 343
	...
	echo T_("Product with barcode2");                                                 // Line 111
	echo T_("Min");                                                                   // Line 154
	echo T_("Max");                                                                   // Line 163
	echo T_("Average");                                                               // Line 172
	echo T_("Buy Price");                                                             // Line 183

	//----------------------------------------content_a\product\warehouse\display.html
	...
	echo T_("Edit cat");                                                              // Line 21
	echo T_("Add new cat");                                                           // Line 23
	echo T_("All product by this cat changed to new value");                          // Line 36
	echo T_("No product in this cat");                                                // Line 38
	echo T_("You can delete it now!");                                                // Line 38
	echo T_("Edit");                                                                  // Line 135
	echo T_("Is default cat?");                                                       // Line 55
	echo T_("Decimal or Integer");                                                    // Line 65
	echo T_("Decimal");                                                               // Line 66
	echo T_("Integer");                                                               // Line 67
	echo T_("Max sale from this cat");                                                // Line 75
	echo T_("For example 100");                                                       // Line 77
	echo T_("Cat name");                                                              // Line 88
	echo T_("Count product");                                                         // Line 100
	echo T_("Max sale");                                                              // Line 103
	echo T_("Action");                                                                // Line 104
	echo T_("Is default");                                                            // Line 110
	echo T_("Without Cat");                                                           // Line 113

	//-------------------------------------------content_a\setting\factor\display.html
	echo T_("Print status");                                                          // Line 8
	echo T_("Pay setting");                                                           // Line 15
	echo T_("Pos setting");                                                           // Line 21
	...
	echo T_("Disable");                                                               // Line 290
	echo T_("Enable");                                                                // Line 289
	...
	echo T_("Status");                                                                // Line 286
	echo T_("Detail");                                                                // Line 106
	echo T_("Is default inventory");                                                  // Line 117
	echo T_("Sale from this inventory");                                              // Line 118
	echo T_("Sale online");                                                           // Line 119
	echo T_("Country");                                                               // Line 176
	echo T_("Choose your country");                                                   // Line 180
	echo T_("City");                                                                  // Line 195
	echo T_("Select city");                                                           // Line 197
	echo T_("Post code");                                                             // Line 210
	echo T_("Phone");                                                                 // Line 246
	echo T_("Fax");                                                                   // Line 236

	//---------------------------------------------------content_a\setting\layout.html
	echo T_("Public");                                                                // Line 25
	echo T_("Plan");                                                                  // Line 34
	echo T_("Units");                                                                 // Line 43
	echo T_("Cats");                                                                  // Line 52
	echo T_("Inventory");                                                             // Line 71
	echo T_("Without traffic");                                                       // Line 92
	echo T_("Last traffic");                                                          // Line 94
	echo T_("Store Plan");                                                            // Line 101
	echo T_("Security and privacy");                                                  // Line 103
	echo T_("Report Settings");                                                       // Line 104
	echo T_("Team short name");                                                       // Line 154
	echo T_("Used for url of board");                                                 // Line 154
	echo T_("Slug of team for board url");                                            // Line 156
	echo T_("Website");                                                               // Line 165
	echo T_("Link your logo on board for visitors");                                  // Line 163
	echo T_("For show in factors");                                                   // Line 193
	echo T_("Used for description of board and show in social media links");          // Line 187
	echo T_("Choose your plan");                                                      // Line 200
	echo T_("All the basics for personal use.");                                      // Line 204
	echo T_("Everything you need for a growing business.");                           // Line 210
	echo T_("Yearly");                                                                // Line 215
	echo T_("Everything in Free plus automatic report via Telegram.");                // Line 222
	echo T_("Simple");                                                                // Line 222
	echo T_("Full");                                                                  // Line 226
	echo T_("For big companies that need fix price per month.");                      // Line 226
	echo T_("Force show in specefic language");                                       // Line 235
	echo T_("Please select one language");                                            // Line 237
	echo T_("Persian");                                                               // Line 238
	echo T_("English");                                                               // Line 239
	echo T_("Report Header");                                                         // Line 249
	echo T_("Report Footer");                                                         // Line 257
	echo T_("Active print factor");                                                   // Line 268
	echo T_("Fish print");                                                            // Line 312
	echo T_("A4");                                                                    // Line 316
	echo T_("A5");                                                                    // Line 320
	echo T_("Default print_size");                                                    // Line 306
	echo T_("No default");                                                            // Line 566
	echo T_("Cash");                                                                  // Line 375
	echo T_("Pos");                                                                   // Line 379
	echo T_("Check");                                                                 // Line 353
	echo T_("Default pay");                                                           // Line 563
	echo T_("Cheque");                                                                // Line 371
	...
	echo T_("Edit unit");                                                             // Line 21
	echo T_("Add new unit");                                                          // Line 23
	echo T_("All product by this unit changed to new value");                         // Line 36
	echo T_("No product in this unit");                                               // Line 38
	echo T_("Is default unit?");                                                      // Line 55
	echo T_("Max sale from this unit");                                               // Line 75
	echo T_("Unit name");                                                             // Line 88
	echo T_("Without Unit");                                                          // Line 113
	...
	//---------------------------------------content_a\thirdparty\address\display.html
	echo T_("Edit address");                                                          // Line 38
	echo T_("Add new address");                                                       // Line 41
	echo T_("Firstname");                                                             // Line 159
	echo T_("Lastname");                                                              // Line 168
	echo T_("Require");                                                               // Line 245
	echo T_("Address line 2");                                                        // Line 252
	echo T_("Yes");                                                                   // Line 261
	echo T_("No");                                                                    // Line 261
	echo T_("Is this a company's address?");                                          // Line 262
	echo T_("Company name");                                                          // Line 344
	echo T_("Job title");                                                             // Line 280
	echo T_("Select one item");                                                       // Line 288
	echo T_("Removed");                                                               // Line 291

	//----------------------------------------content_a\thirdparty\avatar\display.html

	//---------------------------------------content_a\thirdparty\comment\display.html
	echo T_("Add note");                                                              // Line 28
	echo T_("Add every thing");                                                       // Line 20

	//---------------------------------------content_a\thirdparty\company\display.html

	//---------------------------------------content_a\thirdparty\general\display.html
	echo T_("Contact detail");                                                        // Line 40
	echo T_("Permission");                                                            // Line 46
	echo T_("No permission");                                                         // Line 49
	echo T_("Type of thirdparty");                                                    // Line 9

	//----------------------------------------content_a\thirdparty\glance\display.html
	echo T_("Joined to store at");                                                    // Line 13
	echo T_("Last activity");                                                         // Line 94
	echo T_("Budget");                                                                // Line 50
	echo T_("Credit");                                                                // Line 500
	echo T_("Customer total order");                                                  // Line 65
	echo T_("Customer total spend");                                                  // Line 69
	echo T_("Customer last spend");                                                   // Line 91
	echo T_("Supplier total purchased order");                                        // Line 77
	echo T_("Supplier total purchased");                                              // Line 81
	...
	echo T_("Tag keywords...");                                                       // Line 86
	echo T_("Save tag");                                                              // Line 92
	...
	echo T_("Click to choose new image as avatar");                                   // Line 264
	echo T_("Avatar");                                                                // Line 265
	echo T_("Nationality");                                                           // Line 275
	echo T_("Choose your nationality");                                               // Line 279
	echo T_("National card photo");                                                   // Line 294
	echo T_("ID card image");                                                         // Line 304
	echo T_("Passport card image");                                                   // Line 314
	echo T_("Marital");                                                               // Line 324
	echo T_("Please select one itme");                                                // Line 326
	echo T_("Single");                                                                // Line 327
	echo T_("Married");                                                               // Line 328
	echo T_("Enter company name");                                                    // Line 346
	echo T_("Economic code");                                                         // Line 356
	echo T_("Enter economic code");                                                   // Line 358
	echo T_("Company national id");                                                   // Line 364
	echo T_("Enter company national id");                                             // Line 366
	echo T_("Company register number");                                               // Line 373
	echo T_("Enter register number");                                                 // Line 375
	echo T_("Visitor name");                                                          // Line 386
	echo T_("Identify code");                                                         // Line 395
	echo T_("Customer code");                                                         // Line 402
	echo T_("Desctiption");                                                           // Line 410
	echo T_("Glance");                                                                // Line 422
	echo T_("Profile");                                                               // Line 431
	echo T_("Billing");                                                               // Line 6
	echo T_("Logs");                                                                  // Line 449
	echo T_("Notes");                                                                 // Line 463
	echo T_("General");                                                               // Line 466
	echo T_("Identify");                                                              // Line 473
	echo T_("avatar");                                                                // Line 476
	echo T_("Company Detail");                                                        // Line 479
	echo T_("Manage");                                                                // Line 482
	echo T_("Transaction");                                                           // Line 496
	echo T_("Has bought");                                                            // Line 506

	//----------------------------------------content_a\thirdparty\manage\display.html

	//---------------------------------------content_a\thirdparty\profile\display.html
