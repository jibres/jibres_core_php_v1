...
class twigTransTerms
{
 private function transtext()
 {
	...
	echo T_("Country");                                                               // Line 124
	echo T_("Choose your country");                                                   // Line 128
	...
	echo T_("Delete file");                                                           // Line 141
	echo T_("Category image");                                                        // Line 145
	echo T_("Max 1Mb");                                                               // Line 146
	...
	echo T_("SKU");                                                                   // Line 716
	echo T_("Only product by check the need box and set price and stock can add to your product list!");// Line 732
