...
class twigTransTerms
{
 private function transtext()
 {
	...
	echo T_("For someones ready to use Jibres as hero.");                             // Line 48
	echo T_("<span class='bold'>Everything you need</span> for a growing business."); // Line 48
	...
	echo T_("Clear filters");                                                         // Line 229
	echo T_("Result not found!");                                                     // Line 228
	echo T_("Search with new keywords.");                                             // Line 228
	echo T_("Hi!");                                                                   // Line 235
	...
	echo T_("More");                                                                  // Line 179
	echo T_("Sale");                                                                  // Line 266
	echo T_("Prefactor");                                                             // Line 304
	echo T_("Lending");                                                               // Line 316
	echo T_("Backbuy");                                                               // Line 211
	echo T_("Backfactor");                                                            // Line 212
	echo T_("Waste");                                                                 // Line 213
	echo T_("Try to start with add new sale!");                                       // Line 236
	echo T_("Try to start with add new buy!");                                        // Line 237
	echo T_("All");                                                                   // Line 256
	echo T_("Other");                                                                 // Line 288
	echo T_("Back buy");                                                              // Line 308
	echo T_("Back factor");                                                           // Line 312
	echo T_("waste");                                                                 // Line 320
