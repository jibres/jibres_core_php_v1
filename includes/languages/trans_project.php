...
class twigTransTerms
{
 private function transtext()
 {
	...
	echo T_("Add new Product");                                                       // Line 82
	...
	echo T_("Code");                                                                  // Line 81
	echo T_("Clear filters");                                                         // Line 171
	...
	echo T_("Result not found!");                                                     // Line 170
	echo T_("Search with new keywords.");                                             // Line 170
