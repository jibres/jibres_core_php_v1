...
class twigTransTerms
{
 private function transtext()
 {
	...
	echo T_("Search in factors list");                                                // Line 100
	echo T_("Search");                                                                // Line 77
	echo T_("You are not register any factor yet!");                                  // Line 85
	echo T_("Supplier");                                                              // Line 45
	echo T_("Items");                                                                 // Line 116
	echo T_("Invoice Date");                                                          // Line 121
	echo T_("Type");                                                                  // Line 84
	echo T_("Operation");                                                             // Line 125
	echo T_("Whithout name");                                                         // Line 140
	echo T_("Quick");                                                                 // Line 145
	echo T_("View");                                                                  // Line 164
	echo T_("Sale");                                                                  // Line 235
	echo T_("Buy");                                                                   // Line 75
	echo T_("Prefactor");                                                             // Line 273
	echo T_("Lending");                                                               // Line 285
	echo T_("Backbuy");                                                               // Line 180
	echo T_("Backfactor");                                                            // Line 181
	echo T_("Waste");                                                                 // Line 182
	echo T_("Clear filters");                                                         // Line 127
	echo T_("Result not found!");                                                     // Line 126
	echo T_("Search with new keywords.");                                             // Line 126
	echo T_("Hi!");                                                                   // Line 205
	echo T_("Try to start with add new sale!");                                       // Line 205
	echo T_("Try to start with add new buy!");                                        // Line 206
	echo T_("All");                                                                   // Line 225
	echo T_("Other");                                                                 // Line 257
	echo T_("Back buy");                                                              // Line 277
	echo T_("Back factor");                                                           // Line 281
	echo T_("waste");                                                                 // Line 289
	...
	echo T_("Discount Percent");                                                      // Line 203
	echo T_("%");                                                                     // Line 141
	...
	echo T_("POS");                                                                   // Line 93
	echo T_("Without traffic");                                                       // Line 106
	echo T_("Last traffic");                                                          // Line 108
	echo T_("General Detail");                                                        // Line 114
	echo T_("Store Plan");                                                            // Line 115
	echo T_("Security and privacy");                                                  // Line 117
	echo T_("Report Settings");                                                       // Line 118
	...
	echo T_("Fish print");                                                            // Line 326
	echo T_("A4");                                                                    // Line 330
	echo T_("A5");                                                                    // Line 334
	echo T_("Default print_size");                                                    // Line 320
	echo T_("No default");                                                            // Line 382
	echo T_("Cash");                                                                  // Line 96
	echo T_("Check");                                                                 // Line 367
	echo T_("Default pay");                                                           // Line 379
	echo T_("Cheque");                                                                // Line 385
