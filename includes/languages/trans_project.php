...
class twigTransTerms
{
 private function transtext()
 {
	...
	echo T_("Enter a valid name");                                                    // Line 78
	...
	echo T_("Price");                                                                 // Line 40
	echo T_("Toman");                                                                 // Line 116
	...
	echo T_("Add new Product");                                                       // Line 79
	echo T_("Third Parties");                                                         // Line 21
	echo T_("Customers");                                                             // Line 169
	echo T_("Staffs");                                                                // Line 178
	echo T_("Suppliers");                                                             // Line 188
	...
	echo T_("Enter a valid name from 3 to 40 character");                             // Line 180
	...
	echo T_("Edit");                                                                  // Line 131
	echo T_("Disable");                                                               // Line 283
	echo T_("Enable");                                                                // Line 282
	...
	echo T_("Choose your country");                                                   // Line 173
	echo T_("City");                                                                  // Line 188
	echo T_("Select city");                                                           // Line 190
	echo T_("Post code");                                                             // Line 203
	echo T_("Fax");                                                                   // Line 229
	...
	echo T_("Unit");                                                                  // Line 147
	echo T_("Count product");                                                         // Line 100
	echo T_("Type");                                                                  // Line 108
	...
	echo T_("Type of thirdparty");                                                    // Line 74
	echo T_("Customer");                                                              // Line 31
	echo T_("Staff");                                                                 // Line 131
	echo T_("Supplier");                                                              // Line 121
	echo T_("Identification detail");                                                 // Line 99
	echo T_("Location and address");                                                  // Line 100
	echo T_("Tag");                                                                   // Line 119
	echo T_("Add tag manually to link thirdparty togethers");                         // Line 129
	echo T_("Tag keywords...");                                                       // Line 130
	echo T_("Save tag");                                                              // Line 136
	echo T_("Salesman Name");                                                         // Line 157
	echo T_("Last name");                                                             // Line 65
	echo T_("Like");                                                                  // Line 298
	echo T_("National code");                                                         // Line 211
	echo T_("10 digit national code");                                                // Line 213
	echo T_("Father name");                                                           // Line 221
	echo T_("Birthday");                                                              // Line 227
	echo T_("Gender");                                                                // Line 63
	echo T_("Mr");                                                                    // Line 77
	echo T_("Mrs");                                                                   // Line 77
	echo T_("Birth city");                                                            // Line 252
	echo T_("Passport id");                                                           // Line 265
	echo T_("Nationality");                                                           // Line 317
	echo T_("Choose your nationality");                                               // Line 321
	echo T_("National card photo");                                                   // Line 336
	echo T_("ID card image");                                                         // Line 346
	echo T_("Passport card image");                                                   // Line 356
	echo T_("Marital");                                                               // Line 366
	echo T_("Please select one itme");                                                // Line 368
	echo T_("Single");                                                                // Line 369
	echo T_("Married");                                                               // Line 370
	echo T_("Company name");                                                          // Line 264
	echo T_("Enter company name");                                                    // Line 388
	echo T_("Economic code");                                                         // Line 398
	echo T_("Enter economic code");                                                   // Line 400
	echo T_("Company national id");                                                   // Line 406
	echo T_("Enter company national id");                                             // Line 408
	echo T_("Company register number");                                               // Line 415
	echo T_("Enter register number");                                                 // Line 417
	echo T_("Visitor name");                                                          // Line 428
	echo T_("Identify code");                                                         // Line 437
	echo T_("Customer code");                                                         // Line 444
	echo T_("Desctiption");                                                           // Line 452
	echo T_("Glance");                                                                // Line 464
	echo T_("Profile");                                                               // Line 473
	echo T_("Has bought");                                                            // Line 482
	echo T_("Sold");                                                                  // Line 296
	echo T_("Factors");                                                               // Line 501
	echo T_("Logs");                                                                  // Line 510
	echo T_("General");                                                               // Line 524
	echo T_("Identify");                                                              // Line 531
	echo T_("avatar");                                                                // Line 534
	echo T_("Company Detail");                                                        // Line 537
	...
	echo T_("Contact detail");                                                        // Line 37

	//------------------------------------------content_a/thirdparty/home/display.html
	echo T_("Search");                                                                // Line 95
	echo T_("Enter 2 space for search in firstname and lastname and father");         // Line 49
	echo T_("Code");                                                                  // Line 80
	echo T_("Whitout name");                                                          // Line 86
	echo T_("Whitout mobile");                                                        // Line 95
	echo T_("transaction");                                                           // Line 108
	echo T_("Clear filters");                                                         // Line 168
	echo T_("Result not found!");                                                     // Line 167
	echo T_("Search with new keywords.");                                             // Line 167
	echo T_("Hi!");                                                                   // Line 174
	echo T_("Try to start with add new member!");                                     // Line 137
	echo T_("All thirdparty");                                                        // Line 160
	...
	echo T_("Edit address");                                                          // Line 37
	echo T_("Add new address");                                                       // Line 40
	echo T_("Saved address");                                                         // Line 80
	echo T_("Firstname");                                                             // Line 152
	echo T_("Lastname");                                                              // Line 161
	echo T_("Title");                                                                 // Line 70
	echo T_("Require");                                                               // Line 238
	echo T_("Address line 2");                                                        // Line 245
	echo T_("Yes");                                                                   // Line 254
	echo T_("No");                                                                    // Line 254
	echo T_("Is this a company's address?");                                          // Line 255
	echo T_("Job title");                                                             // Line 273
	echo T_("Select one item");                                                       // Line 281
	echo T_("Removed");                                                               // Line 284
	...
	echo T_("Sale");                                                                  // Line 146
	echo T_("Pre Sale");                                                              // Line 48
	echo T_("Lending");                                                               // Line 149
