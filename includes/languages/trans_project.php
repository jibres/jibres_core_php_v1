...
class twigTransTerms
{
 private function transtext()
 {
	...
	//-------------------------rojects/jibres/content_subdomain/theme_full/header.html
	...
	//---------------------------rojects/jibres/content_subdomain/product/display.html
	echo T_("Submit");                                                                // Line 226
	echo T_("Your rate");                                                             // Line 27
	echo T_("Write your comment...");                                                 // Line 44

	//---------------------------------rojects/jibres/content_subdomain/home/site.html
	echo T_("Products");                                                              // Line 13

	//--------------------------rojects/jibres/content_subdomain/products/display.html
	...
	//----------------------------rojects/jibres/content_subdomain/main/visitcard.html
	echo T_("Tel");                                                                   // Line 51
	echo T_("Store Panel");                                                           // Line 16

	//------------------------rojects/jibres/content_subdomain/theme_start/header.html

	//----------------------------------rojects/jibres/content/enterprise/display.html
	...
	//----------------------------------------rojects/jibres/content/help/display.html
	echo T_("Soon");                                                                  // Line 286

	//------------------------------------rojects/jibres/content/help/faq/display.html
	...
	//------------------------------------rojects/jibres/content/benefits/display.html

	//----------------------------------------rojects/jibres/content/logo/display.html
	echo T_("Jibres logo");                                                           // Line 15

	//---------------------------------------rojects/jibres/content/about/display.html
	...
	//---------------------------------------rojects/jibres/content/terms/display.html
	...
	//-------------------------------------rojects/jibres/content/template/footer.html
	echo T_("Home");                                                                  // Line 5
	...
	//-------------------------------------rojects/jibres/content/template/header.html
	echo T_("Beta");                                                                  // Line 7
	echo T_("Admin Panel");                                                           // Line 18

	//-------------------------------------rojects/jibres/content/contact/display.html
	...
	//----------------------------------------rojects/jibres/content/home/display.html
	...
	//----------------------------------rojects/jibres/content/pricing/priceTable.html
	...
	//-------------------------------------rojects/jibres/content/pricing/display.html
	...
	//-------------------------------------rojects/jibres/content/privacy/display.html
	...
	//------------------------rojects/jibres/content/socialresponsibility/display.html
	...
	//----------------------------------------rojects/jibres/content/blog/display.html
	echo T_("View your current location and navigate to parent of it");               // Line 222
	echo T_("Read more");                                                             // Line 97

	//--------------------------------rojects/jibres/content_pay/redirect/display.html
	echo T_("Go");                                                                    // Line 153

	//------------------------------------rojects/jibres/content_pay/home/display.html
	...
	//-----------------------rojects/jibres/public_html/static/siftal/js/error_page.js

	//--------------------rojects/jibres/public_html/static/siftal/js/highlight.min.js

	//--------rojects/jibres/public_html/static/siftal/js/highcharts/highcharts.min.js

	//-------------rojects/jibres/public_html/static/fonts/siftal/icons-reference.html

	//---------------------------------rojects/jibres/public_html/static/js/slider1.js

	//------------------------------rojects/jibres/public_html/static/js/storePanel.js

	//---------------------------rojects/jibres/public_html/static/js/particles.min.js

	//--------------------rojects/jibres/public_html/static/js/gulp/dist/storePanel.js

	//-------rojects/jibres/public_html/static/js/gulp/dist/storePanel.uncompressed.js

	//---rojects/jibres/public_html/static/js/gulp/src/storePanel/JsBarcode.all.min.js

	//----------------------------------rojects/jibres/public_html/static/js/script.js

	//--------------------------------rojects/jibres/content_a/permission/display.html
	...
	//-------------------------rojects/jibres/content_a/permission/delete/display.html
	...
	//-------------------------------rojects/jibres/content_a/setting/sms/display.html
	...
	//---------------------------rojects/jibres/content_a/setting/general/display.html
	echo T_("Enable");                                                                // Line 220
	echo T_("Closed");                                                                // Line 46

	//------------------------------rojects/jibres/content_a/setting/fund/display.html
	...
	//----------------------------rojects/jibres/content_a/setting/factor/display.html
	...
	//--------------------rojects/jibres/content_a/setting/plan/currentPlanDetail.html
	...
	//---------------------------rojects/jibres/content_a/setting/plan/choosePlan.html
	echo T_("Your plan have some days!");                                             // Line 19
	echo T_("Are you sure to change your plan?");                                     // Line 20

	//------------------------------rojects/jibres/content_a/setting/plan/display.html
	...
	//-------------------------rojects/jibres/content_a/setting/plan/choosePeriod.html

	//---------------------------rojects/jibres/content_a/setting/payment/display.html
	...
	//------------------------------rojects/jibres/content_a/setting/home/display.html
	echo T_("Hi");                                                                    // Line 7

	//----------------------------rojects/jibres/content_a/setting/social/display.html
	...
	//---------------------------rojects/jibres/content_a/setting/maximum/display.html
	...
	//------------------------------------rojects/jibres/content_a/setting/layout.html
	...
	//-------------------------------rojects/jibres/content_a/setting/pos/display.html
	...
	//-------------------------rojects/jibres/content_a/setting/inventory/display.html
	...
	//---------------------------------------rojects/jibres/content_a/buy/display.html
	...
	//--------------------------rojects/jibres/content_a/customer/comment/display.html
	...
	//--------------------------rojects/jibres/content_a/customer/general/display.html
	...
	//--------------------------rojects/jibres/content_a/customer/profile/display.html

	//---------------------------rojects/jibres/content_a/customer/export/display.html
	...
	//--------------------------rojects/jibres/content_a/customer/billing/display.html
	...
	//------------------rojects/jibres/content_a/customer/plustransaction/display.html
	...
	//-----------------rojects/jibres/content_a/customer/minustransaction/display.html
	echo T_("Minus amount of budget");                                                // Line 53

	//---------------------------rojects/jibres/content_a/customer/glance/display.html
	...
	//-----------------------------rojects/jibres/content_a/customer/home/display.html
	...
	//---------------------------rojects/jibres/content_a/customer/manage/display.html
	...
	//---------------------------rojects/jibres/content_a/customer/credit/display.html
	...
	//-----------------------------------rojects/jibres/content_a/customer/layout.html
	...
	//---------------------------rojects/jibres/content_a/customer/avatar/display.html

	//--------------------------rojects/jibres/content_a/customer/company/display.html
	...
	//------------------------------rojects/jibres/content_a/customer/add/display.html
	...
	//----------------------rojects/jibres/content_a/customer/transaction/display.html
	...
	//-------------------------------rojects/jibres/content_a/cats/remove/display.html
	...
	//---------------------------------rojects/jibres/content_a/cats/home/display.html
	...
	//-----------------------------rojects/jibres/content_a/cats/property/display.html
	...
	//---------------------------------------rojects/jibres/content_a/cats/layout.html
	echo T_("Setting");                                                               // Line 58
	echo T_("Property");                                                              // Line 590

	//---------------------------------rojects/jibres/content_a/cats/edit/display.html
	...
	//----------------------------------rojects/jibres/content_a/cats/add/display.html

	//-------------------------------rojects/jibres/content_a/factor/home/display.html
	...
	//-------------------------------rojects/jibres/content_a/factor/edit/display.html
	...
	//---------------------------------------rojects/jibres/content_a/pay/display.html
	...
	//-------------------rojects/jibres/content_a/chap/size-receipt/receipt-short.html
	echo T_("Customer Detail");                                                       // Line 43
	echo T_("Sale Invoice");                                                          // Line 65
	echo T_("Sum");                                                                   // Line 29
	echo T_("Your total discount and profits");                                       // Line 128

	//--------------------rojects/jibres/content_a/chap/size-receipt/receipt-long.html

	//-------------------------rojects/jibres/content_a/chap/size-receipt/receipt.html

	//-----------------------------------rojects/jibres/content_a/chap/size-a4/a4.html
	echo T_("Buyer Detail");                                                          // Line 42

	//--------------------------------------rojects/jibres/content_a/chap/display.html
	echo T_("Another print formats");                                                 // Line 8
	echo T_("Please choose one format to print factor");                              // Line 21

	//--------------------rojects/jibres/content_a/thirdparty-old/comment/display.html

	//--------------------rojects/jibres/content_a/thirdparty-old/general/display.html
	echo T_("Type of thirdparty");                                                    // Line 9

	//--------------------rojects/jibres/content_a/thirdparty-old/profile/display.html

	//---------------------rojects/jibres/content_a/thirdparty-old/export/display.html

	//--------------------rojects/jibres/content_a/thirdparty-old/billing/display.html

	//------------rojects/jibres/content_a/thirdparty-old/plustransaction/display.html

	//-----------rojects/jibres/content_a/thirdparty-old/minustransaction/display.html

	//---------------------rojects/jibres/content_a/thirdparty-old/glance/display.html

	//-----------------------rojects/jibres/content_a/thirdparty-old/home/display.html
	...
	//---------------------rojects/jibres/content_a/thirdparty-old/manage/display.html

	//---------------------rojects/jibres/content_a/thirdparty-old/credit/display.html
	...
	//-----------------------------rojects/jibres/content_a/thirdparty-old/layout.html
	echo T_("Add tag manually to link thirdparty togethers");                         // Line 478

	//---------------------rojects/jibres/content_a/thirdparty-old/avatar/display.html

	//--------------------rojects/jibres/content_a/thirdparty-old/company/display.html

	//------------------------rojects/jibres/content_a/thirdparty-old/add/display.html

	//----------------rojects/jibres/content_a/thirdparty-old/transaction/display.html

	//------------------------------------------rojects/jibres/content_a/home/chart.js
	echo T_("Sum factor price and count of it group by hours");                       // Line 20
	echo T_("Sum price");                                                             // Line 87

	//--------------------------------------rojects/jibres/content_a/home/display.html
	...
	//--------------------------------------------rojects/jibres/content_a/layout.html
	...
	//----------------------------------rojects/jibres/content_a/report/month/chart.js

	//------------------------------rojects/jibres/content_a/report/month/display.html

	//----------------------------------rojects/jibres/content_a/report/daily/chart.js

	//------------------------------rojects/jibres/content_a/report/daily/display.html

	//-------------------------------rojects/jibres/content_a/report/home/display.html
	echo T_("Report daily");                                                          // Line 17
	echo T_("Report Month");                                                          // Line 28

	//----------------------------rojects/jibres/content_a/products/units/display.html
	...
	//-----------------------------------rojects/jibres/content_a/products/filter.html
	...
	//----------------------------rojects/jibres/content_a/products/price/display.html

	//-----------------------------rojects/jibres/content_a/products/edit/display.html
	...
	//-------------------------rojects/jibres/content_a/--product/summary/display.html
	...
	//--------------------------rojects/jibres/content_a/--product/factor/display.html

	//---------------------------rojects/jibres/content_a/--product/units/display.html

	//--------------------------rojects/jibres/content_a/--product/export/display.html
	echo T_("Please wait to complete export progress");                               // Line 11

	//-------------------------rojects/jibres/content_a/--product/gallery/display.html
	...
	//----------------------------------rojects/jibres/content_a/--product/filter.html
	...
	//------------------------rojects/jibres/content_a/--product/pricehistory/chart.js
	echo T_("Price change in time line");                                             // Line 26

	//--------------------------rojects/jibres/content_a/--product/lprice/display.html
	...
	//--------------------------rojects/jibres/content_a/--product/glance/display.html
	...
	//----------------------------rojects/jibres/content_a/--product/home/display.html

	//-----------------------rojects/jibres/content_a/--product/guarantee/display.html
	...
	//--------------------------rojects/jibres/content_a/--product/lstock/display.html

	//------------------------rojects/jibres/content_a/--product/property/display.html
	echo T_("This property loaded from default property of category");                // Line 42
	echo T_("key");                                                                   // Line 103

	//--------------------------rojects/jibres/content_a/--product/manage/display.html

	//----------------------------------rojects/jibres/content_a/--product/layout.html
	...
	//------------------------rojects/jibres/content_a/--product/variants/display.html

	//-------------------------rojects/jibres/content_a/--product/company/display.html
	...
	//----------------------------rojects/jibres/content_a/--product/sale/display.html
	echo T_("Sale in site");                                                          // Line 30
	echo T_("Sale in physical");                                                      // Line 57

	//---------------------------rojects/jibres/content_a/--product/stock/display.html
	...
	//--------------------------------rojects/jibres/content_enter/google/display.html
	echo T_("You must not be here!");                                                 // Line 7

	//----------------------------------rojects/jibres/content_enter/pass/display.html
	echo T_("Can't access your account?");                                            // Line 12

	//-------------------------rojects/jibres/content_enter/pass/recovery/display.html
	echo T_("Remembered your password?");                                             // Line 58

	//------------------------------rojects/jibres/content_enter/callback/display.html

	//-------------------------------rojects/jibres/content_enter/twostep/display.html
	...
	//----------------------------------rojects/jibres/content_enter/okay/display.html
	echo T_("You are logined ;)");                                                    // Line 8
	echo T_("Be patient or");                                                         // Line 9
	echo T_("click here!");                                                           // Line 9

	//-----------------------rojects/jibres/content_enter/username/change/display.html
	echo T_("Remove username");                                                       // Line 12

	//----------------------------------rojects/jibres/content_enter/home/display.html
	echo T_("You");                                                                   // Line 8

	//-----------------------------------rojects/jibres/content_enter/app/display.html

	//--------------------------------rojects/jibres/content_enter/byebye/display.html
	...
	//---------------------------rojects/jibres/content_enter/verify/what/display.html
	...
	//--------------------------------rojects/jibres/content_enter/verify/display.html
	...
	//--------------------------rojects/jibres/content_enter/verify/email/display.html

	//--------------------------rojects/jibres/content_enter/verify/later/display.html
	echo T_("You must confirm your mobile in the future");                            // Line 7
	echo T_("Verify now");                                                            // Line 10

	//-------------------rojects/jibres/content_enter/email/change/google/display.html
	...
	//--------------------------rojects/jibres/content_enter/email/change/display.html
	echo T_("Remove my email address");                                               // Line 12

	//---------------------------------rojects/jibres/content_enter/block/display.html
	echo T_("You are blocked becauese of some reason!");                              // Line 7
	echo T_("If have problem");                                                       // Line 8
	echo T_("Contact us");                                                            // Line 28

	//--------------------------------rojects/jibres/content_enter/delete/display.html
	echo T_("Why you want to delete your account!?");                                 // Line 5

	//------------------------rojects/jibres/content_enter/delete/request/display.html
	...
	//------------------------------rojects/jibres/content_crm/permission/display.html

	//-------------------------rojects/jibres/content_crm/permission/add/permView.html

	//-----------------------rojects/jibres/content_crm/permission/delete/display.html

	//----------------------------rojects/jibres/content_crm/sms/template/display.html
	...
	//--------------------------------rojects/jibres/content_crm/sms/send/display.html
	echo T_("What do you want to send to this user?");                                // Line 59
	echo T_("Template");                                                              // Line 46
	echo T_("No template");                                                           // Line 41
	echo T_("Show");                                                                  // Line 9

	//--------------------------------rojects/jibres/content_crm/sms/home/display.html
	echo T_("Your sms panel balance");                                                // Line 18
	echo T_("Send quick");                                                            // Line 27
	echo T_("Group send");                                                            // Line 36

	//------------------------------rojects/jibres/content_crm/sms/verify/display.html

	//-------------------------------rojects/jibres/content_crm/sms/group/display.html
	...
	//------------------------------------rojects/jibres/content_crm/home/display.html
	...
	//----------------------------------rojects/jibres/content_crm/home/solid-gauge.js

	//----------------------rojects/jibres/content_crm/transactions/minus/display.html
	echo T_("Minus charge account");                                                  // Line 46

	//-----------------------------rojects/jibres/content_crm/transactions/layout.html
	...
	//----------------------------rojects/jibres/content_crm/transactions/display.html
	...
	//------------------------rojects/jibres/content_crm/transactions/add/display.html

	//--------------------------rojects/jibres/content_crm/member/general/display.html
	...
	//-------------------rojects/jibres/content_crm/member/identification/display.html
	echo T_("ID Cards");                                                              // Line 17
	echo T_("Thumb");                                                                 // Line 29

	//--------------------------rojects/jibres/content_crm/member/billing/display.html
	echo T_("Billing History");                                                       // Line 65
	echo T_("Invoice");                                                               // Line 73
	echo T_("The user have not payment history yet!");                                // Line 77

	//----------------------------rojects/jibres/content_crm/member/notif/display.html
	...
	//---------------------------rojects/jibres/content_crm/member/glance/display.html
	echo T_("Log");                                                                   // Line 38
	...
	//--------------------------rojects/jibres/content_crm/member/contact/display.html

	//-----------------------------rojects/jibres/content_crm/member/home/display.html
	...
	//---------------------------rojects/jibres/content_crm/member/social/display.html
	...
	//-------------------------rojects/jibres/content_crm/member/security/display.html
	...
	//-----------------------------------rojects/jibres/content_crm/member/layout.html
	...
	//---------------------------rojects/jibres/content_crm/member/ticket/display.html
	echo T_("User ticket");                                                           // Line 21
	echo T_("Solved");                                                                // Line 37
	echo T_("Created on");                                                            // Line 41
	echo T_("Last modified on");                                                      // Line 41

	//---------------------------rojects/jibres/content_crm/member/avatar/display.html
	echo T_("Set your avatar");                                                       // Line 38

	//----------------------rojects/jibres/content_crm/member/description/display.html

	//------------------------rojects/jibres/content_crm/member/education/display.html
	echo T_("Education detail");                                                      // Line 15
	echo T_("Education Course");                                                      // Line 46

	//------------------------------------------rojects/jibres/content_crm/layout.html
	echo T_("CRM");                                                                   // Line 6
	...
	//------------------------------rojects/jibres/content_crm/email/send/display.html

	//------------------------------rojects/jibres/content_crm/email/home/display.html

	//-------------------------------rojects/jibres/content_crm/log/home/logTable.html
	...
	//--------------------------------rojects/jibres/content_crm/log/home/display.html
	...
	//-------------------------------rojects/jibres/content_i/cheque/home/display.html
	...
	//-------------------------------------rojects/jibres/content_i/cheque/layout.html
	...
	//---------------------------rojects/jibres/content_i/chequebook/home/display.html
	echo T_("First serial");                                                          // Line 32
	echo T_("Number");                                                                // Line 62
	echo T_("Page count");                                                            // Line 40

	//---------------------------------rojects/jibres/content_i/chequebook/layout.html
	echo T_("bank");                                                                  // Line 21

	//-----------------------------rojects/jibres/content_i/category/home/display.html
	echo T_("Parent");                                                                // Line 134
	echo T_("Use in incoming");                                                       // Line 59
	echo T_("Without parent");                                                        // Line 125
	echo T_("Edit on");                                                               // Line 78

	//-----------------------------------rojects/jibres/content_i/category/layout.html
	echo T_("Use in incoming record?");                                               // Line 40

	//--------------------------------rojects/jibres/content_i/inout/home/display.html
	echo T_("Jib");                                                                   // Line 71

	//--------------------------------------rojects/jibres/content_i/inout/layout.html
	echo T_("Price ");                                                                // Line 12
	echo T_("Is plus?");                                                              // Line 25
	echo T_("Please choose one item");                                                // Line 89

	//---------------------------------rojects/jibres/content_i/bank/home/display.html
	...
	//---------------------------------------rojects/jibres/content_i/bank/layout.html
	echo T_("Branch code");                                                           // Line 80
	echo T_("SWIFT");                                                                 // Line 107
	echo T_("subtitle");                                                              // Line 154

	//--------------------------------------rojects/jibres/content_i/home/display.html
	echo T_("In out");                                                                // Line 82

	//--------------------------------------------rojects/jibres/content_i/layout.html

	//----------------------------------rojects/jibres/content_i/jib/home/display.html
	echo T_("Default jib");                                                           // Line 70

	//----------------------------------------rojects/jibres/content_i/jib/layout.html
	echo T_("Is default?");                                                           // Line 45

	//--------------------------------------rojects/jibres/content_m/home/display.html
	echo T_("Store list");                                                            // Line 6

	//--------------------------------------------rojects/jibres/content_m/layout.html

	//-------------------------------------rojects/jibres/content_m/store/display.html
	echo T_("id");                                                                    // Line 14
	...
	//-------------------rojects/jibres/content_pardakhtyar/customer/home/display.html
	...
	//-------------------rojects/jibres/content_pardakhtyar/customer/layout-input.html

	//------rojects/jibres/content_pardakhtyar/customer/dashboard/customer-detail.html
	echo T_("Update");                                                                // Line 31

	//------rojects/jibres/content_pardakhtyar/customer/dashboard/terminal-detail.html

	//---------rojects/jibres/content_pardakhtyar/customer/dashboard/shaba-detail.html

	//----------rojects/jibres/content_pardakhtyar/customer/dashboard/shop-detail.html

	//------rojects/jibres/content_pardakhtyar/customer/dashboard/acceptor-detail.html

	//-------------------rojects/jibres/content_pardakhtyar/customer/edit/display.html

	//--------------------rojects/jibres/content_pardakhtyar/customer/add/display.html

	//---------------------------rojects/jibres/content_pardakhtyar/check/display.html
	...
	//----------------------------rojects/jibres/content_pardakhtyar/home/display.html
	echo T_("Customer list");                                                         // Line 28

	//-----------------------rojects/jibres/content_pardakhtyar/shop/home/display.html
	echo T_("Search in shops");                                                       // Line 42
	echo T_("Try to start with add new shop!");                                       // Line 159

	//-----------------------rojects/jibres/content_pardakhtyar/shop/layout-input.html

	//-----------------------rojects/jibres/content_pardakhtyar/shop/edit/display.html

	//------------------------rojects/jibres/content_pardakhtyar/shop/add/display.html

	//----------------------------------rojects/jibres/content_pardakhtyar/layout.html

	//------------------------------rojects/jibres/content_cms/posts/home/display.html
	...
	//------------------------------------rojects/jibres/content_cms/posts/layout.html
	...
	//---------------------------------rojects/jibres/content_cms/sitemap/display.html
	...
	//---------------------------rojects/jibres/content_cms/comments/home/display.html
	...
	//---------------------------rojects/jibres/content_cms/comments/edit/display.html
	echo T_("Submitted on");                                                          // Line 33
	echo T_("Updated on");                                                            // Line 34
	echo T_("Current status");                                                        // Line 36

	//-----------------------------------rojects/jibres/content_cms/terms/display.html
	...
	//------------------------------------rojects/jibres/content_cms/dayevent/chart.js
	echo T_("Day Event");                                                             // Line 27

	//----------------------------rojects/jibres/content_cms/contact/home/display.html

	//----------------------------rojects/jibres/content_cms/contact/edit/display.html

	//----------------------------------------rojects/jibres/content_cms/home/chart.js
	echo T_("Word cloud");                                                            // Line 61
	echo T_("Post count");                                                            // Line 82
	echo T_("Post");                                                                  // Line 93
	echo T_("post");                                                                  // Line 105

	//------------------------------------rojects/jibres/content_cms/home/wordcloud.js

	//------------------------------------rojects/jibres/content_cms/home/display.html
	...
	//----------------------------------rojects/jibres/content_cms/backup/display.html
	...
	//------------------------------------------rojects/jibres/content_cms/layout.html
	...
	//-------------------------rojects/jibres/content_cms/attachment/home/display.html
	echo T_("File Name");                                                             // Line 59
	echo T_("Block");                                                                 // Line 86

	//-------------------------------rojects/jibres/content_cms/attachment/layout.html
	...
	//--------------------------rojects/jibres/content_cms/attachment/add/display.html
	echo T_("Add file");                                                              // Line 10

	//--------------------------------rojects/jibres/content_cms/visitor/home/chart.js
	echo T_("Website analytics");                                                     // Line 20
	echo T_("Page view");                                                             // Line 103
	echo T_("page");                                                                  // Line 107
	echo T_("person");                                                                // Line 117

	//----------------------------rojects/jibres/content_cms/visitor/home/display.html
	...
	//-------------------------------rojects/jibres/content_cms/visitor/chart/chart.js

	//---------------------------rojects/jibres/content_cms/visitor/chart/display.html
	...
	//-----------------------------rojects/jibres/content_cms/visitor/log/display.html
	...
	//-------------------------------rojects/jibres/content_cms/mycontact/display.html
	echo T_("Admin Contact");                                                         // Line 26

	//---------------rojects/jibres/content_account/personalization/theme/display.html
	echo T_("Please select one theme");                                               // Line 32
	echo T_("Sensitive to content");                                                  // Line 33

	//----------------rojects/jibres/content_account/personalization/home/display.html
	...
	//-------------rojects/jibres/content_account/personalization/sidebar/display.html
	echo T_("Toggle side bar");                                                       // Line 14
	echo T_("You can save side bar status");                                          // Line 15
	echo T_("Are your need side bar?");                                               // Line 41

	//------------rojects/jibres/content_account/personalization/language/display.html

	//---------------------------------rojects/jibres/content_account/ref/display.html
	...
	//------------------------rojects/jibres/content_account/notification/display.html
	echo T_("New");                                                                   // Line 52
	echo T_("Sended via SMS");                                                        // Line 77
	echo T_("Sended via Telegram");                                                   // Line 80
	echo T_("No notifications found");                                                // Line 115

	//------------------------------rojects/jibres/content_account/appkey/display.html
	...
	//------------------------rojects/jibres/content_account/my/signature/display.html
	echo T_("Your signature");                                                        // Line 11
	echo T_("Write signature");                                                       // Line 12

	//-------------------------rojects/jibres/content_account/my/username/display.html
	echo T_("You can choose a username");                                             // Line 10

	//-----------------------------rojects/jibres/content_account/my/home/display.html
	...
	//---------------------------rojects/jibres/content_account/my/social/display.html

	//---------------------------rojects/jibres/content_account/my/avatar/display.html
	echo T_("Your avatar");                                                           // Line 20

	//----------------------------rojects/jibres/content_account/my/email/display.html

	//---------------------------------rojects/jibres/content_account/api/display.html
	...
	//---------------------rojects/jibres/content_account/billing/invoice/display.html
	echo T_("Factor of team");                                                        // Line 8

	//----------------------rojects/jibres/content_account/billing/detail/display.html
	...
	//--------------------------------rojects/jibres/content_account/home/display.html
	...
	//-------------------rojects/jibres/content_account/security/sessions/display.html
	...
	//----------------------------rojects/jibres/content_account/security/display.html
	...
	//-----------------rojects/jibres/content_account/security/rememberme/display.html

	//-------------------------------------rojects/jibres/content_account/address.html
	...
	//------------------------------------rojects/jibres/content_su/tools/display.html
	...
	//-------------------------------------rojects/jibres/content_su/nano/display.html

	//----------------------------------rojects/jibres/content_su/command/display.html
	echo T_("Server password");                                                       // Line 8

	//-----------------------------------rojects/jibres/content_su/server/display.html
	echo T_("Show $_SERVER");                                                         // Line 6

	//----------------------------------rojects/jibres/content_su/android/display.html
	echo T_("Revoke");                                                                // Line 11

	//----------------------------------rojects/jibres/content_su/cronjob/display.html
	echo T_("Run cronjob for this service");                                          // Line 15
	echo T_("Manual execute");                                                        // Line 47

	//-----------------------------rojects/jibres/content_su/apilog/home/logTable.html
	...
	//------------------------------rojects/jibres/content_su/apilog/home/display.html

	//-----------------------------------------rojects/jibres/content_su/home/chart.js
	...
	//-------------------------------------rojects/jibres/content_su/home/display.html
	...
	//-------------------------------rojects/jibres/content_su/sendnotify/display.html
	...
	//-----------------------------rojects/jibres/content_su/transactions/display.html

	//-------------------------rojects/jibres/content_su/transactions/add/display.html

	//------------------------------------rojects/jibres/content_su/linfo/display.html
	echo T_("First you need to enable COM on windows");                               // Line 5
	echo T_("Read More");                                                             // Line 7

	//-----------------------------------rojects/jibres/content_su/backup/display.html
	...
	//--------------------------------rojects/jibres/content_su/tg/system/display.html
	echo T_("Chatid");                                                                // Line 60
	echo T_("Telegram chatid");                                                       // Line 78
	echo T_("You are not starting yet!");                                             // Line 119

	//-----------------------------rojects/jibres/content_su/tg/sendphoto/display.html
	...
	//-------------------------------rojects/jibres/content_su/tg/webhook/display.html
	...
	//----------------------------------rojects/jibres/content_su/tg/home/display.html
	echo T_("System");                                                                // Line 28
	echo T_("Webhook");                                                               // Line 30
	echo T_("Send message");                                                          // Line 37
	echo T_("Send photo");                                                            // Line 43

	//---------------------------rojects/jibres/content_su/tg/sendmessage/display.html

	//-----------------------------------rojects/jibres/content_su/tg/log/display.html
	...
	//---------------------------------rojects/jibres/content_su/tg/users/display.html
	echo T_("User_id");                                                               // Line 61

	//-------------------------------------------rojects/jibres/content_su/layout.html
	echo T_("Supervisor dashboard");                                                  // Line 6
	echo T_("Api Log");                                                               // Line 39
	echo T_("Sms client");                                                            // Line 40

	//-------------------------------------rojects/jibres/content_su/time/display.html
	...
	//-----------------------------------rojects/jibres/content_su/update/display.html
	...
	//----------------------------------rojects/jibres/content_su/session/display.html

	//------------------------------rojects/jibres/content_su/translation/display.html
	...
	//--------------------------------------rojects/jibres/content_su/log/display.html
	...
	//----------------------------------------rojects/jibres/content_store/layout.html
	echo T_("My Stores");                                                             // Line 8

	//-----------------------------rojects/jibres/content_support/message/display.html
	echo T_("Open new ticket!");                                                      // Line 31

	//------------------------rojects/jibres/content_support/message/edit/display.html
	echo T_("Content");                                                               // Line 10

	//--------------------------------rojects/jibres/content_support/home/article.html
	echo T_("In this section");                                                       // Line 24
	echo T_("Short link");                                                            // Line 445

	//------------------------------rojects/jibres/content_support/home/dashboard.html
	...
	//--------------------------------------rojects/jibres/content_support/layout.html
	...
	//------------------------------rojects/jibres/content_support/ticket/addForm.html
	...
	//--------------------------rojects/jibres/content_support/ticket/ticketTable.html
	echo T_("Last active tickets");                                                   // Line 3
	echo T_("All Tickets");                                                           // Line 4
	echo T_("Active in this ticket");                                                 // Line 54

	//-------------------------rojects/jibres/content_support/ticket/show/display.html
	...
	//--------------------------rojects/jibres/content_support/ticket/ticketTypes.html
	echo T_("My tickets");                                                            // Line 7
	echo T_("Manage tickets");                                                        // Line 16
	echo T_("Manage all tickets");                                                    // Line 27

	//-------------------------rojects/jibres/content_support/ticket/home/display.html
	...
	//-------------------------rojects/jibres/content_support/ticket/tags/display.html

	//--------------------------rojects/jibres/content_support/ticket/add/display.html
	echo T_("Please log in if you need to store this ticket and track it in the future");// Line 9

	//---------------------------------rojects/jibres/content_support/faq/display.html

	//---------------------------------rojects/jibres/content_support/tag/display.html

	//----------------------------------rojects/jibres/content_test1/home/display.html

	//-----------------------------rojects/jibres/content_test1/log/check/display.html

	//---------------------------rojects/jibres/content_test1/log/request/display.html

	//--------------rojects/jibres/dash/addons/includes/html/display-enter-blocks.html
	...
	//--------------------rojects/jibres/dash/addons/includes/html/inc_pagination.html

	//-----------------------rojects/jibres/dash/addons/includes/html/display-mvc.html
	...
	//--------------------------rojects/jibres/dash/addons/includes/html/inc_spay.html
	...
	//--------------------rojects/jibres/dash/addons/includes/html/inc_commentadd.html

	//------------------rojects/jibres/dash/addons/includes/html/display-dash-xhr.html
	...
	//----------------------rojects/jibres/dash/addons/includes/html/display-dash.html
