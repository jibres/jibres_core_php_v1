...
class twigTransTerms
{
 private function transtext()
 {
	...
	echo T_("Customer");                                                              // Line 87
	echo T_("Address");                                                               // Line 496
	echo T_("Tel");                                                                   // Line 23
	...
	echo T_("Clear filters");                                                         // Line 131
	echo T_("Result not found!");                                                     // Line 130
	echo T_("Search with new keywords.");                                             // Line 130
	echo T_("Hi!");                                                                   // Line 137
	...
	echo T_("Supplier");                                                              // Line 86
	echo T_("Staff");                                                                 // Line 85
	...
	echo T_("General Detail");                                                        // Line 102
	echo T_("Delete product");                                                        // Line 47
	echo T_("Add");                                                                   // Line 345
	...
	echo T_("Enter a valid name from 3 to 40 character");                             // Line 148
	echo T_("Inventory Name");                                                        // Line 104
	echo T_("Status");                                                                // Line 105
	...
	echo T_("Phone");                                                                 // Line 256
	echo T_("Fax");                                                                   // Line 246
	...
	echo T_("Gender");                                                                // Line 206
	echo T_("Last name");                                                             // Line 156
	echo T_("Mr");                                                                    // Line 208
	echo T_("Mrs");                                                                   // Line 209
	...
	echo T_("Document Photo");                                                        // Line 103
	echo T_("Contact information");                                                   // Line 104
	echo T_("Identification detail");                                                 // Line 105
	echo T_("Location and address");                                                  // Line 106
	echo T_("Salesman Name");                                                         // Line 125
	echo T_("Like");                                                                  // Line 266
	echo T_("National code");                                                         // Line 179
	echo T_("10 digit national code");                                                // Line 181
	echo T_("Father name");                                                           // Line 189
	echo T_("Birthday");                                                              // Line 195
	echo T_("Birth city");                                                            // Line 220
	echo T_("Passport id");                                                           // Line 233
	echo T_("Nationality");                                                           // Line 285
	echo T_("Choose your nationality");                                               // Line 289
	echo T_("National card photo");                                                   // Line 304
	echo T_("ID card image");                                                         // Line 314
	echo T_("Passport card image");                                                   // Line 324
	echo T_("Marital");                                                               // Line 334
	echo T_("Please select one itme");                                                // Line 336
	echo T_("Single");                                                                // Line 337
	echo T_("Married");                                                               // Line 338
	echo T_("Company name");                                                          // Line 354
	echo T_("Enter company name");                                                    // Line 356
	echo T_("Economic code");                                                         // Line 366
	echo T_("Enter economic code");                                                   // Line 368
	echo T_("Company national id");                                                   // Line 374
	echo T_("Enter company national id");                                             // Line 376
	echo T_("Company register number");                                               // Line 383
	echo T_("Enter register number");                                                 // Line 385
	echo T_("Visitor name");                                                          // Line 396
	echo T_("Identify code");                                                         // Line 405
	echo T_("Customer code");                                                         // Line 412
	echo T_("Desctiption");                                                           // Line 420
	echo T_("Glance");                                                                // Line 432
	echo T_("Profile");                                                               // Line 441
	echo T_("Has bought");                                                            // Line 450
	echo T_("Factors");                                                               // Line 469
	echo T_("Logs");                                                                  // Line 478
	echo T_("General");                                                               // Line 492
	echo T_("Identify");                                                              // Line 499
	echo T_("avatar");                                                                // Line 502
	echo T_("Company Detail");                                                        // Line 505
	echo T_("Manage");                                                                // Line 508
