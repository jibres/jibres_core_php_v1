...
class twigTransTerms
{
 private function transtext()
 {
	...
	echo T_("Red");                                                                   // Line 50
	echo T_("Yellow");                                                                // Line 27
	echo T_("Green");                                                                 // Line 130
	echo T_("Black");                                                                 // Line 62
	...
	echo T_("Last update on");                                                        // Line 23
	echo T_("wait for next version!");                                                // Line 23
	echo T_("Powered by");                                                            // Line 25
	echo T_("Some right reserved");                                                   // Line 25
	...
	echo T_("Clear filters");                                                         // Line 92
	echo T_("Result not found!");                                                     // Line 91
	echo T_("Search with new keywords.");                                             // Line 91
	echo T_("Hi!");                                                                   // Line 98
	...
	echo T_("Try to start with add new record!");                                     // Line 98
