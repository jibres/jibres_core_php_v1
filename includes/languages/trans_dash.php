...
class twigTransTerms
{
 private function transtext()
 {
	...
	echo T_("Avatar of you");                                                         // Line 224
	echo T_("Default Avatar");                                                        // Line 228
	...
	echo T_("Help Center");                                                           // Line 131
	echo T_("Click to toggle sidebar status");                                        // Line 184
	echo T_("Notifications");                                                         // Line 213
	echo T_("Account");                                                               // Line 218
	echo T_("Logout");                                                                // Line 219
