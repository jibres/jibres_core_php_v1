...
class twigTransTerms
{
 private function transtext()
 {
	...
	echo T_("Dashboard");                                                             // Line 76
	echo T_("Support");                                                               // Line 8

	//--------------------------------addons\content_account\notification\display.html
	echo T_("Content");                                                               // Line 10
	echo T_("Clear filters");                                                         // Line 66
	echo T_("Result not found!");                                                     // Line 65
	echo T_("Search with new keywords.");                                             // Line 65
	echo T_("Hi!");                                                                   // Line 31
	...
	echo T_("User Profile");                                                          // Line 107
	echo T_("User last visits");                                                      // Line 108
	...
	echo T_("All");                                                                   // Line 16
	echo T_("Open tickets");                                                          // Line 19
	echo T_("Answered");                                                              // Line 22
	echo T_("Awaiting answer");                                                       // Line 25
	echo T_("Archived");                                                              // Line 28
