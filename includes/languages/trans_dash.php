...
class twigTransTerms
{
 private function transtext()
 {
	...
	echo T_("Endpoints");                                                             // Line 31
	echo T_("The API is accessed by making HTTPS requests to a specific version endpoint URL, in which GET, POST, PUT, PATCH, and DELETE methods dictate how your interact with the information available.");// Line 6
	...
	echo T_("Finally, to retrieve metadata information, you should use the HEAD method to get the headers.");// Line 56
	echo T_("This returns only the header of what would be returned with an associated GET request.");// Line 56
	echo T_("Response headers contain some useful information about your API access and the results that are available for your request.");// Line 58
	echo T_("For instance, the headers contain your current rate-limit value and the amount of time available until the limit resets.");// Line 60
	echo T_("It also contains metrics about the total number of objects found, pagination information, and the total content length.");// Line 60

	//-------------------------------------addons\content_api\v6\doc\04-responses.html
	echo T_("Responses");                                                             // Line 35
	...
	echo T_("client is rate limited");                                                // Line 97
	echo T_("incorrect HTTP method provided");                                        // Line 103
	echo T_("response is not valid JSON");                                            // Line 109
	...
	echo T_("Required parameters");                                                   // Line 42
	echo T_("on header");                                                             // Line 15
	echo T_("type");                                                                  // Line 16
	echo T_("Constraints");                                                           // Line 48
	echo T_("APP key generated on the user panel");                                   // Line 31
	echo T_("length");                                                                // Line 34
	echo T_("cURL");                                                                  // Line 100
	echo T_("Response");                                                              // Line 113

	//--------------------------------------addons\content_api\v6\doc\20-user-add.html
	echo T_("Sign Up User");                                                          // Line 39
	echo T_("Add new user to service");                                               // Line 8
	echo T_("Your temporary token");                                                  // Line 31
	echo T_("Your mobile manufactor");                                                // Line 58
	echo T_("max length");                                                            // Line 94
	echo T_("Your phone model");                                                      // Line 69
	echo T_("Your mobile serial number");                                             // Line 80
	echo T_("Your mobile os version");                                                // Line 91

	//------------------------------------------addons\content_api\v6\doc\display.html
	echo T_("API");                                                                   // Line 27
	echo T_("Introduction");                                                          // Line 29
