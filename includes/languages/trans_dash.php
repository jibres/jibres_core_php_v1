...
class twigTransTerms
{
 private function transtext()
 {
	...
	echo T_("Select one item");                                                       // Line 167
	echo T_("Enable");                                                                // Line 238
	echo T_("Disable");                                                               // Line 239
	echo T_("Removed");                                                               // Line 171
	echo T_("Add");                                                                   // Line 53
	...
	echo T_("Two step verification");                                                 // Line 192
	echo T_("Show sidebar");                                                          // Line 159
	echo T_("Default language");                                                      // Line 94
	...
	echo T_("Enter a valid username from 3 to 40 character");                         // Line 132
	...
	echo T_("Active");                                                                // Line 168
	echo T_("Awaiting");                                                              // Line 169
	echo T_("Deactive");                                                              // Line 170
	echo T_("Filter");                                                                // Line 172
	echo T_("Unreachable");                                                           // Line 173
	echo T_("Permission");                                                            // Line 96
	echo T_("No permission");                                                         // Line 115
	...
	echo T_("Confirm password");                                                      // Line 147
	echo T_("Require to change current password");                                    // Line 147
	echo T_("Password was set, enter to change it!");                                 // Line 149
	...
	echo T_("Save remember session");                                                 // Line 183
	echo T_("Active sessions");                                                       // Line 210
	echo T_("Terminate all other sessions");                                          // Line 113
	echo T_("Browser");                                                               // Line 213
	echo T_("Operation System");                                                      // Line 214
	echo T_("IP");                                                                    // Line 22
	echo T_("Date login");                                                            // Line 216
	echo T_("Current session");                                                       // Line 218
	echo T_("Terminate");                                                             // Line 220
