...
class twigTransTerms
{
 private function transtext()
 {
	...
	echo T_("Saderat");                                                               // Line 6
	echo T_("Mellat");                                                                // Line 7
	echo T_("Tejarat");                                                               // Line 8
	echo T_("Melli");                                                                 // Line 9
	echo T_("Sepah");                                                                 // Line 10
	echo T_("Keshavarzi");                                                            // Line 11
	echo T_("Parsian");                                                               // Line 18
	echo T_("Maskan");                                                                // Line 13
	echo T_("Refah");                                                                 // Line 14
	echo T_("Novin");                                                                 // Line 15
	echo T_("Ansar");                                                                 // Line 16
	echo T_("Pasargad");                                                              // Line 17
	echo T_("Saman");                                                                 // Line 18
	echo T_("Sina");                                                                  // Line 19
	echo T_("Post");                                                                  // Line 20
	echo T_("Ghavamin");                                                              // Line 21
	echo T_("Taavon");                                                                // Line 22
	echo T_("Shahr");                                                                 // Line 23
	echo T_("Ayande");                                                                // Line 24
	echo T_("Sarmayeh");                                                              // Line 25
	echo T_("Day bank");                                                              // Line 26
	echo T_("Hekmat");                                                                // Line 27
	echo T_("Iranzamin");                                                             // Line 28
	echo T_("Karafarin");                                                             // Line 29
	echo T_("Gardeshgari");                                                           // Line 30
	echo T_("Madan");                                                                 // Line 31
	echo T_("Tsaderat");                                                              // Line 32
	echo T_("Khavarmiyane");                                                          // Line 33
	echo T_("Ivbb");                                                                  // Line 34
	echo T_("Irkish");                                                                // Line 35
	echo T_("Asanpardakht");                                                          // Line 36
	echo T_("Zarinpal");                                                              // Line 37
	echo T_("Payir");                                                                 // Line 38
