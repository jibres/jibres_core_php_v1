...
class twigTransTerms
{
 private function transtext()
 {
	...
	echo T_("Some info may be visible to other people using our service.");           // Line 81
	echo T_("A photo helps personalize your account");                                // Line 90
	echo T_("First name");                                                            // Line 48
	echo T_("Last name");                                                             // Line 117
	echo T_("Gender");                                                                // Line 144
	echo T_("BirthDate");                                                             // Line 112
	...
	echo T_("Enter a valid title from 3 to 40 character");                            // Line 313
	echo T_("Type");                                                                  // Line 164
	echo T_("Enter a valid type from 3 to 40 character");                             // Line 323
	echo T_("Birthday");                                                              // Line 134
	echo T_("Enter a valid displayname from 3 to 40 character");                      // Line 95
	...
	echo T_("To change your password");                                               // Line 417
	echo T_("Click here");                                                            // Line 417
	echo T_("Delete your account");                                                   // Line 422
	...
	echo T_("Password not set, enter to set it!");                                    // Line 431
	...
	echo T_("This device");                                                           // Line 34
	echo T_("Check ip address");                                                      // Line 43
