...
class twigTransTerms
{
 private function transtext()
 {
	...
	echo T_("Customer");                                                              // Line 169
	echo T_("Supplier");                                                              // Line 179
	echo T_("Staff");                                                                 // Line 189
	...
	echo T_("Date Modified");                                                         // Line 54
	echo T_("No change");                                                             // Line 69
	...
	echo T_("Add new Product");                                                       // Line 137
