...
class twigTransTerms
{
 private function transtext()
 {
	...
	//-----------------------------------------------content/template/static/logo.html
	...
	//------------------------------------------content/template/static/help/home.html
	echo T_("Help Center");                                                           // Line 3
	echo T_("Need HELP? Be patient...");                                              // Line 6

	//-------------------------------------------content/template/static/help/faq.html
	echo T_("FAQ");                                                                   // Line 37
	...
	//-----------------------------------------content/template/static/for/school.html
	echo T_("Jibres for School");                                                     // Line 3
	echo T_("Jibres provide complete solution for school.");                          // Line 6
	echo T_("Now only available for Iranians");                                       // Line 12

	//-------------------------------------------content/template/static/for/home.html
	...
	//-----------------------------------------------content/template/static/card.html
	...
	//---------------------------------------content/template/static/pricing/home.html
	...
	//-------------------------------------------content/template/static/benefits.html
	...
	echo T_("General Detail");                                                        // Line 29
	...
	echo T_("Search in products");                                                    // Line 9
	echo T_("Title");                                                                 // Line 83
	echo T_("Category");                                                              // Line 20
	echo T_("Buy price");                                                             // Line 156
	echo T_("Sell Price");                                                            // Line 162
	echo T_("Discount");                                                              // Line 171
	echo T_("Discount percent");                                                      // Line 24
	echo T_("Stock");                                                                 // Line 258
	echo T_("You are not have product yet! add new one.");                            // Line 50
	echo T_("Add new product");                                                       // Line 51
	...
	echo T_("Staffs");                                                                // Line 9
	echo T_("Suppliers");                                                             // Line 10
	echo T_("Customers");                                                             // Line 11
	echo T_("Buy");                                                                   // Line 12
	echo T_("Sell");                                                                  // Line 13
