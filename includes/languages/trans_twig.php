...
class twigTransTerms
{
 private function transtext()
 {
	...
	echo T_("Add new customer");                                                      // Line 52
	...
	echo T_("Father name");                                                           // Line 103
	echo T_("Birthday");                                                              // Line 109
	echo T_("Gender");                                                                // Line 120
	echo T_("Classroom");                                                             // Line 126
	echo T_("Please select one classroom");                                           // Line 129
	echo T_("Birth city");                                                            // Line 141
	echo T_("Country");                                                               // Line 148
	echo T_("Province");                                                              // Line 157
	echo T_("City");                                                                  // Line 165
	echo T_("Zip code");                                                              // Line 173
	echo T_("Religion");                                                              // Line 181
	echo T_("Birth place");                                                           // Line 189
	echo T_("Issue Place");                                                           // Line 197
	echo T_("Passport id");                                                           // Line 205
	echo T_("Passport expire date");                                                  // Line 213
	echo T_("Id number");                                                             // Line 221
	echo T_("National Id");                                                           // Line 229
	echo T_("Address");                                                               // Line 293
	echo T_("Mobile of Customer");                                                    // Line 249
	echo T_("Like");                                                                  // Line 301
	echo T_("Phone");                                                                 // Line 257
	echo T_("Mobile of father");                                                      // Line 266
	echo T_("Mobile of mother");                                                      // Line 275
	echo T_("Post code");                                                             // Line 285
	echo T_("Add");                                                                   // Line 339
	...
	echo T_("Discount");                                                              // Line 215
	echo T_("Discount percent");                                                      // Line 50
	echo T_("Stock");                                                                 // Line 277
	...
	echo T_("Impure Interest Rate");                                                  // Line 166
	echo T_("Final Price");                                                           // Line 174
	echo T_("Final Pure Price");                                                      // Line 176
	echo T_("Pure Interest Rates");                                                   // Line 178
	echo T_("Discount on sale");                                                      // Line 189
	echo T_("Discount Percent");                                                      // Line 191
	echo T_("Vat");                                                                   // Line 201
	echo T_("This product is vat base");                                              // Line 201
	echo T_("Initial Balance");                                                       // Line 209
	echo T_("Min stock");                                                             // Line 217
	echo T_("Max stock");                                                             // Line 226
	echo T_("Status of product");                                                     // Line 233
	echo T_("Avalible");                                                              // Line 237
	echo T_("Normal status of product");                                              // Line 237
	echo T_("Soon");                                                                  // Line 242
	echo T_("maybe come in future and be available");                                 // Line 242
	echo T_("Unavailable");                                                           // Line 247
	echo T_("temporary does not exist in store");                                     // Line 247
	echo T_("Discountinued");                                                         // Line 252
	echo T_("does not exist for now and on the future");                              // Line 252
	echo T_("Unset");                                                                 // Line 257
	echo T_("Unknown status for product");                                            // Line 257
	echo T_("Sold");                                                                  // Line 268
	echo T_("Service");                                                               // Line 286
	echo T_("This product is service base and not a real goods");                     // Line 286
	echo T_("Sell Online");                                                           // Line 295
	echo T_("This product is sellonline base");                                       // Line 295
	echo T_("Sell in store");                                                         // Line 305
	echo T_("This product is sellstore base");                                        // Line 305
	echo T_("Count in carton");                                                       // Line 313
	echo T_("Count of product in carton");                                            // Line 315
	...
	echo T_("Add new supplier");                                                      // Line 52

	//--------------------------------------------------content_a\supplier\layout.html
	echo T_("Select supplier grade");                                                 // Line 76
	echo T_("Mobile of Supplier");                                                    // Line 249
