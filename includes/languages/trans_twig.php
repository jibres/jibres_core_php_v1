...
class twigTransTerms
{
 private function transtext()
 {
	...
	echo T_("Enter a valid name from 3 to 40 character");                             // Line 60
	echo T_("Visitor name");                                                          // Line 70
	echo T_("Grade");                                                                 // Line 74
	...
	echo T_("Father name");                                                           // Line 118
	echo T_("Birthday");                                                              // Line 124
	echo T_("Gender");                                                                // Line 135
	echo T_("Classroom");                                                             // Line 141
	echo T_("Please select one classroom");                                           // Line 144
	echo T_("Birth city");                                                            // Line 156
	echo T_("Country");                                                               // Line 163
	echo T_("Province");                                                              // Line 172
	echo T_("City");                                                                  // Line 180
	echo T_("Zip code");                                                              // Line 188
	echo T_("Religion");                                                              // Line 196
	echo T_("Birth place");                                                           // Line 204
	echo T_("Issue Place");                                                           // Line 212
	echo T_("Passport id");                                                           // Line 220
	echo T_("Passport expire date");                                                  // Line 228
	echo T_("Id number");                                                             // Line 236
	echo T_("National Id");                                                           // Line 244
	echo T_("Address");                                                               // Line 308
	echo T_("Mobile of Supplier");                                                    // Line 251
	echo T_("Like");                                                                  // Line 316
	echo T_("Phone");                                                                 // Line 272
	echo T_("Mobile of father");                                                      // Line 281
	echo T_("Mobile of mother");                                                      // Line 290
	echo T_("Post code");                                                             // Line 300
	echo T_("Add");                                                                   // Line 354
	...
	//-----------------------------------------------content_a/thirdparty/display.html
	...
	echo T_("Discount Percent");                                                      // Line 186
	echo T_("Vat");                                                                   // Line 195
	echo T_("This product is vat base");                                              // Line 195
	echo T_("Initial Balance");                                                       // Line 203
	echo T_("Min stock");                                                             // Line 211
	echo T_("Max stock");                                                             // Line 220
	echo T_("Status of product");                                                     // Line 227
	echo T_("Avalible");                                                              // Line 231
	echo T_("Normal status of product");                                              // Line 231
	echo T_("Soon");                                                                  // Line 236
	echo T_("maybe come in future and be available");                                 // Line 236
	echo T_("Unavailable");                                                           // Line 241
	echo T_("temporary does not exist in store");                                     // Line 241
	echo T_("Discountinued");                                                         // Line 246
	echo T_("does not exist for now and on the future");                              // Line 246
	echo T_("Unset");                                                                 // Line 251
	echo T_("Unknown status for product");                                            // Line 251
	echo T_("Sold");                                                                  // Line 262
	echo T_("Service");                                                               // Line 280
	echo T_("This product is service base and not a real goods");                     // Line 280
	echo T_("Sell Online");                                                           // Line 289
	echo T_("This product is sellonline base");                                       // Line 289
	echo T_("Sell in store");                                                         // Line 299
	echo T_("This product is sellstore base");                                        // Line 299
	echo T_("Count in carton");                                                       // Line 307
	echo T_("Count of product in carton");                                            // Line 309
	...
	echo T_("Third Parties");                                                         // Line 9
	echo T_("Factor");                                                                // Line 10
	echo T_("Setting");                                                               // Line 11

	//-------------------------------------------------content_a/buy/home/display.html
	echo T_("Search in buys list");                                                   // Line 9
	echo T_("Add new buy");                                                           // Line 52

	//-------------------------------------------------------content_a/buy/layout.html
	echo T_("Select buy grade");                                                      // Line 76
