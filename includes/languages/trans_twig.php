...
class twigTransTerms
{
 private function transtext()
 {
	...
	echo T_("Sale");                                                                  // Line 24 Seperate
	echo T_("Buy");                                                                   // Line 25 Seperate
	echo T_("Prefactor");                                                             // Line 151
	echo T_("Lending");                                                               // Line 27 Seperate
	echo T_("Backbuy");                                                               // Line 28 Seperate
	echo T_("Backfactor");                                                            // Line 154
	echo T_("Waste");                                                                 // Line 30 Seperate
