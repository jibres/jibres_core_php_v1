...
class twigTransTerms
{
 private function transtext()
 {
	...
	echo T_("List of your stores");                                                   // Line 12
	echo T_("Lets start by add new store!");                                          // Line 23
	echo T_("Add new Store");                                                         // Line 56
	echo T_("Store");                                                                 // Line 66
	...
	echo T_("Customer");                                                              // Line 119
	echo T_("Staff");                                                                 // Line 139
	echo T_("Supplier");                                                              // Line 129
	...
	echo T_("Products Summary");                                                      // Line 68
	echo T_("Add new Product");                                                       // Line 14
	echo T_("Sale Invoicing");                                                        // Line 98
	echo T_("Buy Invocing");                                                          // Line 108
	echo T_("Sales count group by hour");                                             // Line 158
