ALTER TABLE jibres_XXXXXXX.cart ADD `count2` DECIMAL(22, 4) NULL DEFAULT NULL;
ALTER TABLE jibres_XXXXXXX.cart ADD `price2` DECIMAL(22, 4) NULL DEFAULT NULL;



UPDATE jibres_XXXXXXX.cart SET cart.count2      = (CAST(cart.count AS DECIMAL(22, 4)) / 1000) WHERE cart.count IS NOT NULL;
UPDATE jibres_XXXXXXX.cart SET cart.price2        = (CAST(cart.price AS DECIMAL(22, 4)) / 100) WHERE cart.price IS NOT NULL;
