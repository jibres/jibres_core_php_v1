...
ALTER TABLE jibres_XXXXXXX.products ADD `discountpercent2` DECIMAL(22, 4) NULL DEFAULT NULL;
...
UPDATE jibres_XXXXXXX.products SET products.discountpercent2 = (CAST(products.discountpercent AS DECIMAL(22, 4)) / 100) WHERE products.discountpercent IS NOT NULL;
