...
UPDATE jibres_XXXXXXX.factors SET factors.qty2         = (CAST(factors.qty AS DECIMAL(13, 4)) / 1000) WHERE factors.qty IS NOT NULL;
UPDATE jibres_XXXXXXX.factors SET factors.subprice2    = (CAST(factors.subprice AS DECIMAL(31, 4)) / 100000) WHERE factors.subprice IS NOT NULL;
UPDATE jibres_XXXXXXX.factors SET factors.subdiscount2 = (CAST(factors.subdiscount AS DECIMAL(31, 4)) / 100000) WHERE factors.subdiscount IS NOT NULL;
UPDATE jibres_XXXXXXX.factors SET factors.subtotal2    = (CAST(factors.subtotal AS DECIMAL(31, 4)) / 100000) WHERE factors.subtotal IS NOT NULL;
UPDATE jibres_XXXXXXX.factors SET factors.subvat2      = (CAST(factors.subvat AS DECIMAL(31, 4)) / 100000) WHERE factors.subvat IS NOT NULL;
...
UPDATE jibres_XXXXXXX.factors SET factors.shipping2    = (CAST(factors.shipping AS DECIMAL(13, 4)) / 100) WHERE factors.shipping IS NOT NULL;
UPDATE jibres_XXXXXXX.factors SET factors.shippingvat2 = (CAST(factors.shippingvat AS DECIMAL(13, 4)) / 100) WHERE factors.shippingvat IS NOT NULL;
UPDATE jibres_XXXXXXX.factors SET factors.total2       = (CAST(factors.total AS DECIMAL(31, 4)) / 100000) WHERE factors.total IS NOT NULL;
