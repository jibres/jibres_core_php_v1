...
KEY `index_search_products_locksaleapp` (`locksaleapp`),
...
KEY `index_search_products_locksaleonline` (`locksaleonline`),
KEY `index_search_products_locksaletelegram` (`locksaletelegram`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
