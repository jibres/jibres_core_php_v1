...
`initialbalance`		int(10) UNSIGNED NULL DEFAULT NULL,
`minstock`				int(10) UNSIGNED NULL DEFAULT NULL,
`maxstock`				int(10) UNSIGNED NULL DEFAULT NULL,
...
`carton`				int(10) UNSIGNED NULL DEFAULT NULL,
