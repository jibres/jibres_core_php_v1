...
`url` text NULL,
`pointer` enum('homepage','products','posts','forms','tags','hashtag','socialnetwork','other', 'title', 'separator') NULL DEFAULT NULL,
`related_id` bigint(20) UNSIGNED NULL DEFAULT NULL,
`socialnetwork` varchar(100) NULL DEFAULT NULL,
