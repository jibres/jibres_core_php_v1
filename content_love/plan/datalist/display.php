            ...
            <tr>
                ...
                <td>
                    <span class="block text-green-600"
                          title="<?php echo T_("Start Date"); ?>"><?php echo \dash\fit::date_time(a($value, 'startdate')) ?></span>
					<?php if(a($value, 'expirydate')) : ?>
                        <span class="block text-red-600"
                              title="<?php echo T_("Expire date"); ?>"><?php echo \dash\fit::date_time(a($value, 'expirydate')) ?></span>
					<?php endif; ?>
                </td>
                <td>
