...
<?php if(\dash\permission::supervisor()) {?>
	<div class="c12 s6">
		<a class="bg-white p-2 block m-2 text-2xl" href='<?php echo \dash\url::sitelang(); ?>/sudo'>
...
<?php } ?>
	...
	<div class="c2 s6">
		<a class="bg-white p-2 block m-2 text-2xl" href='<?php echo \dash\url::here(); ?>/store'>
	...
	<div class="c2 s6">
		<a class="bg-white p-2 block m-2 text-2xl" href='<?php echo \dash\url::here(); ?>/business'>
	...
	<div class="c2 s6">
		<a class="bg-white p-2 block m-2 text-2xl" href='<?php echo \dash\url::here(); ?>/domain'>
			<div class="statistic blue">
	...
	<div class="c2 s6">
		<a class="bg-white p-2 block m-2 text-2xl" href='<?php echo \dash\url::here(); ?>/business/domain'>
			<div class="statistic blue">
	...
	<div class="c2 s6">
		<a class="bg-white p-2 block m-2 text-2xl" href='<?php echo \dash\url::here(); ?>/notiflog'>
	...
	<div class="c2 s6">
		<a class="bg-white p-2 block m-2 text-2xl" href='<?php echo \dash\url::this(); ?>/log'>
			<div class="statistic blue">
	...
	<div class="c2 s6">
		<a class="bg-white p-2 block m-2 text-2xl" href='<?php echo \dash\url::this(); ?>/sms'>
			<div class="statistic blue">
	...
	<div class="c2 s6">
		<a class="bg-white p-2 block m-2 text-2xl" href='<?php echo \dash\url::this(); ?>/telegram/datalist'>
			<div class="statistic blue">
	...
	<div class="c2 s6">
		<a class="bg-white p-2 block m-2 text-2xl" href='<?php echo \dash\url::this(); ?>/email'>
	...
	<div class="c2 s6">
		<a class="bg-white p-2 block m-2 text-2xl" href='<?php echo \dash\url::this(); ?>/apilog/twitter'>
			<div class="statistic blue">
	...
	<div class="c2 s6">
		<a class="bg-white p-2 block m-2 text-2xl" href='<?php echo \dash\url::this(); ?>/files'>
			<div class="statistic blue">
	...
	<div class="c2 s6">
		<a class="bg-white p-2 block m-2 text-2xl" href='<?php echo \dash\url::here(); ?>/application'>
			<div class="statistic green">
	...
	<div class="c2 s6">
		<a class="bg-white p-2 block m-2 text-2xl" href='<?php echo \dash\url::here(); ?>/gift'>
			<div class="statistic red">
	...
	<div class="c2 s6">
		<a class="bg-white p-2 block m-2 text-2xl" href='<?php echo \dash\url::kingdom(); ?>/crm'>
			<div class="statistic blue">
	...
	<div class="c2 s6">
		<a class="bg-white p-2 block m-2 text-2xl" href='<?php echo \dash\url::this(); ?>/ip'>
			<div class="statistic red">
	...
	<div class="c2 s6">
		<a class="bg-white p-2 block m-2 text-2xl" href='<?php echo \dash\url::this(); ?>/changelog'>
			<div class="statistic green">
	...
	<div class="c2 s6">
		<a class="bg-white p-2 block m-2 text-2xl" href='<?php echo \dash\url::this(); ?>/plugin'>
			<div class="statistic green">
