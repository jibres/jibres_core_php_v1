  ...
  <ul>
    <li>
      <a class="f item">
        ...
        <div class="value font-bold"><?php echo $dataRow['id'] ?></div>
      </a>
    </li>
    <li>
      <a class="f item">
        <div class="key">Subdomain</div>
        <div class="value font-bold"><?php echo $dataRow['subdomain'] ?></div>
      </a>
    </li>
    <li>
      <a class="f item">
    ...
    <li>
      <a class="f item">
        ...
        <div class="value font-bold"><?php echo \dash\fit::date_time($dataRow['datecreated']) ?></div>
      </a>
    </li>
  </ul>
</nav>