  ...
  <table class="tbl1 v1 cbox fs12">
    ...
    <tbody>
      ...
      <tr class="">
        ...
        <td class="collapsing txtRa">
          <span class="badge warn"><a href="<?php echo \dash\url::this(); ?>?caller=<?php echo a($value, 'caller'); ?>"><?php echo a($value, 'caller'); ?></a></span>
          ...
          <?php if(isset($value['url']) && $value['url']) {?> <a href="<?php echo a($value, 'url'); ?>"><i class="sf-share" title='<?php echo T_("Url"); ?>'></i></a><?php }//endif ?>
          <?php if(isset($value['life_time']) && $value['life_time']) {?> <span class="badge success2"><?php echo a($value, 'life_time'); ?></span><?php }//endif ?>
          <?php if(isset($value['need_answer']) && $value['need_answer']) {?> <span class="sf-check"></span><?php }//endif ?>
          <?php if(isset($value['auto_expire']) && $value['auto_expire']) {?> <br><span class="badge warn2"><?php echo a($value, 'auto_expire'); ?></span><?php }//endif ?>


          <br>
          <a class="badge info" href="<?php echo \dash\url::this(); ?>?status=<?php echo a($value, 'status'); ?>"><?php echo T_($value['status']); ?></a>
        ...
        <td class="collapsing">
          <a href="<?php echo \dash\url::this(); ?>?datecreated=<?php echo a($value, 'datecreated'); ?>" title='<?php echo T_("Date created"); ?>'>
        ...
        <span class="badge danger2" title='<?php echo T_("Date modified"); ?>'>
          <a href="<?php echo \dash\url::this(); ?>?datecreated=<?php echo a($value, 'datemodified'); ?>">
