    ...
    <div class="box">
      ...
      <div class="body">
        <div class="row">
          ...
          <p class="msg minimal mt-2"><?php echo T_("You can insert Jibres DNS record to this domain"); ?> <span data-confirm data-data='{"jibresdns": "jibresdns"}' class="link"><?php echo T_("Insert now!") ?></span></p>
