<section class="avand-md">
  ...
  <div class="box">
   <div class="body">
      <h2 class="font-bold"><?php echo T_("Rebuil sitemap for all Business"); ?></h2>
      ...
      <footer class="txtRa">
        <div data-confirm data-data='{"rebuild" : "rebuild"}' class="btn-danger"><?php echo T_("Rebuil sitemap"); ?></div>
      </footer>
  </div>
