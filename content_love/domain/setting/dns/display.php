...
<div class="f justify-center">
 <div class="c9 m12 s12">
  <div class="cbox">
   <div class="msg minimal pLR20-f fs16 font-bold ltr text-left danger"><?php echo \dash\data::domainDetail_name() ?></div>

   <p class="alert-warning"><?php echo T_('Only edit domain record'); ?></p>
   <form method="post" autocomplete="off" >
    <input type="hidden" name="raw_edit" value="raw_edit">
      <div class="f">
