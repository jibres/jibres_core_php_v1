    ...
    <div class="c-xs-12 c-sm-12 c-lg-8 c-xl-9">
      ...
      <div class="box">
        <div class="body">
          <div class="row">
            <div class="c-auto">
              <div class="badge pA10-f mb-2 fs09 light"><?php echo T_("Order number") ?> <code class="link"><?php echo a(\dash\data::dataRow_order(), 'id'); ?></code></div>
            </div>
            <div class="c-auto">
              <div class="badge pA10-f mb-2 fs09 light"><?php echo T_("Order status") ?> <span class="link"><?php echo a(\dash\data::dataRow_order(), 't_status'); ?></span></div>
            </div>

            <div class="c-auto">
              <div class="badge pA10-f mb-2 fs09 light"><?php echo T_("Order date") ?> <span class="link"><?php echo \dash\fit::date_time(a(\dash\data::dataRow_order(), 'date')); ?></span></div>
            </div>
