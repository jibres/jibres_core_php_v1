  ...
  <div class="box shareBox">
    <nav class="row align-center">
      ...
      <div class="c-auto share1">
        ...
        <a target="_blank" title='<?php echo T_("twitter"); ?>' href="https://twitter.com/intent/tweet?url=<?php echo urlencode(\dash\url::pwd()); ?>&amp;text=<?php echo urlencode(\dash\face::desc()); ?>&hastag=test&via=MyJibres" class="twitter">
