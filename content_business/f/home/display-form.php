		...
		<div class="box">
			...
			<div class="body" data-jform>
				...
				<?php if(\dash\data::formDetail_status() !== 'publish' && \dash\data::accessLoadItem()) {?>
					<div class="msg warn text-center txtB"><?php echo T_("Your form is not publish. Only you can view this form.") ?> <a class="btn-link" href="<?php echo \lib\store::admin_url(). '/a/form/edit?id='. \dash\data::formDetail_id() ?>"><?php echo T_("Edit form") ?></a></div>
				<?php } //endif ?>
