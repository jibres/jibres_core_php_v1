...
<?php $social = \lib\store::social(); ?>
        <div class="social">
<?php if(\dash\get::index($social, 'linkedin', 'user')) {?>
...
<?php } //endif ?>
<?php if(\dash\get::index($social, 'github', 'user')) {?>
...
<?php } //endif ?>
<?php if(\dash\get::index($social, 'facebook', 'user')) {?>
...
<?php } //endif ?>
<?php if(\dash\get::index($social, 'twitter', 'user')) {?>
...
<?php } //endif ?>
<?php if(\dash\get::index($social, 'email', 'user')) {?>
...
<?php } //endif ?>
<?php if(\dash\get::index($social, 'instagram', 'user')) {?>
...
<?php } // ?>
<?php if(\dash\get::index($social, 'telegram', 'user')) {?>
