...
?>
 <div class="tblBbox">
  <table class="tbl1 v1">
    <thead>
      <tr>
      	<th data-sort=<?php echo @$sortLink['user_id']['order']; ?>><a href="<?php echo @$sortLink['user_id']['link']; ?>"><?php echo T_("User"); ?></a></th>
      	<th data-sort=<?php echo @$sortLink['title']['order']; ?>><a href="<?php echo @$sortLink['title']['link']; ?>"><?php echo T_("Title"); ?></a></th>
      	<th data-sort=<?php echo @$sortLink['plus']['order']; ?>><a href="<?php echo @$sortLink['plus']['link']; ?>"><i class="sf-plus-circle"></i></a></th>
      	<th data-sort=<?php echo @$sortLink['minus']['order']; ?>><a href="<?php echo @$sortLink['minus']['link']; ?>"><i class="sf-minus-circle"></i></a></th>
      	<th data-sort=<?php echo @$sortLink['budget']['order']; ?>><a href="<?php echo @$sortLink['budget']['link']; ?>"><?php echo T_("Budget"); ?></a></th>
      	<th data-sort=<?php echo @$sortLink['condition']['order']; ?>><a href="<?php echo @$sortLink['condition']['link']; ?>"><?php echo T_("Condition"); ?></a></th>
      	<th data-sort=<?php echo @$sortLink['verify']['order']; ?>><a href="<?php echo @$sortLink['verify']['link']; ?>"><?php echo T_("Verify"); ?></a></th>
      	<th data-sort=<?php echo @$sortLink['datecreated']['order']; ?>><a href="<?php echo @$sortLink['datecreated']['link']; ?>"><?php echo T_("Date"); ?></a></th>
      </tr>
    </thead>
