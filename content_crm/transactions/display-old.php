...
<div class="cbox fs12">
  <form method="get" action='<?php echo \dash\url::here(); ?>/transactions'>
    <div class="input">
      <input type="search" name="q" placeholder='<?php echo T_("Search in transactions"); ?>' id="q" value="<?php echo \dash\validate::search_string(); ?>" <?php \dash\layout\autofocus::html() ?>  data-pass='submit' autocomplete='off'>
