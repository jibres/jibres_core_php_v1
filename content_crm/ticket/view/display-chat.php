...
?>
 <div class="messageLine row align-start<?php if($otherSide) {echo " f-row-reverse";} ?>">
  ...
  <div class="c<?php if($otherSide) {echo " txtRa";} ?>">
    <div class="messageBox"<?php if(a($value, 'type') === 'note') {echo' data-note';} if($userText){ echo ' data-user'; } ?>>
...
?>
        <div class="c"></div>
<?php if(!$customer_mode) {?>
        <div class="c-auto"><a href="<?php echo \dash\url::this(). '/edit?id='. a($value, 'id') ?>" class="link"><?php echo T_("Edit") ?></a></div>
<?php } //endif ?>
