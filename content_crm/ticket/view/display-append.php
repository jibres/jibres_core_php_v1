<form method="post" autocomplete="off" >
  ...
  <div class="box">
    <div class="pad">
      <textarea class="txt" <?php if(!$customer_mode){echo 'name="answer" data-editor="simple"';}else{echo 'name="content"';} ?> rows="4" <?php \dash\layout\autofocus::html() ?> placeholder='<?php if(!$customer_mode) { echo T_("Answer to ticket"); }else{ echo T_("Write your message");} ?>'></textarea>
