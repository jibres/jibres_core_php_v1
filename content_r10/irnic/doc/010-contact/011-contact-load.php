<div class="box">
  ...
  <div class="body" id="contact-load">
    <div id='contact'>
      ...
      <pre>curl -L <?php if(\dash\url::isLocal()) { echo '-k'; } ?> -X GET '<?php echo \dash\data::IRNICApiURL(); ?>contact?id=B' -H 'appkey: <?php echo \dash\data::myAppKey(); ?>' -H 'apikey: <?php echo \dash\data::myApiKey(); ?>'</pre>
