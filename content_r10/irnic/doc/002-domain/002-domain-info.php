<div class="box">
  <header>
    <h2 class="f" data-kerkere='#domain-info' data-kerkere-icon='open'>
      <span class="cauto pRa10"><span class="badge success">GET</span></span>
      <span class="c"><?php echo T_("Load domain info"); ?></span>
    </h2>
  </header>
  <div class="body" id="domain-info">
      <div>

        <div class="msg url ltr txtL">
          <i class="method">GET</i>
          <span><?php echo \dash\data::IRNICApiURL(); ?><b>domain/info</b></span>
        </div>
...
<pre>
curl <?php if(\dash\url::isLocal()) { echo '-k '; } ?>-X GET '<?php echo \dash\data::IRNICApiURL(); ?>domain/info?domain=jibresisamazing' \
