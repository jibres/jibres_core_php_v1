<div class="box">
  ...
  <div class="body" id="dns-delete">
    <div>
      ...
      <pre>curl <?php if(\dash\url::isLocal()) { echo '-k '; } ?>-X DELETE '<?php echo \dash\data::IRNICApiURL(); ?>dns?id=B' -H 'appkey: <?php echo \dash\data::myAppKey(); ?>' -H 'apikey: <?php echo \dash\data::myApiKey(); ?>'</pre>
