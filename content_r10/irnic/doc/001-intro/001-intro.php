<h2 class="f " data-kerkere='#intro-detail' data-kerkere-icon='open'><?php echo T_("IRNIC domain APIs") ?></h2>
<div id="intro-detail">
  <div class="cbox fs15" id='intro'>
    ...
    <p><?php echo T_("Our API is a RESTful API based on HTTPS requests and JSON responses."); ?> <?php echo T_("If you are registered, you can obtain your API key from 'My Account' page."); ?> <a target="_blank" href="<?php echo \dash\url::kingdom(); ?>/account/api"><?php echo T_("Go to My account."); ?></a></p>


    <h3><?php echo T_("Audience for APIs"); ?></h3>
