<div class="cn" id="android_chooseLang">
 ...
 <div class="f">
  <div class="c6 pRa5">
   <a href="jibres://language/en" class="ltr langItem{%if requestGET.device == 'en'%} device{%endif%}">
  ...
  <div class="c6 pLa5">
   <a href="jibres://language/fa" class="rtl langItem{%if requestGET.device == 'fa'%} device{%endif%}">
...
<style>
 body{background-color: #f9e7e0;webkit-touch-callout:none;-webkit-user-select:none;-khtml-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;cursor:default;-webkit-tap-highlight-color:transparent;}
