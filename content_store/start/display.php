    ...
    <div id="get_started_card">
      <div class="body">
        <div class="pad">
          ...
          <img src="<?php echo \dash\url::static(); ?>/img/store/your-brand.svg" alt='<?php echo T_("Create a store on Jibres"); ?>'>
        ...
        <?php }else{ ?>
            ...
            <a data-direct href="<?php echo \dash\url::here(); ?>" class="btn block outline mT10 success"><?php echo T_("Back"); ?></a>
      ...
      <?php if(\dash\data::canAddStore_can()) {?>
        ...
        <div class="f align-center msg">
          ...
          <div class="cauto os"><a href="<?php echo \dash\url::here(); ?>" class="btn" data-direct><?php echo T_("Cancel"); ?></a></div>
        </div>
      <?php }//endif ?>
    </div>
