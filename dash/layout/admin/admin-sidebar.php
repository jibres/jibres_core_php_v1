...
<?php if(\dash\permission::supervisor()) {?>
   <li><a href="<?php echo \dash\url::sitelang(); ?>/love"<?php if(\dash\url::content() === 'love') {?> class="activeContent"<?php }//endif ?>><img src="<?php echo \dash\url::icon() ?>" class="avatar"> <span><?php echo T_("Jibres Managment"); ?></span></a></li>
