...
else
{
  ...
  if(\dash\user::id())
  {
   ...
   {
    echo '<img src="'. \dash\fit::img(\dash\user::detail('avatar')). '" alt="'. T_("Avatar of you"). ' '. \dash\user::detail('displayname') .'">';
   }
   elseif(\dash\user::id())
   {
  ...
  {
   echo "<a href='". \dash\url::kingdom(). "/enter?referer=". urlencode(\dash\url::location()). "' class='avatar'>";
