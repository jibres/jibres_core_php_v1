...
?>
  ...
  <li>
    <?php if(\dash\permission::check('factorAccess')) {?><a href="<?php echo $urlHere; ?>/order"><i class="sf-print"></i><?php echo T_("Factor"); ?></a><?php } //endif ?>
    <ul>
  ...
  <?php if(in_array(\dash\url::module(), ['order', 'sale', 'buy'])) {?>
      ...
      <?php if(\dash\permission::check('factorAccess')) {?><li><a href="<?php echo $urlHere; ?>/order"><i class="floatRa mRa10 fc-mute sf-list-ul"></i><?php echo T_("List of all factors"); ?></a></li><?php } //endif ?>
<?php } //endif ?>
    </ul>
  </li>
