...
<?php if(\dash\user::detail('avatar')) { ?>
     <img src="<?php echo \dash\fit::img(\dash\user::detail('avatar')); ?>" alt='<?php echo T_("Avatar of you"); ?> <?php echo \dash\user::detail('displayname'); ?>'>
...
<?php }else{ ?>
    <a href="<?php echo \dash\url::kingdom(); ?>/enter?referer=<?php echo urlencode(\dash\url::location()) ?>" title='<?php echo T_("Enter to have better experience"); ?>'><i class="sf-hand-stop"></i></a>
<?php } //endif ?>
   </div>
  </div>