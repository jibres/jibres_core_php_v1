...
{
  echo ' <link href='. \dash\layout\func::staticmtime('css/magic-fonts-v1.css'). ' rel="preload" as="style"/>'."\n";
  echo ' <link href='. \dash\layout\func::staticmtime('css/magic-v1.css'). ' rel="preload"/>'."\n";
