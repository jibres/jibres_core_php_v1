...
$html .= '<div class="toolbar flex-grow-0 flex-none flex content-center mx-2">';
{
  ...
  $html .= '</div>';
  // address line
  $html .= '<div class="ltr relative flex flex-grow items-center px-7 bg-gray-100 hover:bg-gray-200 rounded-full my-3 text-xl text-gray-700 transition">';
  {
  ...
  {
    $html .= '<div data-mode="mobile" class="sf-mobile rounded-full hover:bg-gray-300 text-gray-700 hover:text-gray-900 text-3xl transition cursor-pointer"></div>';
    $html .= '<div data-mode="desktop" class="sf-monitor rounded-full hover:bg-gray-300 text-gray-700 hover:text-gray-900 text-3xl transition cursor-pointer"></div>';
  }
  $html .= '</div>';
}
$html .= '</div>';
