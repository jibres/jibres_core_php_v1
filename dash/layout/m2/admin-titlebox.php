...
<?php if(\dash\data::back_text() && \dash\data::back_link()) { ?>
    <div class="c-auto">
     <a class="btn master back" <?php if(\dash\data::back_direct()) { echo 'data-direct';} ?> href="<?php echo \dash\data::back_link(); ?>"><i class="pRa5 sf-chevron-<?php if(\dash\language::dir() === 'rtl') { echo 'right'; } else { echo 'left'; } ?>"></i><span class="s0"><?php echo \dash\data::back_text(); ?></span></a>
    </div>
    <?php } // ?>
...
<?php if(\dash\face::btnImport()) { ?>
     <a class="btn-light" href="<?php echo \dash\face::btnImport(); ?>"><i class="pRa5 inline-block sf-in"></i><span><?php echo T_("Import"); ?></span></a>
<?php } // endif ?>
<?php if(\dash\face::btnExport()) { ?>
     <a class="btn-light" href="<?php echo \dash\face::btnExport(); ?>"><i class="pRa5 inline-block sf-out"></i><span><?php echo T_("Export"); ?></span></a>
<?php } // endif ?>
<?php if(\dash\face::btnNew()) { ?>
     <a class="btn-light" href="<?php echo \dash\face::btnNew(); ?>"><i class="pRa5 inline-block sf-plus-circle"></i><span><?php echo T_("New"); ?></span></a>
<?php } // endif ?>


<?php if(\dash\face::btnDuplicate()) { ?>
     <a class="btn-light" href="<?php echo \dash\face::btnDuplicate(); ?>"><i class="pRa5 inline-block sf-files-o"></i><span><?php echo T_("Duplicate"); ?></span></a>
<?php } // endif ?>
<?php if(\dash\face::btnSetting()) { ?>
     <a class="btn-light" href="<?php echo \dash\face::btnSetting(); ?>"><i class="pRa5 inline-block sf-tools"></i><span><?php echo T_("Advance"); ?></span></a>
<?php } // endif ?>

<?php if(\dash\face::btnPreview()) { ?>
     <a class="btn-light" href="<?php echo \dash\face::btnPreview(); ?>" target="_blank" data-fancybox='btnPreview' data-type="iframe" data-preload="false"><i class="pRa5 inline-block sf-binoculars"></i><span><?php echo T_("Preview"); ?></span></a>
<?php } // endif ?>
<?php if(\dash\face::btnView()) { ?>
     <a class="btn-light" href="<?php echo \dash\face::btnView(); ?>" target="_blank" data-fancybox='btnView' data-type="iframe" data-preload="false"><i class="pRa5 inline-block sf-eye"></i><span><?php echo T_("View"); ?></span></a>
<?php } // endif ?>
<?php if(\dash\face::help()) { ?>
     <a class="btn-light" href="<?php echo \dash\face::help(); ?>" target="_blank"><i class="pRa5 inline-block sf-question-circle"></i><span><?php echo T_("Help"); ?></span></a>
<?php } // endif ?>
    </nav>
...
<?php if(\dash\face::btnPrint()) { ?>
     <a class="btn master" data-exec='print'><i class="pRa5 inline-block sf-print"></i><span><?php echo T_("Print"); ?></span></a>
<?php } // endif ?>
