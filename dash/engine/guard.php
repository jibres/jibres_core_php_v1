...
class guard
{
	...
	private static function header_content_security_policy()
	{
		...
		$csp .= "script-src ". self::csp_domain('cdn'). " *.google-analytics.com www.googletagmanager.com *.google-analytics.com *.google.com static.cloudflareinsights.com 'unsafe-inline' http://localhost:9759/jibres/; ";
		// style-src
		...
		// frame-src
		$csp .= "frame-src 'self' https://tejarak.com/ https://status.jibres.com/ https://sarshomar.com; ";
		// base-uri
		$csp .= "base-uri 'self'; ";
		// manifest-src
