...
class guard
{
	...
	private static function header_content_security_policy()
	{
		...
		$csp .= "script-src ". self::csp_domain('cdn'). " *.google-analytics.com www.googletagmanager.com *.google-analytics.com *.google.com static.cloudflareinsights.com 'unsafe-inline'; ";
		// style-src
