...
class guard
{
	...
	private static function header_content_security_policy()
	{
		...
		$csp .= "script-src ". self::csp_domain('cdn'). " 'unsafe-inline' *.google-analytics.com www.googletagmanager.com *.google.com static.cloudflareinsights.com http://localhost:9759/jibres/; ";
		// style-src
