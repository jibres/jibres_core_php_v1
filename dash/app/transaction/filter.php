...
class filter
{
	...
	private static function list_of_filter($_module = null, $_statistics_file = null)
	{
		...
		$list['plus']        = ['key' => 'plus', 	'group' => T_("Type"), 'title' => T_('Increase account recharge'), 	'query' => ['ct' => 'y'], 	'public' => true];
		$list['minus']     = ['key' => 'minus', 'group' => T_("Type"), 'title' => T_('Reduce account recharge'), 	'query' => ['ct' => 'n'], 	'public' => true];
