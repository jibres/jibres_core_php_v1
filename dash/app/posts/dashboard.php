...
class dashboard
{
	...
	public static function detail()
	{
		...
		$dashboard_detail['standard']          = \dash\db\posts::get_count(['subtype' => 'standard']);
		$dashboard_detail['gallery']           = \dash\db\posts::get_count(['subtype' => 'gallery']);
		$dashboard_detail['video']             = \dash\db\posts::get_count(['subtype' => 'video']);
		$dashboard_detail['audio']             = \dash\db\posts::get_count(['subtype' => 'audio']);
