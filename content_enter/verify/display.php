...
<?php if(in_array('telegram', $sendWayCod)) { ?>
	<div class="radio1">
		<input type="radio" name="sendCod" value="telegram" id="sRd3" checked autofocus>
...
<?php if(in_array('sms', $sendWayCod)) { ?>
	<div class="radio1">
		<input type="radio" name="sendCod" value="sms" id="sRd1" <?php if(!in_array('telegram', $sendWayCod)) { ?>checked autofocus <?php }//endif ?>	>
...
<?php if(in_array('call', $sendWayCod)) { ?>
	<div class="radio1">
		<input type="radio" name="sendCod" value="call" id="sRd2">
...
<?php if(in_array('sendsms', $sendWayCod)) { ?>
	<div class="radio1">
		<input type="radio" name="sendCod" value="sendsms" id="sRd4">
...
<?php if(in_array('later', $sendWayCod)) { ?>
	<div class="radio1">
		<input type="radio" name="sendCod" value="later" id="sRd5">
