...
if(\dash\user::id())
{
	...
	{
		echo '<div class="alert-success f fs08 text-center font-bold" title='. T_("You"). '>';
...
<div class="btn-warning block" data-confirm data-data='{"logoutapp": 1 <?php echo \dash\csrf::get_json() ?>}' ><?php echo T_("Logout"); ?></div>
