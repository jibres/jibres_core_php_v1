  ...
  <div class="c4 s12">
    <div class="cbox ovh">
        ...
        <div class="f fc-mute mB20 fs09">
          ...
          <div class="cauto os"><a target="_blank" href="<?php echo \dash\url::kingdom(); ?>/ip/<?php echo \dash\data::masterTicketDetail_ipRaw(); ?>"><?php echo \dash\data::masterTicketDetail_prettyip(); ?></a></div>
        </div>
        <?php } //endif ?>
