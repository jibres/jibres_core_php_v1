<h2 class="f" data-kerkere='#ticket-add-detail' data-kerkere-icon='open'>
  <span class="cauto pRa10"><span class="badge primary">POST</span></span>
  <span class="c"><?php echo T_("Add new ticket"); ?></span>
</h2>
<div id="ticket-add-detail">
...
<pre>
curl -X POST <?php echo \dash\data::CustomerApiURL(); ?>ticket/add -H 'appkey: <?php echo \dash\data::myAppKey(); ?>' -H 'apikey: <?php echo \dash\data::myApiKey(); ?> -d '{"content": "Can Help me?"}'
</pre>
