...
<div id="ticket-list-detail">
  <div class="cbox" id='ticket-list'>
    <div class="msg url">
      ...
      <span><?php echo \dash\data::CustomerApiURL(); ?><b>ticket/list</b></span>
    </div>
...
<pre>
curl -X GET <?php echo \dash\data::CustomerApiURL(); ?>ticket/list -H 'appkey: <?php echo \dash\data::myAppKey(); ?>' -H 'apikey: <?php echo \dash\data::myApiKey(); ?>'
</pre>
