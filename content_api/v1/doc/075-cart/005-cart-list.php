...
<div id="show-cart-detail">
  <div class="cbox" id='show-cart'>
    <div class="msg url">
      ...
      <span><?php echo \dash\data::CustomerApiURL(); ?><b>cart/list</b></span>
    </div>
...
<pre>
curl -X GET <?php echo \dash\data::CustomerApiURL(); ?>cart/list -H 'appkey: <?php echo \dash\data::myAppKey(); ?>' -H 'apikey: <?php echo \dash\data::myApiKey(); ?>'
</pre>
