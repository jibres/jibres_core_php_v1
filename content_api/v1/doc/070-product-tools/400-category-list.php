...
<div id="category-list-detail">
  <div class="cbox" id='category-list'>
    <div class="msg url">
      ...
      <span><?php echo \dash\data::CustomerApiURL(); ?><b>category/list</b></span>
    </div>
...
<pre>
curl -X GET <?php echo \dash\data::CustomerApiURL(); ?>category/list -H 'appkey: <?php echo \dash\data::myAppKey(); ?>' -H 'apikey: <?php echo \dash\data::myApiKey(); ?>'
</pre>
