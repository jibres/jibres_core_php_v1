<h2 class="f" data-kerkere='#product-search-detail' data-kerkere-icon='open'>
  ...
  <span class="c"><?php echo T_("Get list of products"); ?></span>
</h2>
...
<pre>
curl -X GET <?php echo \dash\data::CustomerApiURL(); ?>products/search?q=123 -H 'appkey: <?php echo \dash\data::myAppKey(); ?>' -H 'apikey: <?php echo \dash\data::myApiKey(); ?>'
</pre>
