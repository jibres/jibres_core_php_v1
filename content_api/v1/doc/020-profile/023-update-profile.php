...
<div id="update-profile-detail">
  <div class="cbox" id='update-profile'>
    ...
    <?php require (root. 'content_api/v1/doc/000-public/header-appkey-apikey.php'); ?>
      ...
      <table class="tbl1 v3">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <div class="fc-mute"><?php echo T_("Your account username in"); ?> <?php echo T_("instagram"); ?></div>
            </td>
            <td>
              <div class="fc-green"><i><?php echo T_("Optional"); ?></i></div>
            </td>
          ...
          <tr>
            ...
            <td>
              <div class="fc-mute"><?php echo T_("Your account username in"); ?> <?php echo T_("linkedin"); ?></div>
            </td>
            <td>
              <div class="fc-green"><i><?php echo T_("Optional"); ?></i></div>
            </td>
          ...
          <tr>
            ...
            <td>
              <div class="fc-mute"><?php echo T_("Your account username in"); ?> <?php echo T_("facebook"); ?></div>
            </td>
            <td>
              <div class="fc-green"><i><?php echo T_("Optional"); ?></i></div>
            </td>
          ...
          <tr>
            ...
            <td>
              <div class="fc-mute"><?php echo T_("Your account username in"); ?> <?php echo T_("twitter"); ?></div>
            </td>
            <td>
              <div class="fc-green"><i><?php echo T_("Optional"); ?></i></div>
            </td>
...
<pre>
curl -X POST \
  <?php echo \dash\data::CustomerApiURL(); ?>profile/update \
