<h2 class="f" data-kerkere='#contact-detail' data-kerkere-icon='open'>
  ...
  <span class="c"><?php echo T_("Get contact text"); ?></span>
</h2>
<div id="contact-detail">
  <div class="cbox" id='contact'>
    <div class="msg url">
      <i class="method">GET</i>
      <span><?php echo \dash\data::CustomerApiURL(); ?><b>business/contact</b></span>
    </div>
    ...
    <pre>curl -X GET <?php echo \dash\data::CustomerApiURL(); ?>business/contact -H 'appkey: <?php echo \dash\data::myAppKey(); ?>' </pre>
...
<pre>
{
  ...
  "result": {
    ...
    "title": "contact",
    "slug": "contact",
    "url": "<?php echo \dash\data::CustomerApiURL(); ?>contact",
