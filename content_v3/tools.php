...
class tools
{
	...
	{
		if(isset(self::$v3['appkey_detail']) && self::$v3['appkey_detail'])
		{
			return true;
		}
		else
	...
	public static function check_appkey()
	{
		...
		self::$v3['appkey_detail'] = $appkey_is_ok;
	...
	public static function check_apikey()
	{
		...
		// $session_id = \dash\url::kingdom(). 'APIv3'. $get['id'];
		$session_id_text = \dash\url::subdomain(). '.'. \dash\url::root(). '.'. \dash\url::store(). 'v3-'. $apikey;
		$session_id = 'APIv3-'. md5($session_id_text);
