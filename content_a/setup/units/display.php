      ...
      <form method="post" autocomplete="off">
        ...
        <div class="mB10">
          ...
          <select class="select22" name="currency" id="currency">
            ...
            <?php foreach (\dash\data::currencyList() as $key => $value) {?>
                ...
                <option value="<?php echo $key; ?>" <?php if(\dash\data::dataRow_currency() == $key) { echo 'selected';}elseif(\dash\data::dataRow_country() == 'IR' && $key == 'IRT' && !\dash\data::dataRow_currency()) {echo 'selected';} ?> ><?php echo a($value, 'name'); ?> - <?php echo a($value, 'symbol_native'); ?></option>
        ...
        <div class="mB10">
          ...
          <select name="mass_unit" id="mass" class="select22">
            ...
            <option value="<?php echo $key; ?>" <?php if(\dash\data::dataRow_mass_unit() == $key) { echo 'selected'; } ?> ><?php echo a($value, 'name'); ?></option>
        ...
        <div class="mB10">
          ...
          <select name="length_unit" id="length" class="select22">
            ...
            <option value="<?php echo $key; ?>" <?php if(\dash\data::dataRow_length_unit() == $key) { echo 'selected'; } ?> ><?php echo a($value, 'name'); ?></option>
            <?php } //endfor ?>
