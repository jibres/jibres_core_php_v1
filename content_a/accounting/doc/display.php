			...
			<tbody>
				<?php foreach (\dash\data::dataTable() as $key => $value) {?>
					<tr class="font-12">
						...
						<td class=""><?php if(\dash\get::index($value, 'tstatus') === 'Permanent') { echo '<i class="compact sf-lock fc-green mRa10"></i>';} else { echo '<i class="compact sf-unlock fc-red mRa10"></i>';}  ?><?php echo T_(\dash\get::index($value, 'tstatus')) ?></td>
