    ...
    <div class="pad">
      <div class="row">
        <div class="c-xs-12 c-sm-12 c-md-8">
            ...
            <label for="assistant_id"><?php echo T_("Accounting assistant") ?> <small class="text-red-800">* <?php echo T_("Required") ?></small></label>
...
?>
      ...
      <div class="row align-end">
        ...
        <div class="c-xs-12 c-sm-6 c-md-4 c-lg-3 c-xl-3">
        	<label for="value"><?php echo T_("Amount") ?> <small class="text-red-800"><?php echo T_("Required") ?></small></label>
        	<div class="input mB0-f">
