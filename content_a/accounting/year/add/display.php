      ...
      <div class="body">
        ...
        <div class="row">
          <div class="c-sm-6">
            ...
            <div class="input">
              <input class="ltr" type="text" placeholder="yyyy/mm/dd" data-format="date" name="startdate" id="date" value="<?php echo \dash\utility\convert::to_en_number(\dash\fit::date(\dash\data::dataRow_startdate())); ?>" autocomplete='off' <?php if((\dash\url::subchild() !== 'add') && (\dash\data::editMode() || \dash\data::dataRow_startdate()))  {echo 'disabled';}else{echo 'required';}?>>
            </div>
