    ...
    <table class="tbl1 v1 font-10">
      ...
      <tbody>
        ...
        <?php foreach (\dash\data::reportDetail_list() as $key => $value) {?>
          ...
          <tr class="positive">
            <td colspan="10" class="txtB fs14"><a href="<?php echo \dash\url::this(). '/turnover?'. http_build_query(['year_id' => \dash\request::get('year_id'), 'group' => \dash\get::index($value, 'group_id')]); ?>"><?php echo \dash\get::index($value, 'group_title') ?></a></td>
          </tr>
        <?php } //endif ?>
          <tr>
      ...
      <tfoot>
          ...
          <?php } //endif ?>
            ...
            <?php if(\dash\request::get('show') === 'balancesheet') {?>
            <td data-copy="<?php echo \dash\get::index($value, 'opening') ?>" class="font-12 ltr txtR fc-black"></i><code><?php echo \dash\fit::number(\dash\get::index(\dash\data::reportDetail_sum(), 'opening'), true, 'en') ?></code></td>
            <td data-copy="<?php echo \dash\get::index($value, 'current') ?>" class="font-12 ltr txtR fc-black"></i><code><?php echo \dash\fit::number(\dash\get::index(\dash\data::reportDetail_sum(), 'current'), true, 'en') ?></code></td>
          <?php }else{ ?>
