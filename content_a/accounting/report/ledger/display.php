  ...
  <?php foreach ($one_total as $value) {?>
        <tr data-index="<?php echo ($key + 1) ?>" class="border-solid border-b border-blue-100">
          ...
          <?php }elseif(a($value, 'mode') === 'creditor') {?>
            <td class="border-solid border-e border-blue-900  pRa5"><?php echo a($value, 'total_title') ?></td>
            <td class="border-solid border-e border-blue-900"></td>
            <td class="border-solid border-e-2 border-purple-700"></td>
            <td data-copy='<?php echo a($value, 'show_value'); ?>' class="border-solid border-e-2 border-purple-700" ltr txtR fc-red"><code><?php echo \dash\fit::number(a($value, 'show_value'), true, 'en') ?></code></td>
          <?php } //endif ?>
            <td class="border-solid border-e-2 border-purple-700" data-copy='<?php echo a($value, 'remain_value'); ?>' class="ltr txtR fc-green"><code><?php echo \dash\fit::number(a($value, 'remain_value'), true, 'en') ?></code></td>
