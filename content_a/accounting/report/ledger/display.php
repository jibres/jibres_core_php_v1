...
<?php }else{ ?>
  <?php foreach (\dash\data::reportDetail() as $pageNumber => $one_page) { ?>
...
<style type="text/css">.page-break{page-break-after:always}</style>
  <div class="printArea" data-size='A4'>
    <div class="msg f align-center txtC font-16">
      <div class="c3"><span><?php echo \dash\fit::number(a($one_page, 0, 'total_code')); ?></span> <span><?php echo a($one_page, 0, 'total_title'); ?></span></div>
...
<?php if(a($value, 'mode') === 'end_of_page') { $borderPosClass = 'border-t-4';} else { $borderPosClass = 'border-b-4';} ?>
        ...
        <?php }else{ ?>
          ...
          <?php } //endif ?>
            <?php echo  wow_number(a($value, 'remain_value')); ?>
        <?php } //endif ?>
        </tr>
      <?php } //endif ?>
    </tbody>
