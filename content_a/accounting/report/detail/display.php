      ...
      <tbody>
        <?php foreach (\dash\data::reportDetail() as $key => $value) {?>
          <tr>
            ...
            <td class="font-12 fc-red"><?php echo \dash\fit::number(\dash\get::index($value, 'debtor')) ?></td>
            <td class="font-12 fc-green"><?php echo \dash\fit::number(\dash\get::index($value, 'creditor')) ?></td>
            <td class="font-12 fc-red"><?php echo \dash\fit::number(\dash\get::index($value, 'remain_debtor')) ?></td>
            <td class="font-12 fc-green"><?php echo \dash\fit::number(\dash\get::index($value, 'remain_creditor')) ?></td>
          </tr>
        <?php } //endif ?>
      </tbody>
    </table>
