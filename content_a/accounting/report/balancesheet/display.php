    ...
    <table class="tbl1 v6 text-xs">
      ...
      <tfoot>
          ...
          <?php if(\dash\request::get('show') === 'balancesheet') {?>
            ...
            <td data-copy="<?php echo a(\dash\data::reportDetail_sum(), 'current') ?>" class="text-sm ltr text-right"></i><code><?php echo \dash\fit::number(a(\dash\data::reportDetail_sum(), 'current'), true, 'en') ?></code></td>
          <?php }else{ ?>
