    ...
    <table class="tbl1 v6 font-10">
      ...
      <tfoot>
          ...
          <?php if(\dash\request::get('show') === 'balancesheet') {?>
            ...
            <td data-copy="<?php echo \dash\get::index(\dash\data::reportDetail_sum(), 'current') ?>" class="font-12 ltr txtR"></i><code><?php echo \dash\fit::number(\dash\get::index(\dash\data::reportDetail_sum(), 'current'), true, 'en') ?></code></td>
          <?php }else{ ?>
