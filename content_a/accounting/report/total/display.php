    ...
    <tbody>
     ...
     <tfoot>
          ...
          <?php } //endif ?>
            ...
            <?php if(\dash\request::get('show') === 'balancesheet') {?>
          <td class="font-12 ltr txtR" data-copy='<?php echo \dash\get::index($group['sum'], 'end_value'); ?>'><code><?php echo \dash\fit::number(\dash\get::index($group['sum'], 'end_value'), true, 'en') ?></code></td>
