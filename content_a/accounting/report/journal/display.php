...
<?php if(a($value, 'mode') === 'end_of_page') { $borderPosClass = 'border-t-4';} else { $borderPosClass = 'border-b-4';} ?>
            ...
            <?php if(false) {?>
              ...
              <td class="border-solid <?php echo $borderPosClass; ?> border-r-2 border-gray-400 font-14" style="line-height:70px;" data-copy='<?php echo a($value, 'sum_creditor_on_page'); ?>'><code class="ltr text-right text-red-800 font-bold"><?php echo \dash\fit::number(a($value, 'sum_creditor_on_page'), true, 'en') ?></code></td>
            <?php }// endif ?>
          <?php }else{ ?>
        ...
        <?php }else{ ?>
          ...
          <?php }elseif(a($value, 'mode') === 'creditor') {?>
            ...
            <?php if(false) {?>
              <td data-copy='<?php echo a($value, 'show_value'); ?>' class="ltr text-right text-red-800 font-14"><code class="font-bold"><?php echo \dash\fit::number(a($value, 'show_value'), true, 'en') ?></code></td>
            <?php } //endif ?>
