      ...
      <div class="body">
        <?php if(\dash\data::parentList()) {?>
          <select class="select22" name="parent">
            <option value=""><?php echo T_("Without parent") ?></option>
        ...
        <div class="input">
          <input type="number" min="10" max="9999999999" name="code" id="code" required value="<?php echo \dash\data::dataRow_code(); ?>">
        </div>
