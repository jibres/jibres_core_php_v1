...
class view extends \content_a\main\view
{
	...
	public function loadMemberDetail()
	{
		...
		$get_supplier         = ['id' => \lib\utility::get('id')];
		$supplier             = \lib\app\supplier::get($get_supplier, ['its_me' => true]);
		$this->data->supplier = $supplier;

		// var_dump($supplier);
		if(isset($supplier['fullname']))
		{
			$this->data->page['title'] = ' | '. $supplier['fullname'];
		}
