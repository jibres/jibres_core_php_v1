    ...
    <table class="tbl1 v1 cbox fs12">
      ...
      <tbody>
        ...
        <tr <?php if(\dash\request::get('id') == $value['id']) { echo ' class="positive" '; } ?>>
          ...
          <td class="txtC">
            <a href="<?php echo \dash\url::here(); ?>/products?companyid=<?php echo a($value, 'id'); ?>" title='<?php echo T_("Click to check products in this company"); ?>'><?php echo \dash\fit::number(a($value, 'count')); ?></a>
          </td>
          <td class="collapsing">
              ...
              <select name="company" class="select22" id="company">
                ...
                <?php if(is_array(\dash\data::allCompany())) {?>
                  ...
                  <?php foreach (\dash\data::allCompany() as $key => $value) {?>
                    ...
                    <option value="<?php echo a($value, 'id'); ?>"><?php echo $value['title']; ?></option>
