...
<section class="f">
  ...
  <div class="c pRa10">
    <a href="<?php echo \dash\url::that(). '/chart?'. \dash\request::fix_get(['field' => null]); ?>" class="stat x70 <?php if(\dash\url::subchild() === 'chart') { echo 'active'; } ?>">
  ...
  <div class="c pRa10">
    <a href="<?php echo \dash\url::that(). '/chart2?'. \dash\request::fix_get(['field' => null]); ?>" class="stat x70 <?php if(\dash\url::subchild() === 'chart2') { echo 'active'; } ?>">
      <h3><?php echo T_("Chart");?></h3>
      <div class="val"><i class="sf-chart"></i></div>
    </a>
  </div>
