            ...
            <div class="box">
                <div class="pad">
                    ...
                    <div class="switch1 mb-4 mt-4">
                        <input type="checkbox" name="inquiry" id="inquiry" <?php if(\dash\data::dataRow_inquiry()) {
							echo 'checked';
						} ?>>
					...
					<?php if(\dash\data::dataRow_inquiry()) { ?>
                        ...
                        <div class="alert-secondary ltr text-left f">
                            <div class="text-left ltr"><a target="_blank"
                                                          href="<?php echo \dash\data::dataRow_url() . '/inquiry'; ?>"><?php echo \dash\data::dataRow_url() . '/inquiry'; ?></a>
                            </div>
                            <div class="text-right"
                                 data-copy="<?php echo \dash\data::dataRow_url() . '/inquiry'; ?>"><?php echo \dash\utility\icon::svg('link') ?></div>
                        </div>
					<?php } // endif ?>

                    <div data-response="inquiry" <?php if(\dash\data::dataRow_inquiry()) {/*nothing*/
					} else {
                        ...
                        <div class="mb-2">
                            ...
                            <textarea name="inquirymsg" class="txt" rows="7" id="inquirymsg"
                                      placeholder="<?php echo T_("Inquiry Message") ?>"><?php echo \dash\data::dataRow_inquirymsg(); ?></textarea>
                        </div>

                        <label for="messagef"><?php echo T_("Message if result founded") ?></label>
                        <div class="input">
                            <input type="text" id="messagef" name="inquiry_msg_founded"
                                   value="<?php echo a($inquerySetting, 'inquiry_msg_founded'); ?>">
                        </div>

                        <label for="messagenf"><?php echo T_("Message if result not founded") ?></label>
                        <div class="input">
                            <input type="text" id="messagenf" name="inquiry_msg_not_founded"
                                   value="<?php echo a($inquerySetting, 'inquiry_msg_not_founded'); ?>">
                        </div>
                        ...
                        <div class="mb-2">
                            ...
                            <div data-uploader data-name='file' data-final='#finalImagefile1'>
                                ...
                                <label for="file1"><img id="finalImagefile1"
														<?php if(\dash\data::dataRow_inquiryimage()) { ?>src="<?php echo \dash\data::dataRow_inquiryimage(); ?>" <?php } //endif ?>
