    ...
    <tbody>
      <?php foreach (\dash\data::dataTable() as $key => $value) {?>
        <tr>
          ...
          <td class="collapsing"><?php if(a($value, 'factor_id')) {?><a href="<?php echo \dash\url::kingdom(). '/a/order/detail?id='. a($value, 'factor_id'); ?>"><?php echo T_("View Order") ?></a><?php } //endif ?></td>
