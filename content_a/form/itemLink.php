...
<nav class="items">
 <ul>
      ...
      <li><a class="f item" href="<?php echo \dash\url::this(). '/condition?id='. \dash\request::get('id'); ?>"><i class="sf-atom"></i><div class="key"><?php echo T_("Form condition");?></div><div class="go"></div></a></li>
