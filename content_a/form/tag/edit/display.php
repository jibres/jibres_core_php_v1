    ...
    <div class="avand-md">
        ...
        <div class="box">
            <div class="pad">
                ...
                <div data-response='autocomment' <?php if(\dash\data::dataRow_autocomment()) {/*nothing*/
				} else {
                ...
                <div data-response='sendsms' <?php if(\dash\data::dataRow_sendsms()) {/*nothing*/
				} else {
					echo 'data-response-hide';
				} ?>>
                    <div class="mb-2">
            ...
            <footer>
				<?php if(!\dash\data::dataRow_count() && !\dash\data::dataRow_have_child()) { ?>
                    <div class="txtRa"><span data-confirm data-data='{"delete" : "delete"}'
                                             class="btn-link-danger"><?php echo T_("Remove tag"); ?></span></div>
				<?php } else { ?>
                    <div class="txtRa"><a href="<?php echo \dash\url::that() . '/remove?' . \dash\request::fix_get() ?>"
