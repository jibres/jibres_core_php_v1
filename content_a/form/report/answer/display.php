...
<?php if(\dash\data::noChart()) {?>
  <div class="alert-warning text-center font-bold fs14"><?php echo T_("Can not drow chart for this item!") ?></div>
<?php }else{ ?>
...
<div class="alert-warning font-bold font-14">Not ready this chart yet :/</div>
