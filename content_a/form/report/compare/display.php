...
<form method="get" autocomplete="off" action="<?php echo \dash\url::current(); ?>">
  <div class="box">
    <div class="pad">
      ...
      <div class="alert-info font-bold font-14">
        <span class="mRa10 font-bold"><?php echo \dash\fit::number(\dash\data::itemDetailQ1_sort()) ?>.</span>
      ...
      <?php if(\dash\data::itemDetailQ2_title()) {?>
        <div class="alert-info font-bold font-14">
        <span class="mRa10 font-bold"><?php echo \dash\fit::number(\dash\data::itemDetailQ2_sort()) ?>.</span>
    ...
    <?php if(\dash\data::itemDetailQ3_title()) {?>
      <div class="alert-info font-bold font-14">
        <span class="mRa10 font-bold"><?php echo \dash\fit::number(\dash\data::itemDetailQ3_sort()) ?>.</span>
