...
<section class="f" data-option='website-footer-menu-1'>
  <div class="c8 s12">
    <div class="data">
...
{
  echo T_("A site menu is an essential part of your website. Every site should have one so that your site visitors can navigate between your pages or sections. If your menu is placed in the footer or footer, it automatically shows on every page.");
}
?></p>
      </div>
    </div>
