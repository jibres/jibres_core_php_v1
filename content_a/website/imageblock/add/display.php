...
<div class="avand-sm">
  ...
  <form method="post" autocomplete="off" >
    ...
    <div class="box" data-uploader data-name='image' data-file-max-size='<?php echo \dash\data::maxFileSize() ?>' data-final='#finalImage' <?php echo \dash\data::ratioHtml(); ?>>
    ...
    <div class="box">
      ...
      <footer class="txtRa">
        <?php if(\dash\data::dataRow()) {?>
          <div class="f">
            <div class="cauto">
              <div data-confirm data-data='{"remove": "imageblock"}' class="btn linkDel"><?php echo T_("Remove"); ?></div>
            </div>
            <div class="c"></div>
            <div class="cauto">
