<div class="avand-sm">
    ...
    <form method="post" class="box" autocomplete="off" >
        ...
        <div class="body">
          ...
          <div class="input">
            <input type="text" name="title" id="title" value="<?php if(!\dash\get::index(\dash\data::lineSetting(), 'title') && \dash\get::index(\dash\data::lineSetting(), 'title') !== '0'){ echo \dash\data::imageblockNameSuggestion(); }else{ echo \dash\get::index(\dash\data::lineSetting(), 'title'); } ?>"  maxlength="200" >
          </div>
            ...
            <select class="select22" name="ratio">
              ...
              <option value="21:9" <?php if(\dash\data::lineSetting_ratio() === '21:9') {echo 'selected';} ?>><?php echo \dash\fit::text("21:9") ?></option>
