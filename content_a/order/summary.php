...
<div class="tblBox">
	<table class="tbl1 v4">
		<tbody>
              ...
              <tr class="">
                <td class="collapsing text-gray-400"><?php echo T_("Subprice") ?></td>
            ...
            <?php } //endif ?>
              ...
              <tr class="">
                <td class="collapsing text-gray-400"><?php echo T_("Subdiscount") ?></td>
            ...
            <?php if(a($orderDetail, 'factor', 'subvat')) {?>
              <tr class="">
                <td class="collapsing text-gray-400"><?php echo T_("Vat") ?></td>
            ...
            <?php } //endif ?>
              ...
              <?php if(a($orderDetail, 'factor', 'discount')) {?>
                <tr>
                  <td class="collapsing text-gray-400"><?php echo T_("Discount") ?></td>
              ...
              <?php if(a($orderDetail, 'factor', 'discount2')) {?>
                <tr class="active">
                  <td class="collapsing text-gray-400"><?php echo T_("Discount code") ?></td>
              ...
              <?php } //endif ?>
                ...
                <tr>
                  <td class="collapsing text-gray-400"><?php echo T_("Shipping") ?></td>
              ...
              <tr class="active">
                <td class="collapsing text-gray-400"><?php echo T_("Total") ?></td>
