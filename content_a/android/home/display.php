...
<div class="f">
  ...
  <div class="c4 x3 s12">
   <nav class="items">
     <ul>
       <li><a class="f <?php if(\dash\data::setupGuide_apk()) { echo 'complete'; } ?>" href="<?php echo \dash\url::this();?>/apk"><div class="key"><?php echo T_('Download your App');?></div><div class="go"></div></a></li>
       ...
       <li><a class="f <?php if(\dash\data::setupGuide_title()) { echo 'complete'; } ?>" href="<?php echo \dash\url::this();?>/title"><div class="key"><?php echo T_('App Title');?></div><div class="go"></div></a></li>
