...
?>
    ...
    <div class="mB20">
      ...
      <a href="<?php echo \dash\url::this(). '/setting'; ?>" class="checklist fc-black" <?php if(\dash\data::appDetail_title()) { echo 'data-okay';}else{echo 'data-fail';} ?>><?php echo T_("Application title"); ?></a>

      <a href="<?php echo \dash\url::this(). '/setting'; ?>" class="checklist fc-black" <?php if(\dash\data::appDetail_desc()) { echo 'data-okay';}else{echo '';} ?>><?php echo T_("Application description"); ?></a>


      <a href="<?php echo \dash\url::this(). '/setting'; ?>" class="checklist fc-black" <?php if(\dash\data::appDetail_slogan()) { echo 'data-okay';}else{echo '';} ?>><?php echo T_("Application slogan"); ?></a>
      <hr>

      <a href="<?php echo \dash\url::this(). '/splash'; ?>" class="checklist fc-black" <?php if(\dash\data::appDetail_splash_theme()) { echo 'data-okay';}else{echo 'data-fail';} ?>><?php echo T_("Splash theme"); ?></a>
      <hr>
