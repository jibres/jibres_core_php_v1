  ...
  <div class="justify-center mB20 c4 s12 pA5">
    <div class="c6 m8 s12">
      <div class="box">
        ...
        <div class="body">
            ...
            <div class="box" data-uploader data-name="file<?php echo $i; ?>" data-ratio="1" data-file-max-size='<?php echo \dash\data::maxFileSize() ?>' data-final='#finalImage<?php echo $i; ?>'>
    ...
    <div class="c6 s12">
       <section class="mobileFrame" data-intro>
        <div class="screen">
          <div class="imgBox">
            <img id="finalImage<?php echo $i; ?>" src="<?php echo a($introSaved, $i, 'image'); ?>" alt='<?php echo a($introSaved, $i, 'title'); ?>'>
          </div>
