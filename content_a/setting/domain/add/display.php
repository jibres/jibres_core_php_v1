...
<div class="avand-md">
  ...
  <nav class="items">
    <ul>
      <li><a class="f" target="_blank" href="<?php echo \dash\url::sitelang(); ?>/my/domain/buy"><div class="key"><i class="sf-asterisk fc-hot"></i> <?php echo T_("Buy new domain"); ?></div><div class="go"></div></a></li>
    </ul>
  </nav>
