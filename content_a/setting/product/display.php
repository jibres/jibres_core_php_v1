  ...
  <div class="c8 s12 m10 x6 pA20">
    ...
    <nav class="items">
      <ul>
        ...
        <?php if(\dash\permission::check('productPriceHistoryView')) {?><li><a class="f" href="<?php echo $urlHere; ?>/pricehistory"><div class="key"><?php echo T_("Price history"); ?></div><div class="go"></div></a></li><?php } //endif ?>
