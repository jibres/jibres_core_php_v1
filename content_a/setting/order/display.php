...
<section class="f" data-option='setting-order-min-price' id="setting-order-min-price">
  <div class="c8 s12">
    <div class="data">
      <h3><?php echo T_("Minimum order amount"); ?></h3>
      <div class="body">
      </div>
    </div>
  </div>
      ...
      <div class="body">
        ...
        <div class="flex space-s-3 items-center">
          <?php foreach (\dash\utility\pay\get::active_payment() as $key => $value) {?>
           <div class="w-16"><img class="" src="<?php echo a($value, 'icon') ?>" alt="<?php echo a($value, 'title') ?>"></div>
          <?php } //endif ?>
        </div>
