...
class model
{
	public static function getPost()
	{
		...
		// zarinpal
		{
			...
			{
				$payment['zarinpal']['status']     = \dash\request::post('zarinpal') ? true : false;
		...
		// mellat
		{
			...
			{
				$payment['mellat']['status']       = \dash\request::post('mellat') ? true : false;
		...
		// asnapardakht
		{
			...
			{
				$payment['asanpardakht']['status']       = \dash\request::post('asanpardakht') ? true : false;
		...
		// parsian
		{
			...
			{
				$payment['parsian']['status']       = \dash\request::post('parsian') ? true : false;
		...
		// idpay
		{
			...
			{
				$payment['idpay']['status'] = \dash\request::post('idpay') ? true : false;
