  ...
  <form method="post" autocomplete="off">
    <div  class="box impact mB25-f">
      <header><h2><?php echo T_("Set imber live chat setting");?></h2></header>
        <div class="body">
          <p class="mB0-f"><?php echo T_("If you want to have live chat in your website, enter your imber token code here. \nTo do this, you need to register on imber.to and get the code from there"); ?></p>
