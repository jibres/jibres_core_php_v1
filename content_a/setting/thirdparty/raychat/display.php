...
<div class="avand-sm impact zero">
  <form method="post" autocomplete="off" id='aThirdParty'>
    <div class="box">
        <div class="body">
          <img class="block mb-2" src="<?php echo \dash\url::cdn(); ?>/img/thirdparty/livechat/raychat-banner.png" alt='raychat'>
          <div class="alert2">
...
<?php if (!\dash\detect\device::detectPWA()) { ?>
        <footer class="txtRa">
          <button  class="btn-outline-success" ><?php echo T_("Save"); ?></div>
        </footer>
<?php } ?>
    </div>
  </form>
