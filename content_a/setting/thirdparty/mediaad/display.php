...
<div class="avand-sm impact zero">
  <form method="post" autocomplete="off" id='aThirdParty'>
    <div  class="box">
      <img class="block p-2" src="<?php echo \dash\url::cdn(); ?>/img/thirdparty/mediaad.svg" alt='Mediaad'>
        <div class="body">
          <div class="alert2">
          ...
          <div class="alert-info ltr">https://s1.mediaad.org/serve/<b class="font-bold text-red-800">24225</b>/retargeting.js</div>
            <label for="iretargeting">کد SDK ریتارگتینگ <span class="text-red-800">*</span></label>
            <div class="input ltr">
