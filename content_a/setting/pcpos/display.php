    ...
    <div class="box">
     <form method="post" autocomplete="off" class="pad">
      ...
      <div data-response='pos' data-response-where='irkish' data-response-hide>
        ...
        <div class="f mt-2" data-response='irankish'  data-response-hide >
      ...
      <div data-response='pos' data-response-where='asanpardakht' data-response-hide>
        ...
        <div class="f mt-2" data-response='asanpardakht'  data-response-hide >
          <div class="c6 pLa5">
      ...
      <button class="btn block primary mt-2"><?php echo T_("Add pos"); ?></button>
     </form>
    </div>
