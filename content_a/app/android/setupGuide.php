...
<div class="setupGuide">
 ...
 <section>
  <div class="f">
   ...
   <div class="c"><a class="item <?php if(\dash\data::setupGuide_apk()) { echo 'complete'; } ?>" href="<?php echo \dash\url::that();?>/review"><?php echo T_('Review Your App');?></a></div>
  </div>
 </section>
</div>
...
<div class="welcome">
  ...
  <div class="buildBtn">
    <a class="btn xl master" href="<?php echo \dash\url::that(); ?>/logo?setup=wizard"><?php echo T_("Build it now"); ?></a>
  </div>
</div>
<?php
}
