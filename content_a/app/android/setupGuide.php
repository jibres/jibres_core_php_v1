...
<div class="setupGuide">
 ...
 <section>
  <div class="f">
   <div class="c"><a class="item" href="<?php echo \dash\url::that();?>/setting"><?php echo T_('General Settings');?></a></div>
   ...
   <div class="c"><a class="item" href="<?php echo \dash\url::that();?>/download"><?php echo T_('App Download Page');?></a></div>
  </div>
 </section>
</div>
