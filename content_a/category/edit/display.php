    ...
    <div class="c-xs-12 c-sm-12 c-lg-4">
      <section class="box">
       ...
       <section class="box">
          ...
          <footer>
            <?php if(!\dash\data::dataRow_count() && !\dash\data::dataRow_have_child()) {?>
              <div class="txtRa"><span data-confirm data-data='{"delete" : "delete"}' class="btn-link-danger" ><?php echo T_("Remove category"); ?></span></div>
            <?php }else{ ?>
              <div class="txtRa"><a href="<?php echo \dash\url::this(). '/remove?'. \dash\request::fix_get() ?>" class="btn-link-danger" ><?php echo T_("Remove category"); ?></a></div>
            <?php }//endif ?>
          </footer>
        </section>
