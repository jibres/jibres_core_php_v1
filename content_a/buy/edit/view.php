...
class view extends \content_a\main\view
{
	public function config()
	{
		...
		$this->data->page['desc']  = '';
		// $this->data->page['desc']  = T_('Buy your product via Jibres and enjoy using integrated web base platform.');
	...
	private static function getNeededField($_data)
	{
		...
		// 	'buyonline', 'buystore', 'carton', 'datecreated', 'datemodified', 'desc',
		// ];
