			...
			$html .= '<div class="c-xs-12 c-sm-12 c-md-12 c-lg-6">';
			{
				...
				$html .= '<div class="bg-white mt-2 rounded-lg">';
				{
					...
					$html .= '<div class="p-4 flex">';
					{
						...
						{
							$html .= '<div class="w-12 h-12 inline-flex items-center justify-center rounded-full bg-indigo-100 text-indigo-500 mb-4 flex-shrink-0 p-1">';
							{
								$icon = a($value, 'icon');
							...
							if($is_activated)
							{
								$html .= '<div class="w-8 h-8 inline-flex items-center justify-center rounded-full mb-4 flex-shrink-0 p-1" title="'.T_("Activated").'">';
								{
