   ...
   <div class="box">
    ...
    <div class="pad">
      ...
      <div class="input mB0-f">
        <input type="text" name="weight" id="iweight" value="<?php echo a($productDataRow,'weight'); ?>" autocomplete="off" maxlength="7" data-format='number'>
        <div class="addon small"><?php echo a($storData,'mass_detail','name'); ?></div>
      </div>

      <label for="ipreparationtime"><?php echo T_("Preparation time"); ?></label>
          <div class="input">
            <input type="text" name="preparationtime" id="ipreparationtime" value="<?php echo a($productDataRow,'preparationtime'); ?>"  autocomplete="off" maxlength="3" data-format='number'>
