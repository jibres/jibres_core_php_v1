...
<?php
  if(\dash\data::propertyList())
  {
    ...
    <form method="post" id="form1" data-patch>
          ...
          <?php $i=0; foreach (\dash\data::propertyList() as $property => $cat) { $i++; ?>
            <div class="msg info2">
                  ...
                  <li>
                    <div class="item f">
                      ...
                      <div class="value">
                        ...
                        <?php }elseif(a($value, 'lock')){ echo $value['value']; }else{ $randKey = rand(1, 999999); ?>
                          ...
                          <div class="input">
                            <input type="text" name="value_<?php echo $randKey; ?>" value="<?php echo $value['value'] ?>">
