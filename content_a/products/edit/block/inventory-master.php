    ...
    <section class="box">
      ...
      <div class="body">
          ...
          <div data-response='itrackquantity' <?php if(\dash\data::productDataRow_trackquantity() || (\dash\url::child() === 'add')){}else{ echo 'data-response-hide';} ?>  >
            <p class="fs09 text-gray-400"><?php echo T_("Inventory tracking can help you avoid selling products that have run out of stock, or let you know when you need to order or make more of your product."); ?></p>
            ...
            <p class="text-gray-400 fs09"><?php echo T_("Allow to purchase when sold out of stock"); ?></p>
