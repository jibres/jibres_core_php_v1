      ...
      <div class="seoPreview">
        ...
        <div class="f">
          <div class="c s12 pLa10">
            ...
            <p class="desc"><?php echo a($productDataRow,'seodesc'); ?></p>
          </div>
      ...
      <div class="seoData" data-kerkere-content='hide'>
        ...
        <div>
          ...
          <div class="input ltr mb-2">
            <input type="text" name="slug" id="seoSlug" placeholder='<?php echo T_("Slug"); ?>' value="<?php echo a($productDataRow,'slug'); ?>" maxlength='100' minlength="1" ">
          </div>
        </div>
        <div>
          ...
          <textarea class="txt" name="seodesc" id="seoDesc" maxlength='300' rows='3' placeholder='<?php echo T_("Excerpt used for social media and search engines"); ?>'><?php echo a($productDataRow,'seodesc'); ?></textarea>
        </div>
      </div>
    </div>
  </div>