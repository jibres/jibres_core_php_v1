...
?>
    <div class="box">
      <div class="pad1">
        ...
        <?php }else{ ?>
          <div data-uploader data-max-w="1600" data-max-h="1600" data-name='gallery' data-file-max-size='<?php echo \dash\data::maxFileSize() ?>' <?php echo \dash\data::ratioHtml(); ?> <?php if(\dash\url::child() === 'edit') { echo 'data-autoSend'; }?>>
