...
<form class="jPage" id='aProductData' method="post" autocomplete="off" data-autoScroll2="#productGallery">
 <div class="row">
  ...
  <div class="c-xs-12 c-sm-12 c-md-8 c-xxl-9">
    ...
    <div class="box">
      <div class="pad ovv">
        <textarea name="desc" data-editor class="txt" rows="3" maxlength="2000" placeholder='<?php echo T_("Description about product"); ?>'><?php echo a(\dash\data::productDataRow(),'desc'); ?></textarea>
      </div>
    </div>
    <?php  } //endif ?>
