...
<div class="f align-center">
  ...
  <div class="c">
    ...
    <a class='btn <?php if(\dash\request::get('notweight')) { echo 'primary2'; }else{ echo 'light';} ?> mB5' href="<?php echo \dash\url::that(); ?>?notweight=1<?php echo $andQ; ?>"><?php echo T_("Not weight"); ?></a>
  </div>
</div>
