...
<div class="cbox p0">
	<form method="get" action="<?php echo \dash\url::this(); ?>" autocomplete="off" data-action>
		...
		<select name="id" class="select22 barCode" id="productSearch"  data-model='html'  <?php \dash\layout\autofocus::html() ?> data-default data-ajax--delay="250" data-ajax--url='<?php echo \dash\url::here(). '/sale'; ?>?json=true' data-shortkey-search data-placeholder='<?php echo T_("Choose product"); ?>'>
      	</select>
