...
<form method="post" autocomplete="off">
  ...
  <?php echo \content_a\setting3\home\view::switcher('set_remove', true) ?>
  <div class="avand-md">
    <div class="box">
      <div class="pad">
      ...
      <footer class="f">
        <div class="cauto"><a class="btn-outline-secondary" href="<?php echo \dash\url::that() ?>"><?php echo T_("Cancel") ?></a></div>
        <div class="c"></div>
