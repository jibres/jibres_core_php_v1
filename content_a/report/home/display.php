...
<div class="f">
	...
	<div class="c6 s12">
		<div class="mLa5">
			<h4><?php echo T_("Product sales over time") ?></h4>
			<nav class="items long">
				<ul>
					<li>
	...
	<div class="c6 s12">
		<div class="mLa5">
			...
			<nav class="items long">
				...
				<ul>
					<li>
						<a class="item f" href="<?php echo \dash\url::this(); ?>/salesovertime?type=period">
							<i class="sf-tags"></i>
							<div class="key"><?php echo T_("Product sales reports over time"); ?></div>
							<div class="go"></div>
						</a>
				...
				<ul>
					<li>
						<a class="item f" href="<?php echo \dash\url::this(); ?>/salesovertime?type=month">
							<i class="sf-tags"></i>
							<div class="key"><?php echo T_("Product sales reports over month"); ?></div>
							<div class="go"></div>
						</a>
				...
				<ul>
					<li>
						<a class="item f" href="<?php echo \dash\url::this(); ?>/salesovertime?type=year">
							<i class="sf-tags"></i>
							<div class="key"><?php echo T_("Product sales reports over year"); ?></div>
							<div class="go"></div>
						</a>
