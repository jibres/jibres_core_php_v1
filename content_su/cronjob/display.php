<div class="avand-xl">
  <form method="post">
    ...
    <footer class="txtRa">
      ...
      <a class="btn secondary outline" target="_blank" data-direct href="<?php echo \dash\url::this(); ?>?download=crontabme"><?php echo T_("Downalod crontab me file"); ?></a>
      <a class="btn secondary outline" target="_blank" data-direct href="<?php echo \dash\url::this(); ?>?download=result"><?php echo T_("Downalod Execut result"); ?></a>
