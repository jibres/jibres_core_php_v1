    ...
    <?php if(isset($needUpgrade['jibres']) && $needUpgrade['jibres']) {?>
      <div class="c">
        <span><?php echo T_("Jibres"); ?></span>
         <div><?php echo T_("current version"); ?><?php echo @$needUpgrade['jibres']['current']; ?></div>
         <div><?php echo T_("new version"); ?><?php echo @$needUpgrade['jibres']['upgrade']; ?></div>
      </div>
    <?php } //endif ?>
    ...
    <?php if(isset($needUpgrade['store']) && $needUpgrade['store']) {?>
      <div class="c">
        <span><?php echo T_("Stores"); ?></span>
         <div><?php echo T_("current version"); ?><?php echo @$needUpgrade['store']['current']; ?></div>
         <div><?php echo T_("new version"); ?><?php echo @$needUpgrade['store']['upgrade']; ?></div>
      </div>
    <?php } //endif ?>
   </div>
  </div>
