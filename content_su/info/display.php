...
<pre>php8.0-fpm php8.0-cli php8.0-common</pre>
<pre>php8.0-mbstring php8.0-gd php8.0-intl php8.0-xml php8.0-mysql php8.0-zip php8.0-curl php8.0-bz2 php8.0-soap php8.0-xmlrpc php8.0-gettext php-curl</pre>
<pre>libwebp-dev php-yaml php-ssh2</pre>
