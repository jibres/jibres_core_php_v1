...
<div class="f justify-center">
  <div class="c4 s12">
    <div class="cbox">
      ...
      <a href="<?php echo \dash\url::kingdom(); ?>/enter/verify?referer=<?php echo \dash\url::pwd(); ?>" target="_blank" data-direct class="msg block warn txtB txtC mT10"><?php echo T_("To make your appkey you must verify your mobile"); ?></a>
      <?php }else{ ?>
