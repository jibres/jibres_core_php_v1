  <section id='jibresPageTitle' class="color2">
   <div class="avand">
   	<h2><?php echo T_('Access all the information you need to build on our API.') ?></h2>
   	<p><?php echo T_('Our documentation for API, OAuth, and metadata is clearly organized and easy to use.') ?></p>
   </div>
  </section>
			...
			<div class="c6 s12 pA10">
				<div class="box">
					...
					<div class="body">
						...
						<a class="btn2 blue" href="https://documenter.getpostman.com/view/1511811/TVt2e4vB" target="_blank" data-direct><?php echo T_("View API v1 Documentations"); ?></a>
					</div>
				</div>
			</div>

			<div class="c6 s12 pA10 hide">
				<div class="box">
