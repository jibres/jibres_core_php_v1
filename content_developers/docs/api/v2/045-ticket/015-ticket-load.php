...
<div id="ticket-load-detail">
  <div class="cbox" id='ticket-load'>
    <div class="msg url ltr txtL">
      ...
      <span><?php echo \dash\data::CustomerApiURL(); ?><b>ticket/detail?id={TICKET}</b></span>
    </div>
...
<pre>
curl -X GET <?php echo \dash\data::CustomerApiURL(); ?>ticket/detail?id={TICKET} -H 'appkey: <?php echo \dash\data::myAppKey(); ?>' -H 'apikey: <?php echo \dash\data::myApiKey(); ?>'
</pre>
