<div class="box">
  <header>
    <h2 class="f" data-kerkere='#domain-autorenew' data-kerkere-icon='open'>
      ...
      <span class="c"><?php echo T_("Enable or disable domain autorenew"); ?></span>
    </h2>
  </header>
...
<pre>
curl <?php if(\dash\url::isLocal()) { echo '-k '; } ?>-X PATCH '<?php echo \dash\data::IRNICApiURL(); ?>domain?id=S' \
-H 'appkey: <?php echo \dash\data::myAppKey(); ?>' \
-H 'apikey: <?php echo \dash\data::myApiKey(); ?>' \
-H 'Content-Type: application/json' \
--data-raw '{"autorenew": true}'
</pre>
