...
<div class="cbox fs12">
  <form method="get" action='<?php echo \dash\url::here(); ?>/customer'>
    <div class="input">
      <input type="search" name="q" placeholder='<?php echo T_("Search in customers"); ?>' id="q" value="<?php echo \dash\request::get('q'); ?>" <?php \dash\layout\autofocus::html() ?>  data-pass='submit' autocomplete='off'>
