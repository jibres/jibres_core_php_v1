...
<div class="cbox fs12">
  <form method="get" action='<?php echo \dash\url::here(); ?>/shop'>
    <div class="input">
      <input type="search" name="q" placeholder='<?php echo T_("Search in shops"); ?>' id="q" value="<?php echo \dash\validate::search_string() ?>" <?php \dash\layout\autofocus::html() ?>  data-pass='submit' autocomplete='off'>
