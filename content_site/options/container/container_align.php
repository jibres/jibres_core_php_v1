...
trait container_align
{
	...
	private static function enum()
	{
		...
		$enum[] = ['key' => 'start', 'title' => T_("Top"), 'icon' => \dash\utility\icon::svg('SortAscending'),  'class' => 'items-start' ];
		$enum[] = ['key' => 'center','title' => T_("Center"), 'icon' => \dash\utility\icon::svg('BuyButtonButtonLayout'),  'class' => 'items-center'];
		$enum[] = ['key' => 'end', 	 'title' => T_("End"), 'icon' => \dash\utility\icon::svg('SortDescending'), 'class' => 'items-end'];
