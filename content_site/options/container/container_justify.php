...
trait container_justify
{
	...
	{
		$data = \dash\validate::enum($_data, true, ['enum' => array_column(self::enum(), 'key'), 'field_title' => T_('Justify')]);
	...
	public static function admin_html()
	{
		...
		$default = \content_site\section\view::get_current_index_detail('container_justify');
