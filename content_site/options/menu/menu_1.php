...
class menu_1
{
	...
	{
		$default = \content_site\section\view::get_current_index_detail('menu_1');

		$header_menu_key = 'opt_menu_1';
		$title           = T_("Menu");
		...
		$html .= '<form method="post" data-patch>';
		{
			...
			if($menu)
			{
				...
				$html .= '<select name="'. $header_menu_key. '" id="idmenu'. $header_menu_key. '" class="select22" data-placeholder="'. T_("Choose one menu"). '">';
				{
					if($default)
					{
