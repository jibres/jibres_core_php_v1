...
class layout
{
  ...
  <div class="container px-5 py-24 mx-auto flex sm:items-center lg:items-start sm:flex-row sm:flex-nowrap flex-wrap flex-col">
    <div class="w-64 flex-shrink-0 sm:mx-0 mx-auto text-center sm:text-left sm:mt-0 mt-10">
      <a class="flex title-font font-medium items-center sm:justify-start justify-center text-gray-900">
    ...
    <div class="flex-grow flex flex-wrap sm:pr-20 -mb-10 sm:text-left text-center order-first">
