  ...
  <ul>
    <li>
      <a class="item f" href="<?php echo $header_link ?>">
        <img class="bg-blue-50 hover:bg-gray-200 p-2.5" src="<?php echo \dash\utility\icon::url('Header'); ?>">
      ...
      ?>
        <li>
          <a title="<?php echo $myTitle ?>" class="item f <?php if(a($value, 'status_preview') === 'hidden'){ echo 'opacity-30';} ?>" href="<?php echo \dash\url::here(). '/section/'. a($value, 'section'). \dash\request::full_get(['sid' => a($value, 'id')]); ?>">
            ...
            <img class="bg-blue-50 hover:bg-gray-200 p-2.5" src="<?php echo a($value, 'preview', 'icon') ?>">
  ...
  <ul>
    <li>
      <a class="item f" href="<?php echo \dash\url::here(). '/section'. \dash\request::full_get(['folder' => 'body']); ?>">
        <img class="bg-blue-50 hover:bg-gray-200 p-2.5" src="<?php echo \dash\utility\icon::url('add'); ?>">
  ...
  <ul>
    <li>
      <a class="item f" href="<?php echo $footer_link ?>">
        <img class="bg-blue-50 hover:bg-gray-200 p-2.5" src="<?php echo \dash\utility\icon::url('Footer'); ?>">
...
<?php
  ...
  $html .= '<div class="flex flex-wrap mt-10">';
  {
    ...
    {
      $html .= '<a class="btn-light btn-sm" href="'.\dash\url::this(). '/settings'. \dash\request::full_get().'">';
      {
        $html .= '<img class="w-6 inline-block" src="'. \dash\utility\icon::url('Settings', 'minor'). '" alt="Setting">';
        $html .= '<span class="inline-block align-middle px-2">'. T_("Page setting").'</span>';
      }
      $html .= '</a>';
    }
    // $html .= '</div>';
    ...
    // $html .= "<div class='cauto os pLa5'>";
    {
      ...
      $html .= "<a href='$model_url' class='btn-light btn-sm'  title='". T_("Change Background") ."'>";
      $html .= '<img class="w-6 inline-block" src="'. \dash\utility\icon::url('Colors'). '" alt="page background">';
        $html .= '<span class="inline-block align-middle px-2">'. T_("Personalize").'</span>';
      $html .= '</a>';
    }
    $html .= '</div>';
