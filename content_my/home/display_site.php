...
<div class="f">
    <div class="c9 s12 pRa10">
        ...
        <section class="row">
            ...
            <div class="c-xs-0 c">
                <a href="<?php echo \dash\url::kingdom() ?>/account/billing"
                    class="stat x70 <?php if(a($myData, 'budget')>0) echo " green"; ?>">
        ...
        <div class="alert-info text-center text-sm">
        ...
        <div class="f">
            <div class="c6 s12 pRa10">
                <h5 class="font-bold mb-2"><?php echo T_("Business that you are owner"); ?></h5>
                <?php
...
?>
                <li>
                    <a class="f" href="<?php echo a($value, 'url'); ?>/a" data-direct>
                        <img src="<?php echo \dash\fit::img(a($value, 'logo')); ?>"
                            alt="<?php echo a($value, 'title'); ?>">
...
?>
            ...
            <div class="c6 s12">
                <h5 class="font-bold mb-2"><?php echo T_("Business that you are staff"); ?></h5>
                <nav class="items">
                    <ul>
                        <?php
...
if($listStore_staff && is_array($listStore_staff))
{
 foreach ($listStore_staff as $key => $value) {?>
                        ...
                        <?php } else { //endif ?>
                        <li>
                            <div class="msg mb-0 leading-7"><?php echo T_("You are not staff yet!"); ?></div>
                        </li>
                        <?php }//endif ?>
                    </ul>
                </nav>
    ...
    <div class="c3 s12">
        ...
        <section class="circularChartBox">
            ...
            <p><?php echo T_("Badges are little bits of digital flair that you earn for your simple actions on Jibres"); ?>
            </p>
        </section>
        ...
        <nav class="items long">
            <ul>
                <li>
                    <a class="f"
                        href="<?php if(a($myData, 'complete_profile', 'mobile')) { echo \dash\url::kingdom(). '/account/my'; }else{ echo \dash\url::kingdom(). '/enter/verify';}?>">
                        <div class="key"><?php echo T_('Verify Mobile');?></div>
                        <div
                            class="go <?php if(a($myData, 'complete_profile', 'mobile')){echo 'check ok';}else{echo 'times nok';} ?>">
                        </div>
                    </a>
                </li>
                <li>
                    <a class="f" href="<?php echo \dash\url::kingdom();?>/account/my/email">
                        ...
                        <div
                            class="go <?php if(a($myData, 'complete_profile', 'email')){echo 'check ok';}else{echo 'times nok';} ?>">
                        </div>
                    </a>
                </li>
                <li>
                    <a class="f" href="<?php echo \dash\url::kingdom();?>/account/my/username">
                        ...
                        <div
                            class="go <?php if(a($myData, 'complete_profile', 'username')){echo 'check ok';}else{echo 'times nok';} ?>">
                        </div>
                    </a>
                </li>
                <li>
                    <a class="f" href="<?php echo \dash\url::kingdom();?>/account/my/profile">
                        ...
                        <div
                            class="go <?php if(a($myData, 'complete_profile', 'birthday')){echo 'check ok';}else{echo 'times nok';} ?>">
                        </div>
                    </a>
                </li>
                <li>
                    <a class="f" href="<?php echo \dash\url::kingdom();?>/account/my/avatar">
                        ...
                        <div
                            class="go <?php if(a($myData, 'complete_profile', 'avatar')){echo 'check ok';}else{echo 'times nok';} ?>">
                        </div>
                    </a>
                </li>
            </ul>
            ...
            <ul>
                <li>
                    <a class="f" href="<?php echo \dash\url::kingdom();?>/account/billing">
                        ...
                        <div
                            class="go <?php if(a($myData, 'complete_profile', 'firstpay')){echo 'check ok';}else{echo 'times nok';} ?>">
                        </div>
                    </a>
                </li>
            </ul>
        ...
        <nav class="items long">
            <ul>
                <li>
                    <a class="f"
                        href="<?php if(a($myData, 'complete_profile', 'firststore')){ echo \dash\url::here(). '/business/'; }else{echo \dash\url::here(). '/business/start'; } ?>">
                        <div class="key"><?php echo T_('Add Your First Business');?></div>
                        <div
                            class="go <?php if(a($myData, 'complete_profile', 'firststore')){echo 'check ok';}else{echo 'times nok';} ?>">
                        </div>
                    </a>
                </li>
                <li>
                    <a class="f">
                        ...
                        <div
                            class="go <?php if(a($myData, 'complete_profile', 'firstproduct')){echo 'check ok';}else{echo 'times nok';} ?>">
                        </div>
                    </a>
                </li>
                <li>
                    <a class="f">
                        ...
                        <div
                            class="go <?php if(a($myData, 'complete_profile', 'firstorder')){echo 'check ok';}else{echo 'times nok';} ?>">
                        </div>
                    </a>
                </li>
            </ul>
        ...
        <nav class="items long">
            <ul>
                <li>
                    <a class="f"
                        href="<?php if(a($myData, 'complete_profile', 'firstdomain')){ echo \dash\url::here(). '/domain/search?list=mydomain'; }else{ echo \dash\url::here(). '/domain/buy'; } ?>">
                        <div class="key"><?php echo T_('Buy Your First Domain');?></div>
                        <div
                            class="go <?php if(a($myData, 'complete_profile', 'firstdomain')){echo 'check ok';}else{echo 'times nok';} ?>">
                        </div>
                    </a>
                </li>
            </ul>
