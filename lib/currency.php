...
class currency {
	...
	[
		...
		'IRHT' 	=> ['symbol' => 'IRHT',	'decimal_digits' => 0, 'code' => 'IRHT','symbol_native' => 'هزار تومان','name' => 'Thousand Toman', 'group' => 'iran', 'exchange_rial' => 10000],
		'IRHR' 	=> ['symbol' => 'IRHR',	'decimal_digits' => 0, 'code' => 'IRHR','symbol_native' => 'هزار ریال','name' => 'Thousand Rial', 'group' => 'iran', 'exchange_rial' => 1000],
	...
	{
		$new_list = [];
		foreach (self::$currencylist as $key => $value)
		{
			$new_list[$key] = T_(a($value, 'name')). ' - '. a($value, 'symbol_native');
		}
	...
	{
		if(isset(self::$currencylist[$_key]))
		{
	...
	private static function fakeTrans()
	{
		// echo T_('Toman');
		// echo T_('Rial');
		// echo T_('US Dollar');
