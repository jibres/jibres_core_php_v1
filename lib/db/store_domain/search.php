...
class search
{
	...
	public static function list($_and, $_or, $_order_sort = null, $_meta = [])
	{
		...
		$pagination_query = "SELECT COUNT(*) AS `count` FROM store_domain $q[where] ";
		...
		$query = "SELECT store_domain.*,store_data.title,store_data.logo FROM store_domain LEFT JOIN store_data ON store_data.id = store_domain.store_id $q[where] $q[order] $limit ";
