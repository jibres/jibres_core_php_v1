...
class unit
{
	...
	public static function get_count_unit($_unit_id)
	{
	...
	public static function update_all_product_unit_title($_unit_id, $_new_unit_title)
	{
	...
	public static function update_all_product_by_unit($_new_unit_id, $_new_unit_title, $_old_unit_id)
	{
