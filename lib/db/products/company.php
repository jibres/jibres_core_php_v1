...
class company
{
	...
	public static function get_count_company($_company_id)
	{
		$query  = "SELECT COUNT(*) AS `count` FROM products WHERE products.company_id = $_company_id";
		$result = \dash\db::get($query, 'count', true);
		return $result;
	}


	public static function update_all_product_company_title($_company_id, $_new_company_title)
	{
	...
	public static function update_all_product_by_company($_new_company_id, $_new_company_title, $_old_company_id)
	{
