...
class search
{
	...
	{
		$q = \dash\pdo\query_template::ready_pdo_query_args($_and, $_or, $_order_sort, $_meta);
		...
		$limit = \dash\db\mysql\tools\pagination::pagination_query_pdo($pagination_query, $_param);
