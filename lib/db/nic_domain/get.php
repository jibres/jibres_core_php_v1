...
class get
{
	...
	{
		$query  = "SELECT domain.*, dns.ns1, dns.ns2, dns.ns3, dns.ns4, dns.ip1, dns.ip2, dns.ip3, dns.ip4 FROM domain LEFT JOIN dns ON dns.id = domain.dns WHERE domain.id = $_id AND domain.user_id = $_user_id LIMIT 1";
