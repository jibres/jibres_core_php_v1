...
class get
{
	...
	{
		$query = "SELECT * FROM form_filter WHERE form_filter.form_id = $_form_id AND (form_filter.status IS NULL OR form_filter.status != 'deleted') ORDER BY IFNULL(form_filter.sort, form_filter.id) ASC ";
