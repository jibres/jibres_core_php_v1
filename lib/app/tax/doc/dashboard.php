...
class dashboard
{
	...
	public static function detail()
	{
		...
		$total_income = \lib\app\tax\doc\search::list(null, ['template' => 'income', 'quarterlyreport' => 'yes', 'year_id' => $default_year_id, 'summary_mode' => true, 'status' => 'lock']);
		$total_cost   = \lib\app\tax\doc\search::list(null, ['template' => 'costasset', 'quarterlyreport' => 'yes', 'year_id' => $default_year_id, 'summary_mode' => true, 'status' => 'lock']);
