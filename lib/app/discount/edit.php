...
class edit
{
	...
	public static function edit($_args, $_id)
	{
		...
		if(isset($data['title']) && $data['title'])
		{
			...
			$check_duplicate_title = \lib\db\discount\get::check_duplicate_title($check_duplicate);
		...
		else
		{
			...
			if(isset($data['class']))
			{
				\lib\db\discount\update::update_class($data['class'], $load['id']);
			}

			// if(isset($data['topic']))
			// {
			// 	\lib\db\discount\update::update_topic($data['topic'], $load['id']);
			// }
