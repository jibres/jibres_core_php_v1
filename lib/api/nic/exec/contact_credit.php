...
class contact_credit
{
	...
	private static function analyze_contact_credit($_args)
	{
		...
		// $object_result = file_get_contents('/home/reza/projects/jibres/lib/api/nic/exec/contact_credit_sample_response.xml');
	...
	{
		$addr = root. 'lib/api/nic/exec/samples/contact_credit.xml';
