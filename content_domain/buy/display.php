...
<div class="f justify-center">
	<div class="c6 m8 s12">
		...
		<?php }else{ ?>
			...
			<form method="post" autocomplete="off" class="mB20" action="<?php echo \dash\url::here(); ?>/buy">
			...
			<?php if(\dash\data::checkResult()) {?>
				...
				<div class="msg success2"><?php echo T_("Domain is available"); ?>
					<span class="floatL">
						<a class="btn success" href="<?php echo \dash\url::here(); ?>/buy/<?php echo \dash\url::module(); ?>"><?php echo T_("Buy"); ?></a>
					</span>
				</div>
				...
				<div class="msg warn2"><?php echo T_("Domain is occupied"); ?>
					<span class="floatL">
						<a class="btn warn" target="_blank" href="<?php echo \dash\url::kingdom(); ?>/whois/<?php echo \dash\url::module(); ?>"><?php echo T_("Whois"); ?></a>
					</span>
				</div>
		...
		<?php if(\dash\data::checkResult()) {?>
			...
			<?php if(\dash\data::checkResult_available()) {?>
				...
				<label for="irnicid"><?php echo T_("IRNIC contact"); ?> <small><a href="<?php echo \dash\url::here(); ?>/contact/add?type=new"><?php echo T_("Create new IRNIC contact"); ?></a></small></label>
			...
			<div class="txtRa">
				<a href="<?php echo \dash\url::this(); ?>" class="btn secondary"><?php echo T_("Never mind"); ?></a>
			</div>
			<?php } //endif ?>

		<?php }elseif(\dash\url::child()) {?>
