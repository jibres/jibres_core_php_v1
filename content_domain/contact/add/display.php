	...
	<div class="c6 m8 s12">
		<div class="f">
			<div class="c s12">
				...
				<a class="dcard x1 <?php if(\dash\request::get('type') === 'old' || !\dash\request::get('type')) { echo 'active'; } ?>" href='<?php echo \dash\url::that(); ?>?type=old'>
			...
			<div class="c s12">
				...
				<a class="dcard x1 <?php if(\dash\request::get('type') === 'new' ) { echo 'active'; } ?>" href='<?php echo \dash\url::that(); ?>?type=new'>
