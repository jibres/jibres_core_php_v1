...
<div class="f">
  <div class="c s12">
  	...
  	<a class="dcard x1" href='<?php echo \dash\url::here(); ?>/contact'>
  ...
  <div class="c s12">
  	...
  	<a class="dcard x1" href='<?php echo \dash\url::here(); ?>/buy'>
	 <div class="statistic blue">
  ...
  <div class="c s12">
	...
	<a class="dcard x1" href='<?php echo \dash\url::here(); ?>/transfer'>
  ...
  <div class="c s12">
  	...
  	<a class="dcard x1" href='<?php echo \dash\url::here(); ?>/dns'>
	 <div class="statistic blue">
	...
	<table class="tbl1 v4">
		...
		<tbody>
			...
			<tr>
				...
				<td class="collapsing"><a href="<?php echo \dash\url::this(); ?>/setting/<?php echo @$value['name']; ?>" class="btn info2"><?php echo T_("Manage domain"); ?></a></td>
			</tr>
			<?php } //endfor ?>
		</tbody>
	</table>
...
<p class="f fs14 msg warn2">
  ...
  <a class="cauto" href="<?php echo \dash\url::here(); ?>"><?php echo T_("Clear filters"); ?></a>
</p>
...
<div class="cbox">
	...
	<div class="msg success2"><?php echo T_("Domain is available"); ?>
		...
		<span class="floatL">
			<a class="btn success" href="<?php echo \dash\url::here(); ?>/buy/<?php echo \dash\data::myDomain(); ?>"><?php echo T_("Buy"); ?></a>
		</span>
	</div>
...
<div class="fs14 msg info2 pTB20">
  <p><?php echo T_("Hi!"); ?></p>
  <p><a href="<?php echo \dash\url::here(); ?>/buy"><?php echo T_("Try to start with add new domain!"); ?></a></p>
