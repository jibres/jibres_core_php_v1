...
<div class="f">
    ...
    <div class="c4 s12 text-xl p-2">
        <a class="dcard x1 text-red-800"
            href='<?php echo \dash\url::this(); ?>?folder=<?php echo a($value, 'name'); ?>'>
            <div class="statistic bg-white">
...
<table class="tbl1 v3 fs12">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="ltr">
                <a
                    href='<?php echo \dash\url::this(); ?>?folder=<?php echo \dash\request::get('folder'); ?>&file=<?php echo a($value, 'name'); ?>'>
            ...
            <td>
                <a target="_blank" data-direct class="btn-link"
                    href='<?php echo \dash\url::this() . \dash\request::full_get(['file' => a($value, 'name') ]); ?>'>Download</a>
                <?php if(a($value, 'new')) {?>
                <div class="btn-link"></div>
                <a data-direct class="btn-link"
                    href='<?php echo \dash\url::this() . \dash\request::full_get(['file' => a($value, 'name'), 'clear' => 1 ]); ?>'>Clean</a>
                <?php } //endif ?>
