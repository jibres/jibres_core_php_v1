...
<div class="row">
	<div class="c-xs-12 c-md-6">
		  <nav class="items">
		     <ul>
		       <li><a class="f" href="<?php echo \dash\url::here();?>/profile/notification"><div class="key"><?php echo T_('Notifications');?></div><div class="go"></div></a></li>
		       ...
		       <li><a class="f" href="<?php echo \dash\url::here();?>/profile/order"><div class="key"><?php echo T_('My orders');?></div><div class="go"></div></a></li>
