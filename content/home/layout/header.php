...
if (\dash\user::id())
{
 ...
 {
  echo '     <a href="'. \dash\url::sitelang(). '/a" data-direct>'. T_("Store Panel"). '</a>'. "\n";
 }
 else
 {
  echo '     <a href="'. \dash\url::sitelang(). '/store" data-direct>'. T_("Admin Panel"). '</a>'. "\n";
 }

}
else
{
 echo '     <a href="'. \dash\url::sitelang(). '/enter" data-direct>'. T_("Enter"). '</a>'. "\n";
 echo '     <a href="'. \dash\url::sitelang(). '/enter/signup" data-direct>'. T_("SIGN UP"). '</a>'. "\n";
}
?>
    </nav>
   </div>
