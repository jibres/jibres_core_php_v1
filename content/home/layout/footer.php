...
<section id="jibresCertificates">
  <div class="avand-md">
    ...
    <div class="f">
      ...
      <div class="c3 s6 ph4"><a tabindex='-1' target="_blank" rel='nofollow noopener' href="<?php echo \dash\url::kingdom() ?>/certificates/irnic"><img loading="lazy" src="<?php echo \dash\url::cdn(); ?>/img/certificates/200px/jibres-certificate-irnic-200px.png" srcset="<?php echo \dash\url::cdn(); ?>/img/certificates/jibres-certificate-irnic.png  2x" alt='جیبرس نماینده رسمی ایرنیک'></a></div>
      <div class="c3 s6 ph4"><a tabindex='-1' target="_blank" rel='nofollow noopener' href="<?php echo \dash\url::kingdom() ?>/certificates/enamad"><img loading="lazy" src="<?php echo \dash\url::cdn(); ?>/img/certificates/200px/jibres-certificate-enamad-200px.png" srcset="<?php echo \dash\url::cdn(); ?>/img/certificates/jibres-certificate-enamad.png  2x" alt='جیبرس دارای نماد اعتماد الکترونیکی'></a></div>
      <div class="c3 s6 ph4"><a tabindex='-1' target="_blank" rel='nofollow noopener' href="<?php echo \dash\url::kingdom() ?>/certificates/nsr"><img loading="lazy" src="<?php echo \dash\url::cdn(); ?>/img/certificates/200px/jibres-certificate-nsr-200px.png" srcset="<?php echo \dash\url::cdn(); ?>/img/certificates/jibres-certificate-nsr.png  2x" alt='جیبرس عضو رسمی سازمان نظام صنفی رایانه'></a></div>
      <div class="c3 s6 ph4"><a tabindex='-1' href="<?php echo \dash\url::kingdom() ?>/brand"><img loading="lazy" src="<?php echo \dash\url::cdn(); ?>/img/certificates/200px/jibres-certificate-brand-200px.png" srcset="<?php echo \dash\url::cdn(); ?>/img/certificates/jibres-certificate-brand.png  2x" alt='جیبرس برند ثبت شده'></a></div>
