...
<section id="jibresCertificates">
  <div class="avand-md">
    ...
    <div class="f">
      ...
      <div class="c3 s6 ph4"><a tabindex='-1'><img src="<?php echo \dash\url::cdn(); ?>/img/certificates/jibres-certificate-bmn.png" alt='بنیاد ملی نخبگان'></a></div>
      ...
      <div class="c3 s6 ph4"><a tabindex='-1'><img id="samandehiCert" src="<?php echo \dash\url::cdn(); ?>/img/certificates/jibres-certificate-samandehi.png" alt='جیبرس دارای نماد ساماندهی' data-open="https://logo.samandehi.ir/Verify.aspx?id=162977&p=rfthgvkauiwkpfvljyoejyoe"></a></div>
      <div class="c3 s6 ph4"><a tabindex='-1'><img src="<?php echo \dash\url::cdn(); ?>/img/certificates/jibres-certificate-chambertrust.png" alt='جیبرس عضو اتاق بازرگانی ایران'></a></div>
    </div>
  </div>
</section>
<?php } ?>
