...
<section id="jibresCertificates">
  <div class="avand-md">
    ...
    <div class="f">
      <div class="c3 s6 ph4"><a tabindex='-1' target="_blank" rel='nofollow noopener' href="<?php echo \dash\url::kingdom() ?>/certificates/daneshbonyan"><img src="<?php echo \dash\url::cdn(); ?>/img/certificates/200px/jibres-certificate-daneshbonyan-200px.png" srcset="<?php echo \dash\url::cdn(); ?>/img/certificates/jibres-certificate-daneshbonyan.png 2x" alt='دانش‌بنیان - جیبرس'></a></div>
      <!-- <div class="c3 s6 ph4"><a tabindex='-1' target="_blank" rel='nofollow noopener' href="<?php echo \dash\url::kingdom() ?>/certificates/shaparak"><img src="<?php echo \dash\url::cdn(); ?>/img/certificates/200px/jibres-certificate-bank-markazi-200px.png" srcset="<?php echo \dash\url::cdn(); ?>/img/certificates/jibres-certificate-bank-markazi.png  2x" alt='جیبرس پرداخت یار رسمی بانک مرکزی '></a></div> -->
      ...
      <div class="c3 s6 ph4"><a tabindex='-1'><img src="<?php echo \dash\url::cdn(); ?>/img/certificates/200px/jibres-certificate-bmn-200px.png" srcset="<?php echo \dash\url::cdn(); ?>/img/certificates/jibres-certificate-bmn.png  2x" alt='بنیاد ملی نخبگان'></a></div>
      <div class="c3 s6 ph4"><a tabindex='-1' target="_blank" rel='nofollow noopener' href="<?php echo \dash\url::kingdom() ?>/certificates/irnic"><img src="<?php echo \dash\url::cdn(); ?>/img/certificates/200px/jibres-certificate-irnic-200px.png" srcset="<?php echo \dash\url::cdn(); ?>/img/certificates/jibres-certificate-irnic.png  2x" alt='جیبرس نماینده رسمی ایرنیک'></a></div>
      <div class="c3 s6 ph4"><a tabindex='-1' target="_blank" rel='nofollow noopener' href="<?php echo \dash\url::kingdom() ?>/certificates/enamad"><img src="<?php echo \dash\url::cdn(); ?>/img/certificates/200px/jibres-certificate-enamad-200px.png" srcset="<?php echo \dash\url::cdn(); ?>/img/certificates/jibres-certificate-enamad.png  2x" alt='جیبرس دارای نماد اعتماد الکترونیکی'></a></div>
      <div class="c3 s6 ph4"><a tabindex='-1' target="_blank" rel='nofollow noopener' href="<?php echo \dash\url::kingdom() ?>/certificates/nsr"><img src="<?php echo \dash\url::cdn(); ?>/img/certificates/200px/jibres-certificate-nsr-200px.png" srcset="<?php echo \dash\url::cdn(); ?>/img/certificates/jibres-certificate-nsr.png  2x" alt='جیبرس عضو رسمی سازمان نظام صنفی رایانه'></a></div>
      <div class="c3 s6 ph4"><a tabindex='-1' href="<?php echo \dash\url::kingdom() ?>/brand"><img src="<?php echo \dash\url::cdn(); ?>/img/certificates/200px/jibres-certificate-brand-200px.png" srcset="<?php echo \dash\url::cdn(); ?>/img/certificates/jibres-certificate-brand.png  2x" alt='جیبرس برند ثبت شده'></a></div>
      ...
      <div class="c3 s6 ph4"><a tabindex='-1'><img src="<?php echo \dash\url::cdn(); ?>/img/certificates/200px/jibres-certificate-chambertrust-200px.png" srcset="<?php echo \dash\url::cdn(); ?>/img/certificates/jibres-certificate-chambertrust.png  2x" alt='جیبرس عضو اتاق بازرگانی ایران'></a></div>
    </div>
  </div>
</section>
<?php } ?>
