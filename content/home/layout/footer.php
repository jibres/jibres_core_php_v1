...
<section id="jibresCertificates">
  <div class="fit-md">
    ...
    <div class="f">
      <div class="c3 s6"><a tabindex='-1' target="_blank" rel='nofollow noopener' href="https://pub.daneshbonyan.ir/"><img data-src="<?php echo \dash\url::cdn(); ?>/img/certificates/jibres-certificate-daneshbonyan.png" alt='دانش‌بنیان - جیبرس'></a></div>
      <!-- <div class="c3 s6"><a tabindex='-1' target="_blank" rel='nofollow noopener' href="https://shaparak.com/tips/%D8%B4%D8%B1%DA%A9%D8%AA-%D9%87%D8%A7%DB%8C-%D9%BE%D8%B1%D8%AF%D8%A7%D8%AE%D8%AA-%DB%8C%D8%A7%D8%B1"><img data-src="<?php echo \dash\url::cdn(); ?>/img/certificates/jibres-certificate-bank-markazi.png" alt='جیبرس پرداخت یار رسمی بانک مرکزی '></a></div> -->
      <!-- <div class="c3 s6"><a tabindex='-1' target="_blank" rel='nofollow noopener' href="https://shaparak.com/tips/%D8%B4%D8%B1%DA%A9%D8%AA-%D9%87%D8%A7%DB%8C-%D9%BE%D8%B1%D8%AF%D8%A7%D8%AE%D8%AA-%DB%8C%D8%A7%D8%B1"><img data-src="<?php echo \dash\url::cdn(); ?>/img/certificates/jibres-certificate-shaparak.png" alt='جیبرس دارای مجوز ارائه درگاه پرداخت اینترنتی'></a></div> -->
      <div class="c3 s6"><a tabindex='-1' target="_blank" href="<?php echo \dash\url::kingdom(); ?>/certificates"><img data-src="<?php echo \dash\url::cdn(); ?>/img/certificates/jibres-certificate-bmn.png" alt='بنیاد ملی نخبگان'></a></div>
      <div class="c3 s6"><a tabindex='-1' target="_blank" rel='nofollow noopener' href="https://www.nic.ir/List_of_Resellers"><img data-src="<?php echo \dash\url::cdn(); ?>/img/certificates/jibres-certificate-irnic.png" alt='جیبرس نماینده رسمی ایرنیک'></a></div>
      <div class="c3 s6"><a tabindex='-1' target="_blank" rel='nofollow noopener' href="https://trustseal.enamad.ir/?id=118387&Code=2iL8ULp5lVA5oSXMRiLp"><img data-src="<?php echo \dash\url::cdn(); ?>/img/certificates/jibres-certificate-enamad.png" alt='جیبرس دارای نماد اعتماد الکترونیکی'></a></div>
      ...
      <!-- <div class="c3 s6"><a tabindex='-1' target="_blank" rel='nofollow noopener' href=""><img data-src="<?php echo \dash\url::cdn(); ?>/img/certificates/jibres-certificate-brand.png" alt='جیبرس برند ثبت شده'></a></div> -->
      ...
      <div class="c3 s6"><a tabindex='-1' target="_blank" href="<?php echo \dash\url::kingdom(); ?>/certificates"><img data-src="<?php echo \dash\url::cdn(); ?>/img/certificates/jibres-certificate-chambertrust.png" alt='جیبرس عضو اتاق بازرگانی ایران'></a></div>
    </div>
  </div>
</section>
<?php } ?>
