...
<section id="jibresCertificates">
  <div class="avand-md">
    ...
    <div class="f">
      ...
      <div class="c3 s6 ph4"><a tabindex='-1' href="<?php echo \dash\url::kingdom() ?>/certificates"><img src="<?php echo \dash\url::cdn(); ?>/img/certificates/jibres-certificate-brand.png" alt='جیبرس برند ثبت شده'></a></div>

      <div class="c3 s6 ph4"><a tabindex='-1' href="<?php echo \dash\url::kingdom(); ?>/certificates"><img src="<?php echo \dash\url::cdn(); ?>/img/certificates/jibres-certificate-samandehi.png" alt='جیبرس دارای نماد ساماندهی' ></a></div>
