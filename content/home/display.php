  ...
  <div class="avand">
    ...
    <div class="f txtC">
      <div class="c s12 pA10">
          <div class="fs50"><?php echo \dash\utility\convert::to_en_number(\dash\fit::stats(\dash\data::homepagenumber_product(), true)) ?>+</div>
          <div class="font-14"><?php echo T_('Products'); ?></div>
      </div>
      <div class="c s12 pA10">
          <div class="fs50"><?php echo \dash\utility\convert::to_en_number(\dash\fit::stats(\dash\data::homepagenumber_factor(), true)) ?>+</div>
          <div class="font-14"><?php echo T_('Factor'); ?></div>
      </div>
      <div class="c s12 pA10">
          <div class="fs40"><?php echo \dash\utility\convert::to_en_number(\dash\fit::stats(\dash\data::homepagenumber_sum_factor(), true)) ?>+</div>
