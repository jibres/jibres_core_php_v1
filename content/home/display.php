...
<section class="jibresBanner" id='saleChannels'>
 <div class="fit">
  <div class="f">
    <div class="c3 m6 s12">
      <div class="item">
        <img data-src="<?php echo \dash\url::cdn(); ?>/img/homepage/jibres-saleChannels-step1.png" alt="<?php echo T_('Jibres'); ?>">
    ...
    <div class="c3 m6 s12">
      <div class="item">
        <img data-src="<?php echo \dash\url::cdn(); ?>/img/homepage/jibres-saleChannels-step2.png" alt='<?php echo T_('Jibres'); ?>'>
    ...
    <div class="c3 m6 s12">
      <div class="item">
        <img data-src="<?php echo \dash\url::cdn(); ?>/img/homepage/jibres-saleChannels-step3.png" alt='<?php echo T_('Jibres'); ?>'>
    ...
    <div class="c3 m6 s12">
      <div class="item">
        <img data-src="<?php echo \dash\url::cdn(); ?>/img/homepage/jibres-saleChannels-step4.png" alt='<?php echo T_('Jibres'); ?>'>
