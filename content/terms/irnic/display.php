...
<?php if (\dash\language::current() === 'fa') { ?>
 <div class="avand-lg impact">
  ...
  <p class="text-center font-bold">ایرنیک — مرکز ثبت دامنه نقطه-آی‌آر (‎.ir) <br />متن توافقنامه ثبت دامنه تحت &lrm;.ir و .ایران.ir</p>
  ...
  <ul>
   ...
   <li class="mT">متقاضی با امضای موافقتنامه ثبت و قبول مفاد مندرج در ضمائم آن به ویژه قبول می‌کند که</li>
   <li>
...
<?php } ?>
 ...
 <div class="avand-lg impact ltr">
  ...
  <p class="text-center font-bold"> IRNIC - Dot-IR (.ir) ccTLD Registry<br/>Text of agreement for registering domains under .ir and &lrm;.ایران.ir </p>
