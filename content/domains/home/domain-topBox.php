   ...
   <div class="f">
    <div class="c4 s12 mb-2 pRa10">
     <div class="item f f-column">
      ...
      <a class="btn-light" href="<?php echo \dash\url::kingdom() ?>/domains/search"><?php echo T_('Find my Domain'); ?></a>
     </div>
    </div>
    <div class="c4 s12 mb-2 pRa10">
     <div class="item f f-column">
      ...
      <a class="btn-light" href="<?php echo \dash\url::kingdom() ?>/my/domain/transfer"><?php echo T_('Transfer Now'); ?></a>
     </div>
    </div>
    <div class="c4 s12 mb-2">
     <div class="item f f-column">
      ...
      <a class="btn-light" href="<?php echo \dash\url::kingdom() ?>/my/domain/renew"><?php echo T_('Renew Domain'); ?></a>
     </div>
    </div>
   </div>
  </section>
  ...
  <section>
   <div class="row">
    <div class="c-sm-6 s-xs-12 pRa20">
     <h3 class="font-bold text-lg"><?php echo T_('Find your winning domain'); ?></h3>
    ...
    <div class="c-sm-6 c-xs-12">
     <h3 class="font-bold text-lg"><?php echo T_('How to find a good domain name?'); ?></h3>
