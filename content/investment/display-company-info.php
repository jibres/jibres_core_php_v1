 <div class="avand-md impact font-16">
  ...
  <table class="tbl1 v5 mB0-f">
   <tr>
    ...
    <td class="font-bold"><?php echo T_("Jibres"); ?></td>
   </tr>
   <tr>
    <td class="txtRa"><?php echo T_("Company Name"); ?></td>
    <td class="font-bold"><?php echo T_("Rooz Andish Kavir Peyma Ltd"); ?></td>
   </tr>
   <tr>
    <td class="txtRa"><?php echo T_("Company Establishment Date"); ?></td>
    <td class="font-bold ltr"><?php echo \dash\fit::date("2015-06-22"); ?></td>
   </tr>
   <tr>
    <td class="txtRa"><?php echo T_("Company Registration Number"); ?></td>
    <td class="font-bold ltr"><?php echo \dash\fit::number(13552, false); ?></td>
   </tr>
   <tr>
    <td class="txtRa"><?php echo T_("Company Identification Number"); ?></td>
    <td class="font-bold ltr"><?php echo \dash\fit::number(14005025553, false); ?></td>
   </tr>
<?php if(\dash\url::isLocal()) { ?>
   <tr>
    <td class="txtRa"><?php echo T_("Company VAT ID"); ?></td>
    <td class="font-bold ltr"><?php echo \dash\fit::number(411491163378, false); ?></td>
   </tr>
<?php } ?>
<?php if (\dash\language::current() === 'fa') { ?>
   <tr>
    <td class="txtRa"><?php echo T_("Knowledge-based Company"); ?></td>
    <td class="font-bold"><?php echo T_("New Type 2"); ?></td>
   </tr>
   <tr>
    <td class="txtRa"><?php echo T_("Knowledge-based Acquisition Date"); ?></td>
    <td class="font-bold ltr"><?php echo \dash\fit::date("2019-05-04"); ?></td>
   </tr>
   <tr>
    <td class="txtRa"><?php echo T_("Company Headquarter"); ?></td>
    <td class="font-bold"><?php echo T_("Qom, Iran"); ?></td>
   </tr>
   <tr>
    <td class="txtRa"><?php echo T_("Address"); ?></td>
    <td class="font-bold"><?php echo T_("Floor2, Yas Building, #39, 1st alley, Haft-e-tir St"); ?></td>
   </tr>
   <tr>
    <td class="txtRa"><?php echo T_("Postal Code"); ?></td>
    <td class="font-bold"><?php echo \dash\fit::number("37196-17540", false); ?></td>
   </tr>
   <tr>
...
<?php } ?>
   <tr>
    ...
    <td class="font-bold ltr"><a href="<?php echo \dash\url::kingdom(); ?>"><?php echo \dash\url::domain(); ?></a></td>
   </tr>
   <tr>
    <td class="txtRa"><?php echo T_("Email Address"); ?></td>
    <td class="font-bold ltr"><a href="mailto:info@jibres.com">Info [ @ ] Jibres.com</a></td>
   </tr>

   <tr>
    <td class="txtRa"><?php echo T_("CEO"); ?></td>
    <td class="font-bold"><a href="<?php echo \dash\url::cdn(); ?>/vcard/Jibres-vCard-Javad-Adib.vcf"><?php echo T_("Mr. Javad Adib"); ?></a></td>
   </tr>

   <tr>
    <td class="txtRa"><?php echo T_("Activity"); ?></td>
    <td class="font-bold"><?php echo T_("eCommerce Platform"). ' - '. T_("Financial technology"). (' - '). T_("Fintech"); ?></td>
   </tr>
   <tr>
   ...
   <tr>
    ...
    <td class="font-bold"><?php echo \dash\fit::datetime_full("2021-03-29", false); ?></td>
   </tr>
  </table>
 </div>