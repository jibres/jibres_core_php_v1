<div class="jibresBanner">
 <div class="fit zero">
  <img class="block" src="<?php echo \dash\url::cdn(); ?>/img/bg/jibres-certificates-1.jpg" alt='<?php echo \dash\data::page_title();?>'>
 </div>
  ...
  <div class="fit-md">
    <h2><?php echo T_('Jibres Certificates'); ?></h2>
	      ...
	      <div class="c9 s12"><p>از نخستین روزهای شروع کار، ما بر روی لبه فناوری ایستاده‌ایم و مطابق آخرین روش‌های علمی تکنولوژی‌های پیشگام خلق می‌کنیم. پس از بررسی محصولات و سرویس‌های ما توسط کارگروه ارزیابی و تشخیص صلاحیت شرکت‌ها و موسسات دانش بنیان، در نهایت معاونت علمی و فناوری ریاست جمهوری اسلامی ایران، دانش بنیان بودن شرکت روزاندیش کویرپیما را به‌صورت رسمی از تاریخ ۱۴ اردیبهشت ۱۳۹۸ تایید کرد.</p></div>
			...
			<div class="f align-center mB20">
      	<!-- <div class="c3 s12 pRa10"><a tabindex='-1' target="_blank" rel='nofollow' href="https://shaparak.com/tips/%D8%B4%D8%B1%DA%A9%D8%AA-%D9%87%D8%A7%DB%8C-%D9%BE%D8%B1%D8%AF%D8%A7%D8%AE%D8%AA-%DB%8C%D8%A7%D8%B1"><img src="<?php echo \dash\url::cdn(); ?>/img/certificates/jibres-certificate-bank-markazi.png" alt=''></a></div> -->
			</div>


			<div class="f align-center mB20">
      	<!-- <div class="c3 s12 pRa10"><a tabindex='-1' target="_blank" rel='nofollow' href="https://shaparak.com/tips/%D8%B4%D8%B1%DA%A9%D8%AA-%D9%87%D8%A7%DB%8C-%D9%BE%D8%B1%D8%AF%D8%A7%D8%AE%D8%AA-%DB%8C%D8%A7%D8%B1"><img src="<?php echo \dash\url::cdn(); ?>/img/certificates/jibres-certificate-shaparak.png" alt=''></a></div> -->
			</div>
	      ...
	      <div class="c9 s12"><p>نماد اعتماد الکترونیکی که توسط مرکز توسعه تجارت الکترونیکی در وزارت صنعت، معدن و تجارت صادر می‌شود از تاریخ ۱۸ اسفندماه ۱۳۹۷ توسط جیبرس اخذ شده است تا علاوه‌بر مجوز فعالیت، منجر به افزایش اعتماد مخاطبان جیبرس برای پرداخت‌های اینترنتی گردد.</p></div>
			...
			<div class="f align-center mB20">
      	<!-- <div class="c3 s12 pRa10"><a tabindex='-1' target="_blank" rel='nofollow' href=""><img src="<?php echo \dash\url::cdn(); ?>/img/certificates/jibres-certificate-brand.png" alt=''></a></div> -->
			</div>
