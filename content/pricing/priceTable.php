  ...
  <div class="cn">
    <div class="box f">
      ...
      <div class="c3 m6 s12 col1">
        ...
        <a href="<?php echo \dash\url::kingdom(); ?>/enter/signup"><?php echo T_("Signup"); ?></a>
      </div>

      <div class="c3 m6 s12 col2">
        <img src="<?php echo \dash\url::static(); ?>/images/pricing/plan2-starter.png" alt='<?php echo \dash\data::site_title(); ?> <?php echo T_("Starter Plan"); ?>'>
      ...
      <div class="c3 m6 s12 col3">
        <img src="<?php echo \dash\url::static(); ?>/images/pricing/plan3-simple.png" alt='<?php echo \dash\data::site_title(); ?> <?php echo T_("Simple Plan"); ?>'>
      ...
      <div class="c3 m6 s12 col4">
        <img src="<?php echo \dash\url::static(); ?>/images/pricing/plan4-standard.png" alt='<?php echo \dash\data::site_title(); ?> <?php echo T_("Standard Plan"); ?>'>
        ...
        <ul>
          ...
          <li><?php echo T_("Shop with Your Domain"); ?></li>
