<nav class="f align-center">
  ...
  <div class="cauto os share1">
    ...
    <a target="_blank" title='<?php echo T_("linkedin"); ?>' href="https://www.linkedin.com/shareArticle?mini=true&url=<?php echo \dash\url::pwd(); ?>&title=<?php echo urlencode(\dash\data::global_title()); ?>&summary=<?php echo urlencode(\dash\data::page_desc()); ?>" class="linkedin">
    	<?php echo \dash\data::site_title(). ' '. T_("linkedin"); ?>
    </a>

    <a target="_blank" title='<?php echo T_("telegram"); ?>' href="https://t.me/share/url?url=<?php echo \dash\url::pwd(); ?>&text=<?php echo urlencode(\dash\data::global_title()); ?>" class="telegram">
