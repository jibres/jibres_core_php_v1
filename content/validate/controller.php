...
class controller
{
	public static function routing()
	{
		...
		[
			...
			'barcode'         => 'barcode',
			'barcode2'        => 'barcode',
			'minstock'        => 'number_positive',
			'maxstock'        => 'number_positive',
