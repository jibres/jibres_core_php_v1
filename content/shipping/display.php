<div class="jibresBanner">
 ...
 <div class="avand-lg impact">
 	<h2 class="font-bold"><?php echo T_("Ecommerce Shipping Story") ?></h2>
 	...
 	<p><?php echo T_("There's a lot happening behind the scenes of ecommerce shipping. You may be trying to decide which carrier to use and wondering how to determine ecommerce shipping costs that will satisfy both you and your customers."); ?> <span class="font-bold"><?php echo T_("We're here to help."); ?></span></p>
 ...
 <div class="avand-lg impact">
 	<h3 class="font-bold"><?php echo T_("Come up with a shipping strategy") ?></h3>
 ...
 <div class="avand-lg impact">
 	<h2 class="font-bold"><?php echo T_("Determine ecommerce shipping cost") ?></h2>
 ...
 <div class="avand-lg impact">
 	<h3 class="font-bold"><?php echo T_("Offer free shipping") ?></h3>
