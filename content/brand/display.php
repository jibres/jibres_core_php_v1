...
<article class="logo">
  ...
  <section class="avand-xl impact py-36">
   <div class="">
    <div class="f align-center mb-2">
      <div class="c4 m6 s12">
        <h3 class="mb-12"><?php echo T_("MEET THE LOGO"); ?></h3>
  ...
  <section class="avand-xl impact py-36">
   <div class="">
    <div class="f align-center">
      <div class="c4 m6 s12">
        <h3 class="mb-12"><?php echo T_("SAFE SPACE"); ?></h3>
...
?>
  ...
  <section class="avand-xl impact py-24">
   <div class="">
    <div class="f align-center">
      <div class="c4 m6 s12">
        <h3 class="mb-12"><?php echo T_("MINIMAL SIZE"); ?></h3>
...
?>
  ...
  <section class="avand-xl impact py-36">
   <div class="">
    <div class="f align-center">
      <div class="c4 m6 s12">
        <h3 class="mb-12"><?php echo T_("JIBRES RED"); ?></h3>
  ...
  <section class="avand-xl impact py-36">
   <div class="">
    <div class="f align-center">
      <div class="c4 m6 s12">
        <h3 class="mb-12"><?php echo T_("USING GRAYSCALE"); ?></h3>
...
?>
  ...
  <section class="avand-xl impact py-36">
   <div class="">
    <div class="f align-center">
      <div class="c4 m6 s12">
        <h3 class="mb-12"><?php echo T_("BACKGROUND COLOR"); ?></h3>
...
?>
  ...
  <section class="avand-xl impact py-36">
   <div class="">
    <div class="f align-center">
      <div class="c4 m6 s12">
        <h3 class="mb-12"><?php echo T_("WORDMARK"); ?></h3>
...
?>
  ...
  <section class="avand-xl impact py-36">
   <div class="">
    <div class="f align-center">
      <div class="c4 m6 s12">
        <h3 class="mb-12"><?php echo T_("LOGO DON'TS"); ?></h3>
