...
class action
{
	...
	private static function get_post()
	{
		...
		if(\content_v2\tools::isset_input_body('desc')) 				$post['desc']            = \content_v2\tools::input_body('desc') ? $_POST['desc'] : null;
		...
		if(\content_v2\tools::isset_input_body('cat')) 				$post['category']        = \content_v2\tools::input_body('cat');
