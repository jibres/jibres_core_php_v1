<h2 class="f" data-kerkere='#vision-detail' data-kerkere-icon='open'>
  <span class="cauto pRa10"><span class="badge success">GET</span></span>
  <span class="c"><?php echo T_("Get vision text"); ?></span>
</h2>
<div id="vision-detail">
  <div class="cbox" id='vision'>
    ...
    <pre>curl -X GET <?php echo \dash\data::CustomerApiURL(); ?>business/vision -H 'appkey: <?php echo \dash\data::myAppKey(); ?>' </pre>
...
<pre>
{
  ...
  "result": {
    ...
    "title": "vision",
    "slug": "vision",
    "url": "<?php echo \dash\data::CustomerApiURL(); ?>vision",
