...
<div id="user-address-remove-detail">
  <div class="cbox" id='user-address-remove'>
    <div class="msg url ltr txtL">
      ...
      <span><?php echo \dash\data::CustomerApiURL(); ?><b>user/address/remove?id={USERID}&addressid={ADDRESSID}</b></span>
    </div>
...
<pre>
curl -X DELETE <?php echo \dash\data::CustomerApiURL(); ?>user/address/remove?id={USERID}&addressid={ADDRESSID}  -H 'appkey: <?php echo \dash\data::myAppKey(); ?>'  -H 'apikey: <?php echo \dash\data::myApiKey(); ?>'
</pre>
