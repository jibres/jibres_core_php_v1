...
<div id="company-list-detail">
  <div class="cbox" id='company-list'>
    <div class="msg url ltr txtL">
      ...
      <span><?php echo \dash\data::CustomerApiURL(); ?><b>company/fetch</b></span>
    </div>
...
<pre>
curl -X GET <?php echo \dash\data::CustomerApiURL(); ?>company/fetch -H 'appkey: <?php echo \dash\data::myAppKey(); ?>' -H 'apikey: <?php echo \dash\data::myApiKey(); ?>'
</pre>
