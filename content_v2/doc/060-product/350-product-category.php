...
<div id="product-category-list-detail">
  ...
  <div class="cbox" id='product-category-list'>
    <div class="msg url ltr txtL">
      ...
      <span><?php echo \dash\data::CustomerApiURL(); ?><b>product/search?category={CATEGORY}</b></span>
    </div>
...
<pre>
curl -X GET <?php echo \dash\data::CustomerApiURL(); ?>product/search?category={CATEGORY} -H 'appkey: <?php echo \dash\data::myAppKey(); ?>' -H 'apikey: <?php echo \dash\data::myApiKey(); ?>'
</pre>
