...
<div id="product-gallery-remove-detail">
  <div class="cbox" id='product-gallery-remove'>
    ...
    <div class="msg url ltr txtL">
      ...
      <span><?php echo \dash\data::CustomerApiURL(); ?><b>product/gallery/remove?id={PRODUCT_ID}</b></span>
    </div>
...
<pre>
curl -X DELETE \
  <?php echo \dash\data::CustomerApiURL(); ?>product/gallery/remove?id={PRODUCT_ID} \
