...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 29, 2014 at 03:46 PM
...
INSERT INTO `sms` (`id`, `sms_from`, `sms_to`, `sms_message`, `sms_messageid`, `sms_status`, `sms_method`) VALUES
(9, '123', '456', 'qwe', 678, NULL, 'post'),
(13, NULL, NULL, NULL, 123, 1, 'post'),
(14, NULL, NULL, NULL, 123, NULL, 'post');
...
--
ALTER TABLE `verifications`
MODIFY `id` smallint(5) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=357;
--
