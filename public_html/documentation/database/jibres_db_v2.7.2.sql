...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 27, 2014 at 02:47 PM
...
CREATE TABLE IF NOT EXISTS `visitors` (
  ...
  `user_id` smallint(5) unsigned DEFAULT NULL,
  `visitor_datetime` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `date_modified` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `visitors_users_id` (`user_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=195 ;
