...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 07, 2014 at 07:50 PM
...
(1, 'پارسیان', 'parsian', NULL, 'yes', '0000-00-00 00:00:00'),
...
CREATE TABLE IF NOT EXISTS `permissions` (
  ...
  `date_modified` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `name+module_unique` (`permission_name`,`Permission_module`) USING BTREE
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=5 ;
...
INSERT INTO `permissions` (`id`, `permission_name`, `Permission_module`, `permission_view`, `permission_add`, `permission_edit`, `permission_delete`, `permission_status`, `date_modified`) VALUES
...
CREATE TABLE IF NOT EXISTS `productcats` (
  ...
  `attachment_id` int(10) unsigned DEFAULT NULL,
  `productcat_row` smallint(5) unsigned NOT NULL DEFAULT '0',
  `date_modified` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
(14, 'customer', '1', 'eee2', 'male', NULL, NULL, NULL, NULL, NULL, '9112223333', NULL, NULL, NULL, NULL, NULL, NULL, 'no', NULL, NULL, NULL, 'active', NULL, NULL, 9010, 0, 'no', NULL, NULL, 1, '0000-00-00 00:00:00'),
(15, 'supplier', '1', NULL, NULL, NULL, 'Test', NULL, NULL, NULL, '9123334444', NULL, NULL, NULL, NULL, NULL, NULL, 'no', NULL, NULL, NULL, 'awaiting', NULL, NULL, 9032, 0, 'no', NULL, NULL, 1, '0000-00-00 00:00:00'),
(16, 'employee', '1', 'aaa2', NULL, NULL, NULL, 'Test last', NULL, NULL, '9134445555', NULL, NULL, NULL, NULL, NULL, NULL, 'no', NULL, NULL, NULL, 'active', NULL, NULL, 0, 0, 'no', NULL, NULL, 1, '0000-00-00 00:00:00');
